...
.method public close()V
    ...
    iget-object v2, p0, Lcom/android/server/sepunion/friends/agentsvc/AgentSvcClient;->mConnection:Landroid/content/ServiceConnection;
    ...
    iput-boolean v1, p0, Lcom/android/server/sepunion/friends/agentsvc/AgentSvcClient;->mConnectedAtLeastOnce:Z
...
.method connect()Z
    ...
    invoke-static {v0, v3, v2}, Lcom/android/server/sepunion/friends/util/LogFrs;->v(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-static {v0, v3, v4}, Lcom/android/server/sepunion/friends/util/LogFrs;->w(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    ...
    iget-object v3, p0, Lcom/android/server/sepunion/friends/agentsvc/AgentSvcClient;->mContext:Landroid/content/Context;

    iget-object v4, p0, Lcom/android/server/sepunion/friends/agentsvc/AgentSvcClient;->mConnection:Landroid/content/ServiceConnection;

    const-string v5, "SYSTEM"

    invoke-static {v5}, Lcom/android/server/sepunion/friends/common/FwDependency;->getUserHandle(Ljava/lang/String;)Landroid/os/UserHandle;

    move-result-object v5

    invoke-static {v3, v0, v4, v1, v5}, Lcom/android/server/sepunion/friends/common/FwDependency;->bindServiceAsUser(Landroid/content/Context;Landroid/content/Intent;Landroid/content/ServiceConnection;ILandroid/os/UserHandle;)Z
    ...
    :try_start_0
    iget-object v3, p0, Lcom/android/server/sepunion/friends/agentsvc/AgentSvcClient;->mBlockingQueue:Ljava/util/concurrent/BlockingDeque;
    ...
    invoke-direct {p0, v3}, Lcom/android/server/sepunion/friends/agentsvc/AgentSvcClient;->setService(Landroid/os/IInterface;)Landroid/os/IInterface;
    ...
    invoke-static {v3, v4, v5}, Lcom/android/server/sepunion/friends/util/LogFrs;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    :try_end_0
    ...
    invoke-static {v1, v3, v4}, Lcom/android/server/sepunion/friends/util/LogFrs;->w(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
