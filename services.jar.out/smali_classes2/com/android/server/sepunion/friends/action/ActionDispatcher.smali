...
.method public execute(ILandroid/os/Bundle;)Landroid/os/Bundle;
    ...
    invoke-interface {v14, v10, v0, v9}, Lcom/android/server/sepunion/friends/action/ActionExecutable;->preExecute(Landroid/os/Bundle;II)Z

    move-result v2

    if-eqz v2, :cond_3

    invoke-interface {v14, v9}, Lcom/android/server/sepunion/friends/action/ActionExecutable;->executeOnSameThread(I)Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-interface {v14, v10, v0, v9}, Lcom/android/server/sepunion/friends/action/ActionExecutable;->execute(Landroid/os/Bundle;II)Landroid/os/Bundle;
