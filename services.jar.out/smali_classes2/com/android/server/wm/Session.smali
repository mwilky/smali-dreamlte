...
.field private final mEmptyConventionalModeInfo:Lcom/samsung/android/view/ConventionalModeBar$Info;

.field private final mEmptyTranslatedPoint:Landroid/graphics/PointF;

.field private mLastReportedAnimatorScale:F

.field private mNumSystemWindow:I
...
.method public constructor <init>(Lcom/android/server/wm/WindowManagerService;Landroid/view/IWindowSessionCallback;Lcom/android/internal/view/IInputMethodClient;Lcom/android/internal/view/IInputContext;)V
    ...
    iput v0, p0, Lcom/android/server/wm/Session;->mNumSystemWindow:I
    ...
    iput-object v1, p0, Lcom/android/server/wm/Session;->mEmptyTranslatedPoint:Landroid/graphics/PointF;

    new-instance v1, Lcom/samsung/android/view/ConventionalModeBar$Info;

    invoke-direct {v1}, Lcom/samsung/android/view/ConventionalModeBar$Info;-><init>()V

    iput-object v1, p0, Lcom/android/server/wm/Session;->mEmptyConventionalModeInfo:Lcom/samsung/android/view/ConventionalModeBar$Info;
...
.method public binderDied()V
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/wm/TaskPositioningController;->handleAppDied(I)V
...
.method dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    const-string v0, " mNumSystemWindow="

    invoke-virtual {p1, v0}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    iget v0, p0, Lcom/android/server/wm/Session;->mNumSystemWindow:I
...
.method public isCoverOpen()Z
    ...
    invoke-interface {v0}, Lcom/android/server/policy/SamsungWindowManagerPolicy;->isCoverOpen()Z
...
.method public relayout(Landroid/view/IWindow;ILandroid/view/WindowManager$LayoutParams;IIIIJLandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/view/DisplayCutout$ParcelableWrapper;Landroid/util/MergedConfiguration;Landroid/view/Surface;)I
    ...
    iget-object v14, v15, Lcom/android/server/wm/Session;->mEmptyTranslatedPoint:Landroid/graphics/PointF;

    iget-object v13, v15, Lcom/android/server/wm/Session;->mEmptyConventionalModeInfo:Lcom/samsung/android/view/ConventionalModeBar$Info;
...
.method public relayoutForTranslate(Landroid/view/IWindow;ILandroid/view/WindowManager$LayoutParams;IIIIJLandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/view/DisplayCutout$ParcelableWrapper;Landroid/util/MergedConfiguration;Landroid/view/Surface;Landroid/graphics/PointF;Lcom/samsung/android/view/ConventionalModeBar$Info;)I
    .locals 24
...
.method public startMovingTask(Landroid/view/IWindow;FF)Z
    ...
    invoke-virtual {v2, p1, p2, p3, v3}, Lcom/android/server/wm/TaskPositioningController;->startMovingTask(Landroid/view/IWindow;FFI)Z
...
.method windowAddedLocked(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1, v0}, Lcom/android/server/wm/Session;->windowAddedLocked(Ljava/lang/String;Lcom/android/server/wm/WindowState;)V

    return-void
.end method

.method windowAddedLocked(Ljava/lang/String;Lcom/android/server/wm/WindowState;)V
    .locals 3
...
.method windowRemovedLocked()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/wm/Session;->windowRemovedLocked(Lcom/android/server/wm/WindowState;)V

    return-void
.end method

.method windowRemovedLocked(Lcom/android/server/wm/WindowState;)V
    .locals 1
