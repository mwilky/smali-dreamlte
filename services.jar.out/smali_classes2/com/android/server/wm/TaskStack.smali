...
.method updateBoundsAfterConfigChange(Z)Z
    ...
    invoke-virtual {p0, v7}, Lcom/android/server/wm/TaskStack;->setBounds(Landroid/graphics/Rect;)I
    ...
    invoke-virtual {v8}, Lcom/android/server/wm/MultiWindowManagerInternal;->getSnapWindowInternal()Lcom/android/server/wm/SnapWindowInternal;

    move-result-object v8

    iget-boolean v8, v8, Lcom/android/server/wm/SnapWindowInternal;->mSnapWindowRunning:Z
    ...
    :goto_1
    iget-object v10, p0, Lcom/android/server/wm/TaskStack;->mService:Lcom/android/server/wm/WindowManagerService;
    ...
    invoke-virtual {v10}, Lcom/android/server/wm/MultiWindowManagerInternal;->getSnapWindowInternal()Lcom/android/server/wm/SnapWindowInternal;

    move-result-object v10

    iget-object v11, p0, Lcom/android/server/wm/TaskStack;->mTmpRect2:Landroid/graphics/Rect;

    invoke-virtual {v10, v11, v9}, Lcom/android/server/wm/SnapWindowInternal;->getMiddleTargetDockedBounds(Landroid/graphics/Rect;I)V
    ...
    iget v10, p0, Lcom/android/server/wm/TaskStack;->mRotation:I

    iget-object v11, p0, Lcom/android/server/wm/TaskStack;->mTmpRect2:Landroid/graphics/Rect;

    invoke-virtual {v9, v10, v0, v11}, Lcom/android/server/wm/DisplayContent;->rotateBounds(IILandroid/graphics/Rect;)V
    ...
    invoke-direct {p0, v9}, Lcom/android/server/wm/TaskStack;->repositionPrimarySplitScreenStackAfterRotation(Landroid/graphics/Rect;)V

    iget-object v9, p0, Lcom/android/server/wm/TaskStack;->mTmpRect2:Landroid/graphics/Rect;

    invoke-direct {p0, v9}, Lcom/android/server/wm/TaskStack;->snapDockedStackAfterRotation(Landroid/graphics/Rect;)V

    iget-object v9, p0, Lcom/android/server/wm/TaskStack;->mTmpRect2:Landroid/graphics/Rect;

    invoke-direct {p0, v9}, Lcom/android/server/wm/TaskStack;->getDockSide(Landroid/graphics/Rect;)I
    ...
    invoke-virtual {v10, v1, v7}, Lcom/android/server/wm/WindowManagerService;->setDockedStackCreateStateLocked(ILandroid/graphics/Rect;)V
    ...
    invoke-virtual {v1, v9}, Lcom/android/server/wm/DockedStackDividerController;->notifyDockSideChanged(I)V
