...
.method private computeSizeRangesAndScreenLayout(Landroid/view/DisplayInfo;IZIIIFLandroid/content/res/Configuration;)V
    ...
    invoke-direct/range {v15 .. v22}, Lcom/android/server/wm/DisplayContent;->reduceConfigLayout(IIFIIII)I
    ...
    iget v3, v14, Landroid/view/DisplayInfo;->smallestNominalAppWidth:I

    iget v4, v14, Landroid/view/DisplayInfo;->smallestNominalAppHeight:I
...
.method public static synthetic lambda$new$8(Lcom/android/server/wm/DisplayContent;Lcom/android/server/wm/WindowState;)V
    ...
    invoke-virtual {v7}, Lcom/android/server/wm/MultiDisplayManagerInternal;->getDexModeLocked()I

    move-result v7

    if-ne v7, v8, :cond_2

    iput-object p1, v2, Lcom/android/server/wm/RootWindowContainer;->mObscuringDexScreenWindow:Lcom/android/server/wm/WindowState;
...
.method private setInputMethodTarget(Lcom/android/server/wm/WindowState;Z)V
    ...
    invoke-virtual {v2, v3}, Lcom/android/server/wm/SamsungWindowManagerService;->getIMEDisplayIdVS(I)I
    ...
    invoke-virtual {v4, v3}, Lcom/android/server/wm/WindowToken;->onDisplayChanged(Lcom/android/server/wm/DisplayContent;)V
...
.method private updateBaseDisplayMetricsIfNeeded()V
    ...
    :goto_7
    sget-boolean v10, Lcom/samsung/android/rune/CoreRune;->MD_DEBUG_LOG:Z

    if-eqz v10, :cond_8

    sget-boolean v10, Lcom/android/server/wm/WindowManagerDebugConfig;->DEBUG_DISPLAY_MANAGEMENT:Z
    ...
    const-string/jumbo v12, "updateBaseDisplayMetricsIfNeeded: d"
    ...
    const-string v12, "dpi /  newCutout="
    ...
    :goto_a
    iget-boolean v12, p0, Lcom/android/server/wm/DisplayContent;->isDefaultDisplay:Z
    ...
    iget-boolean v13, p0, Lcom/android/server/wm/DisplayContent;->mAlreadyUpdatedForcedDisplaySize:Z

    if-nez v13, :cond_e

    iput-boolean v2, p0, Lcom/android/server/wm/DisplayContent;->mAlreadyUpdatedForcedDisplaySize:Z

    iget-object v2, p0, Lcom/android/server/wm/DisplayContent;->mService:Lcom/android/server/wm/WindowManagerService;

    iget-object v2, v2, Lcom/android/server/wm/WindowManagerService;->mSamsungWindowManager:Lcom/android/server/wm/SamsungWindowManagerService;

    invoke-virtual {v2, p0, v4, v5}, Lcom/android/server/wm/SamsungWindowManagerService;->updateForcedDisplaySizeForInitialDisplayChanged(Lcom/android/server/wm/DisplayContent;II)V
    ...
    iget v13, p0, Lcom/android/server/wm/DisplayContent;->mBaseDisplayHeight:I
    ...
    iget v14, p0, Lcom/android/server/wm/DisplayContent;->mBaseDisplayDensity:I
    ...
    :goto_e
    invoke-virtual {p0, v2, v13, v14, v1}, Lcom/android/server/wm/DisplayContent;->updateBaseDisplayMetrics(IIIZ)V
    ...
    iget-boolean v2, p0, Lcom/android/server/wm/DisplayContent;->mAlreadyUpdatedForcedDisplaySize:Z
    ...
    invoke-virtual {v2, p0}, Lcom/android/server/wm/SamsungWindowManagerService;->updateTouchableAreaForInitialDisplayChanged(Lcom/android/server/wm/DisplayContent;)V

    :cond_12
    iput-boolean v1, p0, Lcom/android/server/wm/DisplayContent;->mAlreadyUpdatedForcedDisplaySize:Z
    ...
    invoke-virtual {p0, v1, v2}, Lcom/android/server/wm/DisplayContent;->updateBaseDisplayCutout(II)V

    iget-object v1, p0, Lcom/android/server/wm/DisplayContent;->mService:Lcom/android/server/wm/WindowManagerService;

    invoke-virtual {v1, p0}, Lcom/android/server/wm/WindowManagerService;->reconfigureDisplayLocked(Lcom/android/server/wm/DisplayContent;)V
    ...
    new-instance v10, Lcom/android/server/wm/-$$Lambda$DisplayContent$gXpm9iON84WxoeOerSeNctnL3M0;

    invoke-direct {v10, v2}, Lcom/android/server/wm/-$$Lambda$DisplayContent$gXpm9iON84WxoeOerSeNctnL3M0;-><init>(Landroid/app/ActivityManagerInternal;)V

    invoke-virtual {v1, v10}, Lcom/android/server/wm/WindowManagerService$H;->post(Ljava/lang/Runnable;)Z
...
.method applySurfaceChangesTransaction(Z)Z
    ...
    invoke-virtual {v5, p0, v0, v1}, Lcom/android/server/wm/SamsungWindowManagerService;->updateBoundsVS(Lcom/android/server/wm/DisplayContent;II)V
...
.method computeImeTarget(Z)Lcom/android/server/wm/WindowState;
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/wm/DisplayContent;->computeImeTarget(Z)Lcom/android/server/wm/WindowState;
...
.method computeScreenConfiguration(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {v1, v11, v10}, Lcom/android/server/wm/MultiDisplayManagerInternal;->adjustDexConfigurationLocked(Landroid/content/res/Configuration;Lcom/android/server/wm/DisplayContent;)V
...
.method public dump(Ljava/io/PrintWriter;Ljava/lang/String;Z)V
    ...
    const-string/jumbo v5, "mPointerTouchExcludeRegion="
    ...
    iget v4, p0, Lcom/android/server/wm/DisplayContent;->mLastStatusBarVisibility:I
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {v2}, Lcom/android/server/wm/AspectRatioController;->onConfigurationChanged()V
...
.method screenshotDisplayLocked(Landroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    const-string v3, "Attempted to take screenshot while display was off."
    ...
    invoke-direct {v3, v4, v4, v1, v11}, Landroid/graphics/Rect;-><init>(IIII)V
    ...
    :goto_3
    invoke-static {v12, v13, v1, v11}, Lcom/android/server/wm/DisplayContent;->convertCropForSurfaceFlinger(Landroid/graphics/Rect;III)V
    ...
    :cond_7
    invoke-virtual/range {p0 .. p0}, Lcom/android/server/wm/DisplayContent;->isDexMode()Z
    ...
    sget-boolean v3, Lcom/samsung/android/rune/CoreRune;->MD_DEX_EMULATOR:Z
    ...
    invoke-virtual {v3}, Landroid/hardware/display/DisplayManagerInternal;->isDesktopSwitched()Z
    ...
    invoke-static/range {v3 .. v10}, Landroid/view/SurfaceControl;->screenshot(Landroid/os/IBinder;Landroid/graphics/Rect;IIIIZI)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {v3, v4}, Landroid/graphics/Bitmap;->createAshmemBitmap(Landroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
...
.method updateRotationUnchecked(Z)Z
    ...
    iget-boolean v10, v1, Lcom/android/server/wm/DisplayContent;->mAltOrientation:Z

    iget-object v4, v1, Lcom/android/server/wm/DisplayContent;->mService:Lcom/android/server/wm/WindowManagerService;
    ...
    invoke-virtual {v4}, Lcom/android/server/wm/SamsungWindowManagerService;->inVSMode()Z
    ...
    iget v8, v1, Lcom/android/server/wm/DisplayContent;->mProposedRotation:I
    ...
    invoke-interface/range {v4 .. v9}, Lcom/android/server/policy/WindowManagerPolicy;->rotationForOrientationLw(IIZIZ)I
    ...
    invoke-interface {v4, v3, v2, v5}, Lcom/android/server/policy/WindowManagerPolicy;->rotationForOrientationLw(IIZ)I
    ...
    const-string v7, "Computed rotation="

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v6, v4}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v7, " for display id="
    ...
    const-string v7, " based on lastOrientation="

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v6, v3}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v7, " and oldRotation="
    ...
    invoke-interface {v5, v2, v4}, Lcom/android/server/policy/WindowManagerPolicy;->shouldRotateSeamlessly(II)Z
    ...
    invoke-virtual {v1, v6}, Lcom/android/server/wm/DisplayContent;->getWindow(Ljava/util/function/Predicate;)Lcom/android/server/wm/WindowState;
    ...
    sget-boolean v7, Lcom/samsung/android/rune/CoreRune;->FW_MANAGE_AOD_POLICY:Z
    ...
    iget-object v7, v7, Lcom/android/server/wm/SamsungWindowManagerService;->mSamsungPolicy:Lcom/android/server/policy/SamsungWindowManagerPolicy;

    invoke-interface {v7}, Lcom/android/server/policy/SamsungWindowManagerPolicy;->isAodVisibleWithDozeMode()Z
    ...
    invoke-interface {v9, v3, v4}, Lcom/android/server/policy/WindowManagerPolicy;->rotationHasCompatibleMetricsLw(II)Z
    ...
    const-string v13, "Display id="

    invoke-virtual {v12, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v13, v1, Lcom/android/server/wm/DisplayContent;->mDisplayId:I

    invoke-virtual {v12, v13}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v13, " selected orientation "

    invoke-virtual {v12, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v12, v3}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v13, ", got rotation "

    invoke-virtual {v12, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v12, v4}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v13, " which has "

    invoke-virtual {v12, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    if-eqz v9, :cond_11

    const-string v13, "incompatible"

    goto :goto_5

    :cond_11
    const-string v13, "compatible"
    ...
    const-string v13, " rotation changed to "
    ...
    const-string v13, ", lastOrientation="
    ...
    iget-object v11, v1, Lcom/android/server/wm/DisplayContent;->mService:Lcom/android/server/wm/WindowManagerService;

    iput-boolean v7, v11, Lcom/android/server/wm/WindowManagerService;->mWaitingForConfig:Z

    :cond_17
    iput v4, v1, Lcom/android/server/wm/DisplayContent;->mRotation:I

    iput-boolean v9, v1, Lcom/android/server/wm/DisplayContent;->mAltOrientation:Z

    iget-boolean v11, v1, Lcom/android/server/wm/DisplayContent;->isDefaultDisplay:Z

    if-eqz v11, :cond_18

    iget-object v11, v1, Lcom/android/server/wm/DisplayContent;->mService:Lcom/android/server/wm/WindowManagerService;

    iget-object v11, v11, Lcom/android/server/wm/WindowManagerService;->mPolicy:Lcom/android/server/policy/WindowManagerPolicy;

    invoke-interface {v11, v4}, Lcom/android/server/policy/WindowManagerPolicy;->setRotationLw(I)V

    :cond_18
    iget-object v11, v1, Lcom/android/server/wm/DisplayContent;->mService:Lcom/android/server/wm/WindowManagerService;

    iput v7, v11, Lcom/android/server/wm/WindowManagerService;->mWindowsFreezingScreen:I
    ...
    invoke-virtual {v11, v13}, Lcom/android/server/wm/WindowManagerService$H;->removeMessages(I)V
    ...
    invoke-virtual {v11, v13, v7, v8}, Lcom/android/server/wm/WindowManagerService$H;->sendEmptyMessageDelayed(IJ)Z
    ...
    invoke-interface {v11, v14}, Lcom/android/server/policy/WindowManagerPolicy;->selectRotationAnimationLw([I)V
    ...
    invoke-virtual {v11, v0, v13, v1}, Lcom/android/server/wm/WindowManagerService;->startFreezingDisplayLocked(IILcom/android/server/wm/DisplayContent;)V

    iget-object v0, v1, Lcom/android/server/wm/DisplayContent;->mService:Lcom/android/server/wm/WindowManagerService;

    iget-object v0, v0, Lcom/android/server/wm/WindowManagerService;->mAnimator:Lcom/android/server/wm/WindowAnimator;

    iget v11, v1, Lcom/android/server/wm/DisplayContent;->mDisplayId:I
    ...
    invoke-virtual {v11}, Lcom/android/server/wm/WindowManagerService;->startSeamlessRotation()V
    ...
    invoke-virtual {v13}, Lcom/android/server/wm/ScreenRotationAnimation;->hasScreenshot()Z
    ...
    iget-object v11, v1, Lcom/android/server/wm/DisplayContent;->mDisplayInfo:Landroid/view/DisplayInfo;
    ...
    invoke-virtual/range {v11 .. v18}, Lcom/android/server/wm/ScreenRotationAnimation;->setRotation(Landroid/view/SurfaceControl$Transaction;IJFII)Z
    ...
    invoke-direct {v0, v2, v4}, Lcom/android/server/wm/-$$Lambda$DisplayContent$YooAGhJSBcftNk21oP6nOxalKHI;-><init>(II)V

    const/4 v7, 0x1

    invoke-virtual {v1, v0, v7}, Lcom/android/server/wm/DisplayContent;->forAllWindows(Ljava/util/function/Consumer;Z)V
    ...
    invoke-virtual {v1, v0, v2, v4}, Lcom/android/server/wm/DisplayContent;->seamlesslyRotate(Landroid/view/SurfaceControl$Transaction;II)V
    ...
    invoke-virtual {v1, v0, v8}, Lcom/android/server/wm/DisplayContent;->forAllWindows(Ljava/util/function/Consumer;Z)V
    ...
    invoke-virtual {v0, v8}, Lcom/android/server/wm/WindowManagerService$H;->removeMessages(I)V
    ...
    invoke-virtual {v0, v8, v11, v12}, Lcom/android/server/wm/WindowManagerService$H;->sendEmptyMessageDelayed(IJ)Z
    ...
    check-cast v11, Lcom/android/server/wm/WindowManagerService$RotationWatcher;

    iget v0, v11, Lcom/android/server/wm/WindowManagerService$RotationWatcher;->mDisplayId:I

    iget v12, v1, Lcom/android/server/wm/DisplayContent;->mDisplayId:I

    if-ne v0, v12, :cond_1e

    :try_start_0
    iget-object v0, v11, Lcom/android/server/wm/WindowManagerService$RotationWatcher;->mWatcher:Landroid/view/IRotationWatcher;

    invoke-interface {v0, v4}, Landroid/view/IRotationWatcher;->onRotationChanged(I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method updateStatusBarVisibilityLocked(I)Z
    ...
    iget v3, p0, Lcom/android/server/wm/DisplayContent;->mLastDispatchedSystemUiVisibility:I
    ...
    iget v2, p0, Lcom/android/server/wm/DisplayContent;->mLastDispatchedSystemUiVisibility:I
    ...
    const-string/jumbo v5, "updateStatusBarVisibilityLocked:#"
    ...
    invoke-virtual {v3, p1, v4}, Lcom/android/server/input/InputManagerService;->setSystemUiVisibility(II)V
