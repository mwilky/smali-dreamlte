...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/wm/DisplayContent;ZZLcom/android/server/wm/WindowManagerService;)V
    ...
    invoke-virtual {v0, v13, v14}, Landroid/view/SurfaceControl$Builder;->setSize(II)Landroid/view/SurfaceControl$Builder;
    ...
    invoke-virtual {v0, v14, v8}, Landroid/view/SurfaceControl$Transaction;->setOverrideScalingMode(Landroid/view/SurfaceControl;I)Landroid/view/SurfaceControl$Transaction;

    invoke-virtual {v0, v8}, Landroid/view/SurfaceControl$Transaction;->apply(Z)V
    ...
    :cond_b
    invoke-static {v8}, Landroid/view/SurfaceControl;->getBuiltInDisplay(I)Landroid/os/IBinder;
    ...
    invoke-virtual {v14, v0}, Landroid/view/Surface;->copyFrom(Landroid/view/SurfaceControl;)V

    invoke-static {v12, v14}, Landroid/view/SurfaceControl;->screenshot(Landroid/os/IBinder;Landroid/view/Surface;)V
    ...
    invoke-virtual {v7, v0, v3}, Landroid/view/SurfaceControl$Transaction;->setAlpha(Landroid/view/SurfaceControl;F)Landroid/view/SurfaceControl$Transaction;
    ...
    const-string v14, "Built-in display "
    ...
    const-string v8, "Unable to allocate freeze surface"
    ...
    const-string v8, "Dismiss MultiWindowFreezeAnimation for ScreenRotationAnimation"
    ...
    invoke-virtual {v3, v8, v12}, Lcom/android/server/wm/WindowAnimator;->setMultiWindowFreezeAnimationLocked(ILcom/android/server/wm/MultiWindowFreezeAnimation;)V
