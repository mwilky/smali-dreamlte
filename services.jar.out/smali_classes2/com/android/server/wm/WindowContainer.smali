...
.field mIgnoreParentCrop:Z

.field mIgnoreParentCropRequested:Z
...
.method constructor <init>(Lcom/android/server/wm/WindowManagerService;)V
    ...
    iput-boolean v1, p0, Lcom/android/server/wm/WindowContainer;->mIgnoreParentCropRequested:Z

    iput-boolean v1, p0, Lcom/android/server/wm/WindowContainer;->mIgnoreParentCrop:Z
...
.method private clearSavedLeash()V
    .locals 5

    iget-object v0, p0, Lcom/android/server/wm/WindowContainer;->mSurfaceAnimator:Lcom/android/server/wm/SurfaceAnimator;

    iget-object v0, v0, Lcom/android/server/wm/SurfaceAnimator;->mSavedLeashListUntilCommit:Ljava/util/ArrayList;
    ...
    const-string v4, "clearSavedLeashOnCommit, savedLeash="
    ...
    iput-boolean v1, v0, Lcom/android/server/wm/SurfaceAnimator;->mRequestedToClearSavedLeash:Z
...
.method clearSavedLeashOnCommit()V
    .locals 2

    iget-object v0, p0, Lcom/android/server/wm/WindowContainer;->mSurfaceAnimator:Lcom/android/server/wm/SurfaceAnimator;

    iget-boolean v0, v0, Lcom/android/server/wm/SurfaceAnimator;->mRequestedToClearSavedLeash:Z

    if-eqz v0, :cond_0

    invoke-direct {p0}, Lcom/android/server/wm/WindowContainer;->clearSavedLeash()V
    ...
    invoke-virtual {v1}, Lcom/android/server/wm/WindowContainer;->clearSavedLeashOnCommit()V
...
.method onParentSet()V
    ...
    const-string/jumbo v2, "onParentSet, reparentSurfaceControl is called, surface="
...
.method prepareSurfaces()V
    ...
    const-string/jumbo v2, "prepareSurfaces, request to clear saved leash, surface="
...
.method requestIgnoreParentCrop(Z)V
    .locals 0

    iput-boolean p1, p0, Lcom/android/server/wm/WindowContainer;->mIgnoreParentCropRequested:Z
...
.method updateIgnoreParentCropPolicy()V
    .locals 3

    iget-boolean v0, p0, Lcom/android/server/wm/WindowContainer;->mIgnoreParentCropRequested:Z

    iget-boolean v1, p0, Lcom/android/server/wm/WindowContainer;->mIgnoreParentCrop:Z

    if-eq v0, v1, :cond_0

    iget-boolean v0, p0, Lcom/android/server/wm/WindowContainer;->mIgnoreParentCropRequested:Z

    iput-boolean v0, p0, Lcom/android/server/wm/WindowContainer;->mIgnoreParentCrop:Z
    ...
    iget-boolean v2, p0, Lcom/android/server/wm/WindowContainer;->mIgnoreParentCrop:Z
