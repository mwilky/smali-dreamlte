...
.method constructor <init>(Landroid/content/Context;Landroid/os/Looper;Z)V
    ...
    iput-object v2, v0, Lcom/android/server/pm/ShortcutService;->mUserManager:Landroid/os/UserManager;
    ...
    iget-object v6, v0, Lcom/android/server/pm/ShortcutService;->mPackageMonitor:Landroid/content/BroadcastReceiver;

    sget-object v7, Landroid/os/UserHandle;->ALL:Landroid/os/UserHandle;

    const/4 v9, 0x0

    iget-object v10, v0, Lcom/android/server/pm/ShortcutService;->mHandler:Landroid/os/Handler;
    ...
    iget-object v13, v0, Lcom/android/server/pm/ShortcutService;->mPackageMonitor:Landroid/content/BroadcastReceiver;
    ...
    invoke-virtual {v6, v11}, Landroid/content/IntentFilter;->setPriority(I)V

    iget-object v12, v0, Lcom/android/server/pm/ShortcutService;->mContext:Landroid/content/Context;

    iget-object v13, v0, Lcom/android/server/pm/ShortcutService;->mReceiver:Landroid/content/BroadcastReceiver;

    sget-object v14, Landroid/os/UserHandle;->ALL:Landroid/os/UserHandle;

    iget-object v7, v0, Lcom/android/server/pm/ShortcutService;->mHandler:Landroid/os/Handler;
    ...
    new-instance v7, Lcom/android/server/pm/ShortcutService$SettingChangeObserver;

    iget-object v8, v0, Lcom/android/server/pm/ShortcutService;->mContext:Landroid/content/Context;

    invoke-direct {v7, v0, v8}, Lcom/android/server/pm/ShortcutService$SettingChangeObserver;-><init>(Lcom/android/server/pm/ShortcutService;Landroid/content/Context;)V

    iput-object v7, v0, Lcom/android/server/pm/ShortcutService;->mSettingChangeObserver:Lcom/android/server/pm/ShortcutService$SettingChangeObserver;
    ...
    iget-object v9, v0, Lcom/android/server/pm/ShortcutService;->mSettingChangeObserver:Lcom/android/server/pm/ShortcutService$SettingChangeObserver;

    invoke-virtual {v7, v8, v1, v9}, Landroid/content/ContentResolver;->registerContentObserver(Landroid/net/Uri;ZLandroid/database/ContentObserver;)V

    iget-object v1, v0, Lcom/android/server/pm/ShortcutService;->mUidObserver:Landroid/app/IUidObserver;

    const/4 v7, 0x3

    invoke-virtual {v0, v1, v7}, Lcom/android/server/pm/ShortcutService;->injectRegisterUidObserver(Landroid/app/IUidObserver;I)V
...
.method static synthetic access$1300(Lcom/android/server/pm/ShortcutService;Ljava/lang/String;I)V
    .locals 0
...
.method static synthetic access$1700(Lcom/android/server/pm/ShortcutService;Ljava/lang/String;IZ)V
    .locals 0
...
.method static synthetic access$1800(Lcom/android/server/pm/ShortcutService;)V
    .locals 0
...
.method static synthetic access$400(Lcom/android/server/pm/ShortcutService;)Landroid/os/UserManager;
    .locals 1
...
.method static synthetic access$500(Lcom/android/server/pm/ShortcutService;Ljava/util/List;)Ljava/util/List;
    .locals 1
...
.method static synthetic access$800(Lcom/android/server/pm/ShortcutService;Ljava/lang/String;ILandroid/content/pm/ShortcutInfo;Landroid/appwidget/AppWidgetProviderInfo;Landroid/os/Bundle;Landroid/content/IntentSender;)Z
    .locals 1
...
.method static synthetic access$900(Lcom/android/server/pm/ShortcutService;)Ljava/util/concurrent/atomic/AtomicBoolean;
    .locals 1
...
.method public static synthetic lambda$applyRestore$14(Lcom/android/server/pm/ShortcutService;Ljava/io/PrintWriter;)V
    .locals 1
...
.method public static synthetic lambda$applyRestore$15(Lcom/android/server/pm/ShortcutService;Ljava/io/PrintWriter;)V
    .locals 1
...
.method static synthetic lambda$getBackupPayload$11(Lcom/android/server/pm/ShortcutPackageItem;)V
    .locals 0
...
.method static synthetic lambda$getBackupPayload$12(Lcom/android/server/pm/ShortcutPackage;)V
    .locals 2
...
.method static synthetic lambda$getBackupPayload$13(Lcom/android/server/pm/ShortcutLauncher;)V
    .locals 0
...
.method static synthetic lambda$getBackupShortcut$10(Lcom/android/server/pm/ShortcutLauncher;)V
    .locals 0
...
.method static synthetic lambda$getBackupShortcut$9(Lcom/android/server/pm/ShortcutPackageItem;)V
    .locals 0
...
.method static synthetic lambda$getBitmapPathList$8(Ljava/util/ArrayList;Lcom/android/server/pm/ShortcutPackage;)V
    .locals 5
...
.method public static synthetic lambda$rescanUpdatedPackagesLocked$7(Lcom/android/server/pm/ShortcutService;Lcom/android/server/pm/ShortcutUser;IZLandroid/content/pm/ApplicationInfo;)V
    .locals 2
...
.method static synthetic lambda$verifyStatesInner$16(Lcom/android/server/pm/ShortcutUser;)V
    .locals 1
...
.method private requestPinItem(Ljava/lang/String;ILandroid/content/pm/ShortcutInfo;Landroid/appwidget/AppWidgetProviderInfo;Landroid/os/Bundle;Landroid/content/IntentSender;I)Z
    ...
    invoke-direct {v1, p1, p2}, Lcom/android/server/pm/ShortcutService;->verifyCaller(Ljava/lang/String;I)V

    move-object v10, p1

    invoke-direct {v1, v10, v9}, Lcom/android/server/pm/ShortcutService;->verifyShortcutInfoPackage(Ljava/lang/String;Landroid/content/pm/ShortcutInfo;)V

    iget-object v11, v1, Lcom/android/server/pm/ShortcutService;->mLock:Ljava/lang/Object;
    ...
    invoke-virtual {v1}, Lcom/android/server/pm/ShortcutService;->injectBinderCallingUid()I

    move-result v0

    invoke-virtual {v1, v0}, Lcom/android/server/pm/ShortcutService;->isUidForegroundLocked(I)Z
    ...
    invoke-virtual {v1, v10, v12}, Lcom/android/server/pm/ShortcutService;->getPackageShortcutsForPublisherLocked(Ljava/lang/String;I)Lcom/android/server/pm/ShortcutPackage;
    ...
    invoke-virtual {v0, v2}, Lcom/android/server/pm/ShortcutPackage;->isShortcutExistsAndInvisibleToPublisher(Ljava/lang/String;)Z

    move-result v3

    if-eqz v3, :cond_0

    invoke-virtual {v0, v9}, Lcom/android/server/pm/ShortcutPackage;->updateInvisibleShortcutForPinRequestWith(Landroid/content/pm/ShortcutInfo;)V

    invoke-virtual {v1, v10, v12}, Lcom/android/server/pm/ShortcutService;->packageShortcutsChanged(Ljava/lang/String;I)V
    ...
    invoke-virtual/range {v2 .. v8}, Lcom/android/server/pm/ShortcutRequestPinProcessor;->requestPinItemLocked(Landroid/content/pm/ShortcutInfo;Landroid/appwidget/AppWidgetProviderInfo;Landroid/os/Bundle;ILandroid/content/IntentSender;I)Z
...
.method private rescanUpdatedPackagesLocked(IJZ)V
    ...
    new-instance v9, Lcom/android/server/pm/-$$Lambda$ShortcutService$luXbgCIL_ky8Z8V4DxgdIlBHF04;

    invoke-direct {v9, p0, v0, p1, p4}, Lcom/android/server/pm/-$$Lambda$ShortcutService$luXbgCIL_ky8Z8V4DxgdIlBHF04;-><init>(Lcom/android/server/pm/ShortcutService;Lcom/android/server/pm/ShortcutUser;IZ)V
...
.method private verifyStatesInner()V
    ...
    :try_start_0
    sget-object v1, Lcom/android/server/pm/-$$Lambda$ShortcutService$nwkPYf_FPYSlk4GVF72g0T4-xqo;->INSTANCE:Lcom/android/server/pm/-$$Lambda$ShortcutService$nwkPYf_FPYSlk4GVF72g0T4-xqo;
...
.method public applyRestore([BI)V
    ...
    new-instance v3, Lcom/android/server/pm/-$$Lambda$ShortcutService$nr2YpVwPOGGO8CME0IHeIUIo4yk;

    invoke-direct {v3, p0}, Lcom/android/server/pm/-$$Lambda$ShortcutService$nr2YpVwPOGGO8CME0IHeIUIo4yk;-><init>(Lcom/android/server/pm/ShortcutService;)V
    ...
    new-instance v5, Lcom/android/server/pm/-$$Lambda$ShortcutService$4wergOcS-Uk5sLBmde15u-sAUV4;

    invoke-direct {v5, p0}, Lcom/android/server/pm/-$$Lambda$ShortcutService$4wergOcS-Uk5sLBmde15u-sAUV4;-><init>(Lcom/android/server/pm/ShortcutService;)V
...
.method public getBackupPayload(I)[B
    ...
    :cond_1
    sget-object v3, Lcom/android/server/pm/-$$Lambda$ShortcutService$czpyyFh3OpxQSZgJ1UuQLPlktn8;->INSTANCE:Lcom/android/server/pm/-$$Lambda$ShortcutService$czpyyFh3OpxQSZgJ1UuQLPlktn8;

    invoke-virtual {v1, v3}, Lcom/android/server/pm/ShortcutUser;->forAllPackageItems(Ljava/util/function/Consumer;)V

    sget-object v3, Lcom/android/server/pm/-$$Lambda$ShortcutService$BgapJrdquo1OPe4VggDVe-adDMo;->INSTANCE:Lcom/android/server/pm/-$$Lambda$ShortcutService$BgapJrdquo1OPe4VggDVe-adDMo;

    invoke-virtual {v1, v3}, Lcom/android/server/pm/ShortcutUser;->forAllPackages(Ljava/util/function/Consumer;)V

    sget-object v3, Lcom/android/server/pm/-$$Lambda$ShortcutService$qZKocFWzizz4DG9R0afdFN-7cLQ;->INSTANCE:Lcom/android/server/pm/-$$Lambda$ShortcutService$qZKocFWzizz4DG9R0afdFN-7cLQ;
...
.method public getBackupShortcut(I)Landroid/os/ParcelFileDescriptor;
    ...
    :cond_1
    sget-object v3, Lcom/android/server/pm/-$$Lambda$ShortcutService$Y71dxUsD_muV66ZYWEhG8jKcp-Y;->INSTANCE:Lcom/android/server/pm/-$$Lambda$ShortcutService$Y71dxUsD_muV66ZYWEhG8jKcp-Y;

    invoke-virtual {v1, v3}, Lcom/android/server/pm/ShortcutUser;->forAllPackageItems(Ljava/util/function/Consumer;)V

    sget-object v3, Lcom/android/server/pm/-$$Lambda$ShortcutService$n4goLnVD5Bl6miK0tv5RyB8Fedc;->INSTANCE:Lcom/android/server/pm/-$$Lambda$ShortcutService$n4goLnVD5Bl6miK0tv5RyB8Fedc;
...
.method public getBitmapPathList(I)[Ljava/lang/String;
    ...
    new-instance v2, Lcom/android/server/pm/-$$Lambda$ShortcutService$HbMwYI1ucsWZ88QO3HX_8d22N0Q;

    invoke-direct {v2, v0}, Lcom/android/server/pm/-$$Lambda$ShortcutService$HbMwYI1ucsWZ88QO3HX_8d22N0Q;-><init>(Ljava/util/ArrayList;)V
...
.method getDefaultLauncher(I)Landroid/content/ComponentName;
    ...
    iget-object v15, v1, Lcom/android/server/pm/ShortcutService;->mContext:Landroid/content/Context;

    invoke-static {v15}, Lcom/samsung/android/desktopmode/DesktopModeFeature;->isDesktopMode(Landroid/content/Context;)Z
    ...
    const-string v15, "com.sec.android.app.desktoplauncher"
    ...
    const-string v7, "Ignore DeX Home on getLastKnownLauncher: "
    ...
    const-string v15, "Cached launcher "

    invoke-virtual {v13, v15}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v13, v14}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    const-string v15, " no longer exists"
...
.method protected openIconFileForWriteSmartSwitch(ILjava/lang/String;Ljava/lang/String;)Ljava/io/FileOutputStream;
    ...
    const-string v3, "Unable to create file - already exists "
...
.method public restoreBitmapsFromBackupService(Landroid/os/ParcelFileDescriptor;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v2, p2, p3}, Lcom/android/server/pm/ShortcutService;->openIconFileForWriteSmartSwitch(ILjava/lang/String;Ljava/lang/String;)Ljava/io/FileOutputStream;
