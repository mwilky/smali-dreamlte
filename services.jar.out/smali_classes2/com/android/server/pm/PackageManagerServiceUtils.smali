...
.method public static getPackagesForDexopt(Ljava/util/Collection;Lcom/android/server/pm/PackageManagerService;)Ljava/util/List;
    ...
    sget-object v4, Lcom/android/server/pm/-$$Lambda$PackageManagerServiceUtils$kn9eLAtCSZB5gvEAnNPnKd8qi2I;->INSTANCE:Lcom/android/server/pm/-$$Lambda$PackageManagerServiceUtils$kn9eLAtCSZB5gvEAnNPnKd8qi2I;

    invoke-static {v4, v1, v0, v2, p1}, Lcom/android/server/pm/PackageManagerServiceUtils;->applyPackageFilter(Ljava/util/function/Predicate;Ljava/util/Collection;Ljava/util/Collection;Ljava/util/List;Lcom/android/server/pm/PackageManagerService;)V
    ...
    invoke-static {v4, v5}, Lcom/android/server/pm/PackageManagerServiceUtils;->getPackageNamesForIntent(Landroid/content/Intent;I)Landroid/util/ArraySet;

    move-result-object v5

    new-instance v6, Lcom/android/server/pm/-$$Lambda$PackageManagerServiceUtils$Iy0sECcs_IeYr9HKXFHH9pDWqe8;

    invoke-direct {v6, v5}, Lcom/android/server/pm/-$$Lambda$PackageManagerServiceUtils$Iy0sECcs_IeYr9HKXFHH9pDWqe8;-><init>(Landroid/util/ArraySet;)V
    ...
    new-instance v7, Lcom/android/server/pm/-$$Lambda$PackageManagerServiceUtils$c-dGaXsmGOu661bqprnoiwpU_u4;

    invoke-direct {v7, v6}, Lcom/android/server/pm/-$$Lambda$PackageManagerServiceUtils$c-dGaXsmGOu661bqprnoiwpU_u4;-><init>(Lcom/android/server/pm/dex/DexManager;)V

    invoke-static {v7, v1, v0, v2, p1}, Lcom/android/server/pm/PackageManagerServiceUtils;->applyPackageFilter(Ljava/util/function/Predicate;Ljava/util/Collection;Ljava/util/Collection;Ljava/util/List;Lcom/android/server/pm/PackageManagerService;)V
    ...
    sget-object v7, Lcom/android/server/pm/-$$Lambda$PackageManagerServiceUtils$Q7ryK_U_j8oS1_VFYB6pS_hheCk;->INSTANCE:Lcom/android/server/pm/-$$Lambda$PackageManagerServiceUtils$Q7ryK_U_j8oS1_VFYB6pS_hheCk;

    invoke-static {v0, v7}, Ljava/util/Collections;->max(Ljava/util/Collection;Ljava/util/Comparator;)Ljava/lang/Object;
    ...
    invoke-virtual {v7}, Landroid/content/pm/PackageParser$Package;->getLatestForegroundPackageUseTimeInMills()J
    ...
    new-instance v12, Lcom/android/server/pm/-$$Lambda$PackageManagerServiceUtils$S-WLz0BZO3t7yIZeI8iORGXQIws;

    invoke-direct {v12, v10, v11}, Lcom/android/server/pm/-$$Lambda$PackageManagerServiceUtils$S-WLz0BZO3t7yIZeI8iORGXQIws;-><init>(J)V
    ...
    :cond_1
    sget-object v10, Lcom/android/server/pm/-$$Lambda$PackageManagerServiceUtils$eG_tkLBmCbURIz5MuvmgYamj8jM;->INSTANCE:Lcom/android/server/pm/-$$Lambda$PackageManagerServiceUtils$eG_tkLBmCbURIz5MuvmgYamj8jM;
...
.method static synthetic lambda$getPackagesForDexopt$2(Landroid/content/pm/PackageParser$Package;)Z
    .locals 1
...
.method static synthetic lambda$getPackagesForDexopt$3(Landroid/util/ArraySet;Landroid/content/pm/PackageParser$Package;)Z
    .locals 1
...
.method static synthetic lambda$getPackagesForDexopt$4(Lcom/android/server/pm/dex/DexManager;Landroid/content/pm/PackageParser$Package;)Z
    .locals 1
...
.method static synthetic lambda$getPackagesForDexopt$5(Landroid/content/pm/PackageParser$Package;Landroid/content/pm/PackageParser$Package;)I
    .locals 4
...
.method static synthetic lambda$getPackagesForDexopt$6(JLandroid/content/pm/PackageParser$Package;)Z
    .locals 2
...
.method static synthetic lambda$getPackagesForDexopt$8(Landroid/content/pm/PackageParser$Package;)Z
    .locals 1
