...
.method public constructor <init>(Lcom/android/server/pm/PackageInstallerService$InternalCallback;Landroid/content/Context;Lcom/android/server/pm/PackageManagerService;Landroid/os/Looper;IILjava/lang/String;ILandroid/content/pm/PackageInstaller$SessionParams;JLjava/io/File;Ljava/lang/String;ZZ)V
    ...
    iput-object v8, v1, Lcom/android/server/pm/PackageInstallerSession;->mFds:Ljava/util/ArrayList;

    new-instance v8, Ljava/util/ArrayList;

    invoke-direct {v8}, Ljava/util/ArrayList;-><init>()V

    iput-object v8, v1, Lcom/android/server/pm/PackageInstallerSession;->mBridges:Ljava/util/ArrayList;

    new-instance v8, Ljava/util/ArrayList;

    invoke-direct {v8}, Ljava/util/ArrayList;-><init>()V

    iput-object v8, v1, Lcom/android/server/pm/PackageInstallerSession;->mResolvedStagedFiles:Ljava/util/List;

    new-instance v8, Ljava/util/ArrayList;

    invoke-direct {v8}, Ljava/util/ArrayList;-><init>()V

    iput-object v8, v1, Lcom/android/server/pm/PackageInstallerSession;->mResolvedInheritedFiles:Ljava/util/List;

    new-instance v8, Ljava/util/ArrayList;

    invoke-direct {v8}, Ljava/util/ArrayList;-><init>()V

    iput-object v8, v1, Lcom/android/server/pm/PackageInstallerSession;->mResolvedInstructionSets:Ljava/util/List;

    new-instance v8, Ljava/util/ArrayList;

    invoke-direct {v8}, Ljava/util/ArrayList;-><init>()V

    iput-object v8, v1, Lcom/android/server/pm/PackageInstallerSession;->mResolvedNativeLibPaths:Ljava/util/List;

    new-instance v8, Lcom/android/server/pm/PackageInstallerSession$3;

    invoke-direct {v8, v1}, Lcom/android/server/pm/PackageInstallerSession$3;-><init>(Lcom/android/server/pm/PackageInstallerSession;)V

    iput-object v8, v1, Lcom/android/server/pm/PackageInstallerSession;->mHandlerCallback:Landroid/os/Handler$Callback;

    move-object/from16 v8, p1

    iput-object v8, v1, Lcom/android/server/pm/PackageInstallerSession;->mCallback:Lcom/android/server/pm/PackageInstallerService$InternalCallback;

    move-object/from16 v9, p2

    iput-object v9, v1, Lcom/android/server/pm/PackageInstallerSession;->mContext:Landroid/content/Context;

    move-object/from16 v10, p3

    iput-object v10, v1, Lcom/android/server/pm/PackageInstallerSession;->mPm:Lcom/android/server/pm/PackageManagerService;
    ...
    iput-object v11, v1, Lcom/android/server/pm/PackageInstallerSession;->mHandler:Landroid/os/Handler;
    ...
    iput-wide v14, v1, Lcom/android/server/pm/PackageInstallerSession;->createdMillis:J

    iput-object v6, v1, Lcom/android/server/pm/PackageInstallerSession;->stageDir:Ljava/io/File;

    iput-object v7, v1, Lcom/android/server/pm/PackageInstallerSession;->stageCid:Ljava/lang/String;
    ...
    iput-boolean v12, v1, Lcom/android/server/pm/PackageInstallerSession;->mPrepared:Z
    ...
    invoke-virtual {v0, v4, v6, v7}, Lcom/android/server/pm/PackageManagerService;->getPackageUid(Ljava/lang/String;II)I
    ...
    iget-object v4, v1, Lcom/android/server/pm/PackageInstallerSession;->mHandler:Landroid/os/Handler;
    ...
    const-string v5, "InstallLogger: PackageInstallerSession(): createInstallTimeInfo("
...
.method private allocateSessionIdLockedtemp()Ljava/lang/String;
    ...
    const-string v1, "inside method allocateSessionIdLockedtemp()"
...
.method private calculateInstalledSize()J
    ...
    :cond_3
    new-instance v11, Landroid/content/pm/PackageParser$PackageLite;
    ...
    invoke-static {v2, v1, v3}, Lcom/android/internal/content/PackageHelper;->calculateInstalledSize(Landroid/content/pm/PackageParser$PackageLite;ZLjava/lang/String;)J
    ...
    const-string v7, "Failed to calculate install size"

    invoke-direct {v5, v6, v7, v3}, Lcom/android/server/pm/PackageManagerException;-><init>(ILjava/lang/String;Ljava/lang/Throwable;)V
...
.method private commitLocked()V
    ...
    invoke-virtual {v0, v1, v2}, Lcom/android/server/pm/PackageInstallTimeLogger;->updateInstallTimeInfo(ILjava/lang/String;)V
    ...
    invoke-direct {p0}, Lcom/android/server/pm/PackageInstallerSession;->checkSettingsForDirectSdInstall()Z
    ...
    invoke-direct {p0, v2, v0, v1}, Lcom/android/server/pm/PackageInstallerSession;->resizeContainerForSd(Ljava/lang/String;J)V
    ...
    invoke-virtual {v1, v3, v4}, Lcom/android/server/pm/PackageInstallTimeLogger;->changeInstallTimeInfoKey(II)V
    ...
    invoke-virtual/range {v3 .. v12}, Lcom/android/server/pm/PackageManagerService;->installStage(Ljava/lang/String;Ljava/io/File;Ljava/lang/String;Landroid/content/pm/IPackageInstallObserver2;Landroid/content/pm/PackageInstaller$SessionParams;Ljava/lang/String;ILandroid/os/UserHandle;Landroid/content/pm/PackageParser$SigningDetails;)V
...
.method private doWriteInternal(Ljava/lang/String;JJLandroid/os/ParcelFileDescriptor;)Landroid/os/ParcelFileDescriptor;
    ...
    invoke-virtual {v0, v8, v11, v12, v7}, Landroid/os/storage/StorageManager;->allocateBytes(Ljava/io/FileDescriptor;JI)V
    ...
    invoke-static {v8, v3, v4, v0}, Landroid/system/Os;->lseek(Ljava/io/FileDescriptor;JI)J
    ...
    iget-object v5, v1, Lcom/android/server/pm/PackageInstallerSession;->mFds:Ljava/util/ArrayList;
    ...
    :cond_7
    iget-object v5, v1, Lcom/android/server/pm/PackageInstallerSession;->mBridges:Ljava/util/ArrayList;
    ...
    invoke-virtual {v13, v0, v3}, Landroid/os/RevocableFileDescriptor;->init(Landroid/content/Context;Ljava/io/FileDescriptor;)V

    invoke-virtual {v13}, Landroid/os/RevocableFileDescriptor;->getRevocableFileDescriptor()Landroid/os/ParcelFileDescriptor;
    ...
    :cond_9
    invoke-virtual {v14, v3}, Landroid/os/FileBridge;->setTargetFile(Ljava/io/FileDescriptor;)V

    invoke-virtual {v14}, Landroid/os/FileBridge;->start()V

    new-instance v0, Landroid/os/ParcelFileDescriptor;

    invoke-virtual {v14}, Landroid/os/FileBridge;->getClientSocket()Ljava/io/FileDescriptor;

    move-result-object v4

    invoke-direct {v0, v4}, Landroid/os/ParcelFileDescriptor;-><init>(Ljava/io/FileDescriptor;)V
...
.method private resizeContainerForSd(Ljava/lang/String;J)V
    ...
    invoke-static {v0}, Lcom/android/internal/content/PackageHelper;->unMountSdDir(Ljava/lang/String;)Z
...
.method private resolveStageDirLocked()Ljava/io/File;
    ...
    const-string v3, "Failed to resolve path to container "
...
.method public abandon()V
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/pm/PackageInstallTimeLogger;->abandonInstallTimeInfo(I)V
