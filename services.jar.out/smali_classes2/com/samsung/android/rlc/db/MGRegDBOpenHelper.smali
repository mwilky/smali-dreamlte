...
.method public onCreate(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    const-string v0, "CREATE TABLE rmmreg ( _id INTEGER PRIMARY KEY autoincrement, pushreg TEXT,pushtype TEXT,dlvurl TEXT,savetime DATETIME DEFAULT (date(\'now\')))"

    const-string v1, "CREATE TABLE rmmpref ( _id INTEGER PRIMARY KEY autoincrement, key TEXT,value TEXT,savetime DATETIME DEFAULT (date(\'now\')))"
    ...
    const-string v4, "Create DB FAIL"
