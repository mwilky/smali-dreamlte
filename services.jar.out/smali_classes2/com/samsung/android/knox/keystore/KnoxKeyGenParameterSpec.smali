...
# direct methods
.method private constructor <init>(ZLjava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;[Z[Ljava/lang/String;Ljava/lang/String;Z[BLandroid/security/keystore/KeyGenParameterSpec;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Z",
    ...
    iput-object p11, p0, Lcom/samsung/android/knox/keystore/KnoxKeyGenParameterSpec;->mKeyGenParameterSpec:Landroid/security/keystore/KeyGenParameterSpec;
    ...
    iput-object p4, p0, Lcom/samsung/android/knox/keystore/KnoxKeyGenParameterSpec;->mAccessorIdentities:Ljava/util/List;

    iput-object p5, p0, Lcom/samsung/android/knox/keystore/KnoxKeyGenParameterSpec;->mAdministratorIdentities:Ljava/util/List;

    iput-object p6, p0, Lcom/samsung/android/knox/keystore/KnoxKeyGenParameterSpec;->mKeyUsage:[Z

    iput-object p7, p0, Lcom/samsung/android/knox/keystore/KnoxKeyGenParameterSpec;->mExtendedKeyUsage:[Ljava/lang/String;

    iput-object p8, p0, Lcom/samsung/android/knox/keystore/KnoxKeyGenParameterSpec;->mAttestationRoot:Ljava/lang/String;

    iput-boolean p9, p0, Lcom/samsung/android/knox/keystore/KnoxKeyGenParameterSpec;->mKnoxCsrResponseRequired:Z

    iput-boolean p1, p0, Lcom/samsung/android/knox/keystore/KnoxKeyGenParameterSpec;->mKnoxObjectProtectionRequired:Z

    iput-object p10, p0, Lcom/samsung/android/knox/keystore/KnoxKeyGenParameterSpec;->mSubjectAlternativeName:[B

    return-void
.end method

.method synthetic constructor <init>(ZLjava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;[Z[Ljava/lang/String;Ljava/lang/String;Z[BLandroid/security/keystore/KeyGenParameterSpec;Lcom/samsung/android/knox/keystore/KnoxKeyGenParameterSpec$1;)V
    .locals 0

    invoke-direct/range {p0 .. p11}, Lcom/samsung/android/knox/keystore/KnoxKeyGenParameterSpec;-><init>(ZLjava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;[Z[Ljava/lang/String;Ljava/lang/String;Z[BLandroid/security/keystore/KeyGenParameterSpec;)V
...
.method public getAccessorIdentities()Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/samsung/android/knox/keystore/KnoxKeyGenParameterSpec;->mAccessorIdentities:Ljava/util/List;
...
.method public getAdministratorIdentities()Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/samsung/android/knox/keystore/KnoxKeyGenParameterSpec;->mAdministratorIdentities:Ljava/util/List;
