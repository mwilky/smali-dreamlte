...
.method private getDecryptedData(Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    invoke-static {v3}, Lcom/samsung/android/friends/util/UtilStringCrypto;->decryption(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v6

    invoke-virtual {v4, v5, v6}, Lcom/samsung/android/friends/common/BundleFrs$Builder;->put(Ljava/lang/String;Ljava/lang/String;)Lcom/samsung/android/friends/common/BundleFrs$Builder;
    ...
    invoke-static {v3}, Lcom/samsung/android/friends/util/UtilStringCrypto;->decryption([B)[B

    move-result-object v6

    invoke-virtual {v4, v5, v6}, Lcom/samsung/android/friends/common/BundleFrs$Builder;->put(Ljava/lang/String;[B)Lcom/samsung/android/friends/common/BundleFrs$Builder;
...
.method private getDecryptedMultipleData(Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    new-instance v4, Lcom/samsung/android/friends/executable/-$$Lambda$ExecStringCrypto$xqv6Udqk07UkSi13xYJz90Pf4No;

    invoke-direct {v4, v3}, Lcom/samsung/android/friends/executable/-$$Lambda$ExecStringCrypto$xqv6Udqk07UkSi13xYJz90Pf4No;-><init>(Ljava/util/ArrayList;)V
    ...
    invoke-direct {p0, v2, v3, v4}, Lcom/samsung/android/friends/executable/ExecStringCrypto;->mergeEncryptedData([BLjava/util/ArrayList;Z)Landroid/util/Pair;
...
.method private getEncryptedData(Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    invoke-static {v3}, Lcom/samsung/android/friends/util/UtilStringCrypto;->encryption(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v3}, Lcom/samsung/android/friends/util/UtilStringCrypto;->encryption([B)[B
...
.method private getEncryptedMultipleData(Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    new-instance v4, Lcom/samsung/android/friends/executable/-$$Lambda$ExecStringCrypto$8UxYyVVMhkQ75kzpjqFUamq6RpM;

    invoke-direct {v4, v3}, Lcom/samsung/android/friends/executable/-$$Lambda$ExecStringCrypto$8UxYyVVMhkQ75kzpjqFUamq6RpM;-><init>(Ljava/util/ArrayList;)V
...
.method private mergeEncryptedData([BLjava/util/ArrayList;Z)Landroid/util/Pair;
    ...
    invoke-static {v7}, Lcom/samsung/android/friends/util/UtilStringCrypto;->encryption([B)[B
    ...
    :cond_1
    invoke-static {v7}, Lcom/samsung/android/friends/util/UtilStringCrypto;->decryption([B)[B
    ...
    invoke-static {v4, v9, v10}, Lcom/samsung/android/friends/util/LogFrs;->e(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
