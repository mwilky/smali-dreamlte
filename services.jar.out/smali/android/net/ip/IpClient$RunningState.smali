...
.method private createPacketTracker()Landroid/net/ip/ConnectivityPacketTracker;
    ...
    invoke-static {v2}, Landroid/net/ip/IpClient;->access$2900(Landroid/net/ip/IpClient;)Landroid/net/util/InterfaceParams;

    move-result-object v2

    iget-object v3, p0, Landroid/net/ip/IpClient$RunningState;->this$0:Landroid/net/ip/IpClient;

    invoke-static {v3}, Landroid/net/ip/IpClient;->access$3700(Landroid/net/ip/IpClient;)Landroid/util/LocalLog;
...
.method private ensureDhcpAction()V
    ...
    invoke-static {v2}, Landroid/net/ip/IpClient;->access$3800(Landroid/net/ip/IpClient;)Lcom/android/internal/util/WakeupMessage;
...
.method private stopDhcpAction()V
    ...
    invoke-static {v0}, Landroid/net/ip/IpClient;->access$3800(Landroid/net/ip/IpClient;)Lcom/android/internal/util/WakeupMessage;
...
.method public enter()V
    ...
    invoke-static {v1}, Landroid/net/ip/IpClient;->access$2700(Landroid/net/ip/IpClient;)Landroid/content/Context;
    ...
    invoke-static {v2}, Landroid/net/ip/IpClient;->access$2700(Landroid/net/ip/IpClient;)Landroid/content/Context;

    move-result-object v2

    iget-object v3, p0, Landroid/net/ip/IpClient$RunningState;->this$0:Landroid/net/ip/IpClient;

    invoke-static {v3}, Landroid/net/ip/IpClient;->access$2900(Landroid/net/ip/IpClient;)Landroid/net/util/InterfaceParams;
    ...
    invoke-static {v1, v2}, Landroid/net/ip/IpClient;->access$2802(Landroid/net/ip/IpClient;Landroid/net/apf/ApfFilter;)Landroid/net/apf/ApfFilter;

    iget-object v1, p0, Landroid/net/ip/IpClient$RunningState;->this$0:Landroid/net/ip/IpClient;

    invoke-static {v1}, Landroid/net/ip/IpClient;->access$2800(Landroid/net/ip/IpClient;)Landroid/net/apf/ApfFilter;
    ...
    invoke-static {v1}, Landroid/net/ip/IpClient;->access$3000(Landroid/net/ip/IpClient;)Z
    ...
    invoke-static {v1, v2}, Landroid/net/ip/IpClient;->access$3100(Landroid/net/ip/IpClient;I)V
    ...
    invoke-static {v1}, Landroid/net/ip/IpClient;->access$3200(Landroid/net/ip/IpClient;)Z
    ...
    invoke-static {v2, v1}, Landroid/net/ip/IpClient;->access$3300(Landroid/net/ip/IpClient;Landroid/net/ip/IpClient$InitialConfiguration;)Z
    ...
    invoke-static {v2, v3}, Landroid/net/ip/IpClient;->access$3100(Landroid/net/ip/IpClient;I)V
    ...
    invoke-static {v4}, Landroid/net/ip/IpClient;->access$2700(Landroid/net/ip/IpClient;)Landroid/content/Context;
    ...
    invoke-static {v2, v3}, Landroid/net/ip/IpClient;->access$3402(Landroid/net/ip/IpClient;Landroid/net/util/MultinetworkPolicyTracker;)Landroid/net/util/MultinetworkPolicyTracker;

    iget-object v2, p0, Landroid/net/ip/IpClient$RunningState;->this$0:Landroid/net/ip/IpClient;

    invoke-static {v2}, Landroid/net/ip/IpClient;->access$3400(Landroid/net/ip/IpClient;)Landroid/net/util/MultinetworkPolicyTracker;
    ...
    invoke-static {v2}, Landroid/net/ip/IpClient;->access$3500(Landroid/net/ip/IpClient;)Z
...
.method public exit()V
    ...
    invoke-static {v0}, Landroid/net/ip/IpClient;->access$3600(Landroid/net/ip/IpClient;)Landroid/net/ip/IpReachabilityMonitor;
    ...
    invoke-static {v0, v1}, Landroid/net/ip/IpClient;->access$3602(Landroid/net/ip/IpClient;Landroid/net/ip/IpReachabilityMonitor;)Landroid/net/ip/IpReachabilityMonitor;

    :cond_0
    iget-object v0, p0, Landroid/net/ip/IpClient$RunningState;->this$0:Landroid/net/ip/IpClient;

    invoke-static {v0}, Landroid/net/ip/IpClient;->access$3400(Landroid/net/ip/IpClient;)Landroid/net/util/MultinetworkPolicyTracker;
    ...
    invoke-static {v0, v1}, Landroid/net/ip/IpClient;->access$3402(Landroid/net/ip/IpClient;Landroid/net/util/MultinetworkPolicyTracker;)Landroid/net/util/MultinetworkPolicyTracker;
    ...
    invoke-static {v0}, Landroid/net/ip/IpClient;->access$2800(Landroid/net/ip/IpClient;)Landroid/net/apf/ApfFilter;
    ...
    invoke-static {v0, v1}, Landroid/net/ip/IpClient;->access$2802(Landroid/net/ip/IpClient;Landroid/net/apf/ApfFilter;)Landroid/net/apf/ApfFilter;
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v5}, Landroid/net/ip/IpClient;->access$2600(Landroid/net/ip/IpClient;)Landroid/net/LinkProperties;

    move-result-object v5

    invoke-direct {v4, v5}, Landroid/net/LinkProperties;-><init>(Landroid/net/LinkProperties;)V

    invoke-static {v2, v3, v4}, Landroid/net/ip/IpClient;->access$4000(Landroid/net/ip/IpClient;Landroid/net/LinkProperties$ProvisioningChange;Landroid/net/LinkProperties;)V
    ...
    invoke-static {v0}, Landroid/net/ip/IpClient;->access$4200(Landroid/net/ip/IpClient;)V
    ...
    const-string v3, "Unknown DHCP_FAILURE reason: %s"
    ...
    invoke-virtual {v0, v2}, Landroid/net/ip/IpClient$Callback;->onSemLog(I)V
    ...
    invoke-virtual {v0, v3}, Landroid/net/ip/IpClient$Callback;->onSemLog(I)V
    ...
    check-cast v3, Landroid/net/DhcpResults;

    invoke-static {v0, v3}, Landroid/net/ip/IpClient;->access$4100(Landroid/net/ip/IpClient;Landroid/net/DhcpResults;)V
    ...
    invoke-static {v0}, Landroid/net/ip/IpClient;->access$3900(Landroid/net/ip/IpClient;)Landroid/os/ConditionVariable;
