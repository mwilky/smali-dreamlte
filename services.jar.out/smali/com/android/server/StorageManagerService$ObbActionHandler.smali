...
.method private connectToService()Z
    ...
    invoke-static {v1}, Lcom/android/server/StorageManagerService;->access$1700(Lcom/android/server/StorageManagerService;)Landroid/content/Context;
    ...
    invoke-static {v2}, Lcom/android/server/StorageManagerService;->access$4700(Lcom/android/server/StorageManagerService;)Lcom/android/server/StorageManagerService$DefaultContainerConnection;
...
.method private disconnectService()V
    ...
    invoke-static {v0, v1}, Lcom/android/server/StorageManagerService;->access$4302(Lcom/android/server/StorageManagerService;Lcom/android/internal/app/IMediaContainerService;)Lcom/android/internal/app/IMediaContainerService;
    ...
    invoke-static {v0}, Lcom/android/server/StorageManagerService;->access$1700(Lcom/android/server/StorageManagerService;)Landroid/content/Context;

    move-result-object v0

    iget-object v1, p0, Lcom/android/server/StorageManagerService$ObbActionHandler;->this$0:Lcom/android/server/StorageManagerService;

    invoke-static {v1}, Lcom/android/server/StorageManagerService;->access$4700(Lcom/android/server/StorageManagerService;)Lcom/android/server/StorageManagerService$DefaultContainerConnection;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v4, "Flushing all OBB state for path "
    ...
    invoke-static {v1}, Lcom/android/server/StorageManagerService;->access$4400(Lcom/android/server/StorageManagerService;)Ljava/util/Map;
    ...
    invoke-static {v4}, Lcom/android/server/StorageManagerService;->access$4500(Lcom/android/server/StorageManagerService;)Ljava/util/Map;
    ...
    invoke-static {v7, v6}, Lcom/android/server/StorageManagerService;->access$4600(Lcom/android/server/StorageManagerService;Lcom/android/server/StorageManagerService$ObbState;)V
    :try_end_0
    ...
    invoke-static {v8, v9}, Lcom/android/server/utils/sysfwutil/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I
    ...
    const-string v1, "OBB_MCS_RECONNECT"
    ...
    const-string v3, "OBB_MCS_UNBIND"

    invoke-static {v0, v3}, Lcom/android/server/utils/sysfwutil/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I
    ...
    const-string v2, "OBB_MCS_BOUND"

    invoke-static {v0, v2}, Lcom/android/server/utils/sysfwutil/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-static {v0, v2}, Lcom/android/server/StorageManagerService;->access$4302(Lcom/android/server/StorageManagerService;Lcom/android/internal/app/IMediaContainerService;)Lcom/android/internal/app/IMediaContainerService;
    ...
    const-string v4, "OBB_RUN_ACTION: "
