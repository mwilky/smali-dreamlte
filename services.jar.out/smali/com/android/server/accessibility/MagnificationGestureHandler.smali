...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/accessibility/MagnificationGestureHandler$ScreeningState;,
...
.field final mScreeningState:Lcom/android/server/accessibility/MagnificationGestureHandler$ScreeningState;
    .annotation build Lcom/android/internal/annotations/VisibleForTesting;
    .end annotation
.end field
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/accessibility/MagnificationController;ZZ)V
    ...
    new-instance v0, Lcom/android/server/accessibility/MagnificationGestureHandler$ScreeningState;

    invoke-direct {v0, p0}, Lcom/android/server/accessibility/MagnificationGestureHandler$ScreeningState;-><init>(Lcom/android/server/accessibility/MagnificationGestureHandler;)V

    iput-object v0, p0, Lcom/android/server/accessibility/MagnificationGestureHandler;->mScreeningState:Lcom/android/server/accessibility/MagnificationGestureHandler$ScreeningState;
    ...
    iput-object v0, p0, Lcom/android/server/accessibility/MagnificationGestureHandler;->mDisplay:Landroid/hardware/display/DisplayManager;

    new-instance v0, Lcom/android/server/accessibility/MagnificationGestureHandler$1;

    invoke-direct {v0, p0}, Lcom/android/server/accessibility/MagnificationGestureHandler$1;-><init>(Lcom/android/server/accessibility/MagnificationGestureHandler;)V

    iput-object v0, p0, Lcom/android/server/accessibility/MagnificationGestureHandler;->mDisplayListener:Landroid/hardware/display/DisplayManager$DisplayListener;

    iget-object v0, p0, Lcom/android/server/accessibility/MagnificationGestureHandler;->mDisplay:Landroid/hardware/display/DisplayManager;

    if-eqz v0, :cond_1

    iget-object v0, p0, Lcom/android/server/accessibility/MagnificationGestureHandler;->mDisplay:Landroid/hardware/display/DisplayManager;

    iget-object v2, p0, Lcom/android/server/accessibility/MagnificationGestureHandler;->mDisplayListener:Landroid/hardware/display/DisplayManager$DisplayListener;
...
.method static synthetic access$000(Lcom/android/server/accessibility/MagnificationGestureHandler;)Landroid/hardware/display/DisplayManager;
    .locals 1
...
.method static synthetic access$100(Lcom/android/server/accessibility/MagnificationGestureHandler;Lcom/android/server/accessibility/MagnificationGestureHandler$State;)V
    .locals 0
...
.method private handleEventWith(Lcom/android/server/accessibility/MagnificationGestureHandler$State;Landroid/view/MotionEvent;Landroid/view/MotionEvent;I)V
    ...
    invoke-static {v0}, Lcom/android/server/accessibility/MagnificationGestureHandler$PanningScalingState;->access$200(Lcom/android/server/accessibility/MagnificationGestureHandler$PanningScalingState;)Landroid/view/GestureDetector;
    ...
    invoke-static {v0}, Lcom/android/server/accessibility/MagnificationGestureHandler$PanningScalingState;->access$300(Lcom/android/server/accessibility/MagnificationGestureHandler$PanningScalingState;)Landroid/view/ScaleGestureDetector;
...
.method private onMotionEventInternal(Landroid/view/MotionEvent;Landroid/view/MotionEvent;I)V
    ...
    :cond_2
    :goto_0
    invoke-virtual {p0}, Lcom/android/server/accessibility/MagnificationGestureHandler;->getNext()Lcom/android/server/accessibility/EventStreamTransformation;
...
.method public onDestroy()V
    ...
    iget-object v1, p0, Lcom/android/server/accessibility/MagnificationGestureHandler;->mDisplayListener:Landroid/hardware/display/DisplayManager$DisplayListener;
