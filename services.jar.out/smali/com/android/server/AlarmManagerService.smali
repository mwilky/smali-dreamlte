...
.method reAddAlarmLocked(Lcom/android/server/AlarmManagerService$Alarm;JZ)V
    ...
    iget-wide v1, v0, Lcom/android/server/AlarmManagerService$Alarm;->origWhen:J

    iput-wide v1, v0, Lcom/android/server/AlarmManagerService$Alarm;->when:J

    iget-wide v1, v0, Lcom/android/server/AlarmManagerService$Alarm;->expectedWhenElapsed:J

    iget-wide v3, v0, Lcom/android/server/AlarmManagerService$Alarm;->whenElapsed:J

    sub-long/2addr v1, v3

    iget-wide v3, v0, Lcom/android/server/AlarmManagerService$Alarm;->expectedMaxWhenElapsed:J
    ...
    invoke-static {v5, v6, v7}, Lcom/android/server/AlarmManagerService;->convertToElapsed(JI)J
    ...
    invoke-static {v7, v8}, Lcom/android/server/AlarmManagerService;->clampPositive(J)J
    ...
    :goto_0
    iput-wide v5, v0, Lcom/android/server/AlarmManagerService$Alarm;->whenElapsed:J

    iput-wide v7, v0, Lcom/android/server/AlarmManagerService$Alarm;->maxWhenElapsed:J

    iget-wide v9, v0, Lcom/android/server/AlarmManagerService$Alarm;->whenElapsed:J

    add-long/2addr v9, v1

    iput-wide v9, v0, Lcom/android/server/AlarmManagerService$Alarm;->expectedWhenElapsed:J

    iget-wide v9, v0, Lcom/android/server/AlarmManagerService$Alarm;->maxWhenElapsed:J

    add-long/2addr v9, v3

    iput-wide v9, v0, Lcom/android/server/AlarmManagerService$Alarm;->expectedMaxWhenElapsed:J
    ...
    invoke-direct {v10, v0, v9, v11}, Lcom/android/server/AlarmManagerService;->setImplLocked(Lcom/android/server/AlarmManagerService$Alarm;ZZ)V
