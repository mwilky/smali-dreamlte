...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/display/DisplayManagerService$Injector;)V
    ...
    iput-object v1, p0, Lcom/android/server/display/DisplayManagerService;->mDisplayBrightnessListeners:Ljava/util/ArrayList;
...
.method static synthetic access$4800(Lcom/android/server/display/DisplayManagerService;)I
    .locals 1
...
.method static synthetic access$5000(Lcom/android/server/display/DisplayManagerService;Lcom/android/server/display/DisplayDevice;)Lcom/android/server/display/LogicalDisplay;
    .locals 1
...
.method static synthetic access$5200(Lcom/android/server/display/DisplayManagerService;Landroid/os/IBinder;III)V
    .locals 0
...
.method static synthetic access$5300(Lcom/android/server/display/DisplayManagerService;Landroid/os/IBinder;Landroid/view/Surface;)V
    .locals 0
...
.method static synthetic access$5400(Lcom/android/server/display/DisplayManagerService;Landroid/os/IBinder;)V
    .locals 0
...
.method static synthetic access$5500(Lcom/android/server/display/DisplayManagerService;)Lcom/android/server/display/WifiDisplayAdapter;
    .locals 1
...
.method static synthetic access$5600(Lcom/android/server/display/DisplayManagerService;Landroid/hardware/display/SemDeviceInfo;)V
    .locals 0
...
.method static synthetic access$5800(Lcom/android/server/display/DisplayManagerService;II)V
    .locals 0
...
.method static synthetic access$5900(Lcom/android/server/display/DisplayManagerService;)Landroid/util/SparseArray;
    .locals 1
...
.method static synthetic access$6000(Lcom/android/server/display/DisplayManagerService;Ljava/io/PrintWriter;[Ljava/lang/String;)Z
    .locals 1
...
.method static synthetic access$6400(Lcom/android/server/display/DisplayManagerService;)Landroid/os/UserManager;
    .locals 1
...
.method static synthetic access$6500(Lcom/android/server/display/DisplayManagerService;)Lcom/android/server/display/PersistentDataStore;
    .locals 1
...
.method static synthetic access$6600(Lcom/android/server/display/DisplayManagerService;IIII)V
    .locals 0
...
.method static synthetic access$6800(Lcom/android/server/display/DisplayManagerService;)Lcom/android/server/display/DisplayManagerService$DisplayManagerHandler;
    .locals 1
...
.method static synthetic access$6900(Lcom/android/server/display/DisplayManagerService;III)Landroid/view/DisplayInfo;
    .locals 1
...
.method static synthetic access$7100(Lcom/android/server/display/DisplayManagerService;Landroid/hardware/display/DisplayManagerInternal$DisplayTransactionListener;)V
    .locals 0
...
.method static synthetic access$7300(Lcom/android/server/display/DisplayManagerService;ILandroid/view/DisplayInfo;)V
    .locals 0
...
.method static synthetic access$7400(Lcom/android/server/display/DisplayManagerService;IZFIZ)V
    .locals 0
...
.method static synthetic access$7500(Lcom/android/server/display/DisplayManagerService;III)V
    .locals 0
...
.method static synthetic access$7600(Lcom/android/server/display/DisplayManagerService;Landroid/util/SparseArray;)V
    .locals 0
...
.method static synthetic access$7700(Lcom/android/server/display/DisplayManagerService;II)Z
    .locals 1
...
.method static synthetic access$7900(Lcom/android/server/display/DisplayManagerService;)Z
    .locals 1
...
.method static synthetic access$8100(Lcom/android/server/display/DisplayManagerService;)I
    .locals 1
...
.method static synthetic access$8300(Lcom/android/server/display/DisplayManagerService;Landroid/hardware/display/DisplayManagerInternal$DisplayBrightnessListener;)V
    .locals 0
...
.method static synthetic access$8400(Lcom/android/server/display/DisplayManagerService;Landroid/hardware/display/DisplayManagerInternal$DisplayBrightnessListener;)V
    .locals 0
...
.method private configureDisplayLocked(Landroid/view/SurfaceControl$Transaction;Lcom/android/server/display/DisplayDevice;)V
    ...
    invoke-direct {v0, v13}, Lcom/android/server/display/DisplayManagerService;->getDexLogicalDisplayLocked(Lcom/android/server/display/LogicalDisplay;)Lcom/android/server/display/LogicalDisplay;
    ...
    const-string v4, "configureDisplayLocked d#"
    ...
    const-string v4, ", so do not mirror dex display to hdmi"
    ...
    invoke-static {v14, v4}, Lcom/android/server/power/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-virtual {v6, v8, v1, v4}, Lcom/android/server/display/LogicalDisplay;->configureDisplayLocked(Landroid/view/SurfaceControl$Transaction;Lcom/android/server/display/DisplayDevice;Z)V
