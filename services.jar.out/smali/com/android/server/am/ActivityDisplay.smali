...
.method public dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    :cond_3
    iget v1, p0, Lcom/android/server/am/ActivityDisplay;->mDefaultMinSizeOfResizeableTask:I
    ...
    const-string/jumbo v2, "mDefaultMinSizeOfResizeableTask="

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v2, p0, Lcom/android/server/am/ActivityDisplay;->mDefaultMinSizeOfResizeableTask:I
...
.method resolveWindowingMode(Lcom/android/server/am/ActivityRecord;Landroid/app/ActivityOptions;Lcom/android/server/am/TaskRecord;I)I
    ...
    invoke-virtual/range {p3 .. p3}, Lcom/android/server/am/TaskRecord;->getDisplayId()I

    move-result v2

    iget v3, v7, Lcom/android/server/am/ActivityDisplay;->mDisplayId:I
    ...
    invoke-virtual {v7, v8}, Lcom/android/server/am/ActivityDisplay;->getWindowingMode(I)I

    move-result v1

    :cond_5
    iget-object v2, v7, Lcom/android/server/am/ActivityDisplay;->mSupervisor:Lcom/android/server/am/ActivityStackSupervisor;

    iget-object v10, v2, Lcom/android/server/am/ActivityStackSupervisor;->mService:Lcom/android/server/am/ActivityManagerService;

    iget-boolean v2, v10, Lcom/android/server/am/ActivityManagerService;->mSupportsMultiWindow:Z

    iget-boolean v3, v10, Lcom/android/server/am/ActivityManagerService;->mSupportsSplitScreenMultiWindow:Z

    iget-boolean v4, v10, Lcom/android/server/am/ActivityManagerService;->mSupportsFreeformWindowManagement:Z

    iget-boolean v5, v10, Lcom/android/server/am/ActivityManagerService;->mSupportsPictureInPicture:Z
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/android/server/am/ActivityDisplay;->isDexMode()Z
