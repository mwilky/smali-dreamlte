...
.method private computeBounds(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v2, v3}, Lcom/android/server/wm/AspectRatioController;->updateMaxAspectRatioIfNeeded(Landroid/content/pm/ActivityInfo;)F
    ...
    :cond_2
    invoke-virtual {p0}, Lcom/android/server/am/ActivityRecord;->isDexMode()Z
...
.method private updateOverrideConfiguration()V
    ...
    iget-object v2, p0, Lcom/android/server/am/ActivityRecord;->mTmpBounds:Landroid/graphics/Rect;
    ...
    :goto_0
    iput v2, v1, Landroid/app/WindowConfiguration;->mConventionalMode:I
...
.method createWindowContainer()V
    ...
    invoke-virtual {v1}, Lcom/android/server/am/TaskRecord;->isFullscreenFreeform()Z
    ...
    const-string v3, "com.samsung.android.sdk.multiwindow.freeform.border"
    ...
    invoke-virtual {v3, v2}, Lcom/android/server/wm/AppWindowContainerController;->setUseFreeformBorder(Z)V
    ...
    invoke-virtual {v1, v4}, Lcom/android/server/wm/AppWindowContainerController;->requestFreeformForceHiding(Z)V

    :cond_4
    iget-object v1, v0, Lcom/android/server/am/ActivityRecord;->info:Landroid/content/pm/ActivityInfo;

    iget v1, v1, Landroid/content/pm/ActivityInfo;->requestTransientBarDelay:I
    ...
    const-string/jumbo v3, "setTransientBarShowingDelay: delayMillis="

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v3, v0, Lcom/android/server/am/ActivityRecord;->info:Landroid/content/pm/ActivityInfo;

    iget v3, v3, Landroid/content/pm/ActivityInfo;->requestTransientBarDelay:I
    ...
    iget v2, v2, Landroid/content/pm/ActivityInfo;->requestTransientBarDelay:I

    invoke-virtual {v1, v2}, Lcom/android/server/wm/AppWindowContainerController;->setTransientBarShowingDelay(I)V
...
.method ensureActivityConfiguration(IZZ)Z
    ...
    invoke-virtual {v7, v1}, Lcom/android/server/am/MultiDisplayManagerService;->getDisplayConfiguration(I)Landroid/content/res/Configuration;
    ...
    iget-object v7, v7, Lcom/android/server/am/MultiDisplayManagerService;->mDexCompatController:Lcom/android/server/am/DexCompatController;

    iget-object v8, p0, Lcom/android/server/am/ActivityRecord;->processAppInfo:Landroid/content/pm/ApplicationInfo;

    invoke-virtual {p0}, Lcom/android/server/am/ActivityRecord;->getDisplayId()I

    move-result v9

    invoke-virtual {v7, v8, v9, p0}, Lcom/android/server/am/DexCompatController;->isDexCompatConfigurationTargetLocked(Landroid/content/pm/ApplicationInfo;ILcom/android/server/am/ActivityRecord;)Z
    ...
    invoke-direct {v9, v5}, Landroid/content/res/Configuration;-><init>(Landroid/content/res/Configuration;)V

    move-object v5, v9

    iget-object v9, p0, Lcom/android/server/am/ActivityRecord;->processAppInfo:Landroid/content/pm/ApplicationInfo;

    new-instance v10, Ljava/lang/StringBuilder;

    invoke-direct {v10}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v11, "ensureActivityConfig["
    ...
    invoke-virtual {v7, p0, v5, v9, v10}, Lcom/android/server/am/DexCompatController;->applyDexCompatConfigurationLocked(Lcom/android/server/am/ActivityRecord;Landroid/content/res/Configuration;Landroid/content/pm/ApplicationInfo;Ljava/lang/String;)V

    :cond_8
    iget-object v9, p0, Lcom/android/server/am/ActivityRecord;->mWindowContainerController:Lcom/android/server/wm/AppWindowContainerController;

    iget-object v10, p0, Lcom/android/server/am/ActivityRecord;->appToken:Landroid/view/IApplicationToken$Stub;

    invoke-virtual {v9, v10, v8}, Lcom/android/server/wm/AppWindowContainerController;->setWindowCompatMode(Landroid/os/IBinder;Z)V
...
.method public onWindowsGone()V
    ...
    invoke-virtual {v1, p0}, Lcom/android/server/am/MultiDisplayManagerService;->notifyAppWindowGone(Lcom/android/server/am/ActivityRecord;)V
...
.method relaunchActivityLocked(ZZ)V
    ...
    iget-object v6, v6, Lcom/android/server/am/ActivityManagerService;->mMultiDisplayManager:Lcom/android/server/am/MultiDisplayManagerService;

    iget-object v7, p0, Lcom/android/server/am/ActivityRecord;->app:Lcom/android/server/am/ProcessRecord;

    invoke-virtual {v7}, Lcom/android/server/am/ProcessRecord;->getDisplayId()I

    move-result v7

    invoke-virtual {v6, v7}, Lcom/android/server/am/MultiDisplayManagerService;->getDisplayConfiguration(I)Landroid/content/res/Configuration;

    move-result-object v6

    invoke-virtual {v3, v6}, Landroid/content/res/Configuration;->setTo(Landroid/content/res/Configuration;)V
    ...
    iget-object v6, v6, Lcom/android/server/am/MultiDisplayManagerService;->mDexCompatController:Lcom/android/server/am/DexCompatController;

    iget-object v7, p0, Lcom/android/server/am/ActivityRecord;->processAppInfo:Landroid/content/pm/ApplicationInfo;

    invoke-virtual {p0}, Lcom/android/server/am/ActivityRecord;->getDisplayId()I

    move-result v8

    invoke-virtual {v6, v7, v8, p0}, Lcom/android/server/am/DexCompatController;->isDexCompatConfigurationTargetLocked(Landroid/content/pm/ApplicationInfo;ILcom/android/server/am/ActivityRecord;)Z
    ...
    invoke-virtual {v6, p0, v3, v7, v8}, Lcom/android/server/am/DexCompatController;->applyDexCompatConfigurationLocked(Lcom/android/server/am/ActivityRecord;Landroid/content/res/Configuration;Landroid/content/pm/ApplicationInfo;Ljava/lang/String;)V
    ...
    iget-object v5, v5, Lcom/android/server/am/ActivityStackSupervisor;->mService:Lcom/android/server/am/ActivityManagerService;
    ...
    invoke-virtual {v5, v6}, Lcom/android/server/am/FreeformController;->removeToggleFreeformList(Lcom/android/server/am/TaskRecord;)V
...
.method setRequestedOrientation(I)V
    ...
    invoke-virtual {p0}, Lcom/android/server/am/ActivityRecord;->inFreeformWindowingMode()Z
    ...
    invoke-virtual {v5, v6, p0}, Lcom/android/server/am/DexCompatController;->isOrientationChangedLocked(Lcom/android/server/am/TaskRecord;Lcom/android/server/am/ActivityRecord;)Z

    move-result v6

    if-eqz v6, :cond_1

    invoke-virtual {v5, p0}, Lcom/android/server/am/DexCompatController;->rotateCompatTaskLocked(Lcom/android/server/am/ActivityRecord;)V
