...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/am/LaunchParamsController$SafeLaunchParams;
    }
.end annotation
...
.method calculate(Lcom/android/server/am/TaskRecord;Landroid/content/pm/ActivityInfo$WindowLayout;Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;Landroid/app/ActivityOptions;Lcom/android/server/am/LaunchParamsController$LaunchParams;)V
    ...
    iget-object v2, v0, Lcom/android/server/am/LaunchParamsController;->mTmpResult:Lcom/android/server/am/LaunchParamsController$LaunchParams;

    invoke-virtual {v2}, Lcom/android/server/am/LaunchParamsController$LaunchParams;->reset()V
...
.method layoutTask(Lcom/android/server/am/TaskRecord;Landroid/content/pm/ActivityInfo$WindowLayout;Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;Landroid/app/ActivityOptions;)Z
    ...
    iget-boolean v0, v0, Lcom/android/server/am/LaunchParamsController$LaunchParams;->mIsFullscreenBounds:Z
    :try_end_0
...
.method registerDefaultModifiers(Lcom/android/server/am/ActivityStackSupervisor;)V
    ...
    invoke-direct {v0, v1}, Lcom/android/server/am/TaskLaunchParamsModifier;-><init>(Lcom/android/server/am/ActivityManagerService;)V
    ...
    new-instance v1, Lcom/android/server/am/TaskLaunchParamsModifier$DexCompatLaunchParamsModifier;

    invoke-static {v0}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;)Ljava/lang/Object;

    invoke-direct {v1, v0}, Lcom/android/server/am/TaskLaunchParamsModifier$DexCompatLaunchParamsModifier;-><init>(Lcom/android/server/am/TaskLaunchParamsModifier;)V

    invoke-virtual {p0, v1}, Lcom/android/server/am/LaunchParamsController;->registerModifier(Lcom/android/server/am/LaunchParamsController$LaunchParamsModifier;)V

    new-instance v1, Lcom/android/server/am/DisplayPolicyLaunchParamsModifier;

    iget-object v2, p0, Lcom/android/server/am/LaunchParamsController;->mService:Lcom/android/server/am/ActivityManagerService;

    invoke-direct {v1, v2}, Lcom/android/server/am/DisplayPolicyLaunchParamsModifier;-><init>(Lcom/android/server/am/ActivityManagerService;)V

    invoke-virtual {p0, v1}, Lcom/android/server/am/LaunchParamsController;->registerModifier(Lcom/android/server/am/LaunchParamsController$LaunchParamsModifier;)V

    new-instance v1, Lcom/android/server/am/ActivityLaunchParamsModifier;

    invoke-direct {v1, p1}, Lcom/android/server/am/ActivityLaunchParamsModifier;-><init>(Lcom/android/server/am/ActivityStackSupervisor;)V

    invoke-virtual {p0, v1}, Lcom/android/server/am/LaunchParamsController;->registerModifier(Lcom/android/server/am/LaunchParamsController$LaunchParamsModifier;)V

    new-instance v1, Lcom/android/server/am/InitialLaunchParamsModifier;

    iget-object v2, p0, Lcom/android/server/am/LaunchParamsController;->mService:Lcom/android/server/am/ActivityManagerService;

    invoke-direct {v1, v2}, Lcom/android/server/am/InitialLaunchParamsModifier;-><init>(Lcom/android/server/am/ActivityManagerService;)V
