...
.method public bringStackToForeground(III)V
    ...
    invoke-virtual {v0, p1, p2, p3}, Lcom/android/server/am/SamsungActivityManagerService;->bringStackToForeground(III)V
...
.method public clearHomeStack(I)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/am/SamsungActivityManagerService;->clearHomeStack(I)V
...
.method public clearHomeStackForKnoxKiosk(I)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/am/SamsungActivityManagerService;->clearHomeStackForKnoxKiosk(I)V
...
.method public getForegroundStackId(I)I
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/am/SamsungActivityManagerService;->getForegroundStackId(I)I
...
.method public killForegroundAppsForUser(I)V
    ...
    iget-object v0, v0, Lcom/android/server/am/ActivityManagerService;->mPersonaActivityHelper:Lcom/android/server/am/PersonaActivityHelper;

    invoke-virtual {v0, p1}, Lcom/android/server/am/PersonaActivityHelper;->notifyKillForegroundAppsForUser(I)Z
...
.method public killPackageProcess(Ljava/lang/String;IILjava/lang/String;Z)I
    .locals 17
    ...
    :cond_2
    const-string/jumbo v0, "kill PackageProcess"
    ...
    invoke-static/range {v2 .. v12}, Lcom/android/server/am/ActivityManagerService;->access$2400(Lcom/android/server/am/ActivityManagerService;Ljava/lang/String;IIIZZZZLjava/lang/String;Z)Z
...
.method public notifyKeyguardTrustedChanged()V
    ...
    invoke-static {v1}, Lcom/android/server/am/ActivityManagerService;->access$2300(Lcom/android/server/am/ActivityManagerService;)Lcom/android/server/am/KeyguardController;
...
.method public removeTaskByCmpName(Ljava/lang/String;II)V
    ...
    invoke-virtual {v1, p1, p2, p3}, Lcom/android/server/am/ActivityStackSupervisor;->removeTaskByCmpName(Ljava/lang/String;II)V
...
.method public saveANRState(Ljava/lang/String;)V
    ...
    invoke-static {v3}, Lcom/android/server/am/ActivityManagerService;->access$2200(Lcom/android/server/am/ActivityManagerService;)Lcom/android/server/am/ActivityStartController;
...
.method public scheduleApplicationInfoChanged(Ljava/util/List;ZI)V
    ...
    invoke-virtual {v0, p1, v1, p3}, Lcom/android/server/am/ActivityManagerService;->scheduleApplicationInfoChanged(Ljava/util/List;ZI)V
...
.method public startActivitiesAsPackage(Ljava/lang/String;I[Landroid/content/Intent;Landroid/os/Bundle;)I
    ...
    invoke-static {v0}, Lcom/android/server/am/ActivityManagerService;->access$2200(Lcom/android/server/am/ActivityManagerService;)Lcom/android/server/am/ActivityStartController;
...
.method public updatePersistentConfigurationForUser(Landroid/content/res/Configuration;I)V
    ...
    invoke-static/range {v1 .. v7}, Lcom/android/server/am/ActivityManagerService;->access$2100(Lcom/android/server/am/ActivityManagerService;Landroid/content/res/Configuration;Lcom/android/server/am/ActivityRecord;ZZIZ)Z
