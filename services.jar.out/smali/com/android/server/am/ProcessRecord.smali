...
.field primaryDisplayName:Ljava/lang/String;
...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;Lcom/android/internal/os/BatteryStatsImpl;Landroid/content/pm/ApplicationInfo;Ljava/lang/String;I)V
    ...
    iput v0, p0, Lcom/android/server/am/ProcessRecord;->hotnessAdj:I

    iput v0, p0, Lcom/android/server/am/ProcessRecord;->callerHotnessAdj:I

    iput-boolean v0, p0, Lcom/android/server/am/ProcessRecord;->isPreload:Z

    iput v0, p0, Lcom/android/server/am/ProcessRecord;->dhaKeepEmptyFlag:I

    iput-boolean v0, p0, Lcom/android/server/am/ProcessRecord;->isAMSException:Z

    const/4 v1, -0x1

    iput v1, p0, Lcom/android/server/am/ProcessRecord;->AMSExceptionFlag:I
    ...
    iput-boolean v0, p0, Lcom/android/server/am/ProcessRecord;->keepProcessAlive:Z

    const/4 v1, 0x0

    iput-object v1, p0, Lcom/android/server/am/ProcessRecord;->primaryDisplayName:Ljava/lang/String;

    iput v0, p0, Lcom/android/server/am/ProcessRecord;->displayId:I

    iput-boolean v0, p0, Lcom/android/server/am/ProcessRecord;->isDexCompatConfigApplied:Z
...
.method dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    const-string/jumbo v2, "foregroundServices="
    ...
    const-string v2, "MultiDisplayInfo {"
    ...
    iget v2, p0, Lcom/android/server/am/ProcessRecord;->displayId:I

    invoke-virtual {p1, v2}, Ljava/io/PrintWriter;->print(I)V

    iget-object v2, p0, Lcom/android/server/am/ProcessRecord;->primaryDisplayName:Ljava/lang/String;

    if-eqz v2, :cond_29

    const-string v2, " primaryDisplay="
    ...
    :cond_29
    iget-boolean v2, p0, Lcom/android/server/am/ProcessRecord;->keepProcessAlive:Z

    if-eqz v2, :cond_2a

    const-string v2, " keepProcessAlive=true"
    ...
    const-string v4, "com.samsung.android.multidisplay.do_not_show_displaychooser"
    ...
    const-string v2, " skipToShowDisplayChooser=true"
...
.method getDisplayId()I
    ...
    iget v0, p0, Lcom/android/server/am/ProcessRecord;->displayId:I
...
.method kill(Ljava/lang/String;Z)V
    ...
    invoke-static {v0, v1}, Lcom/android/server/am/AppStateBroadcasterA;->sendApplicationStop(Ljava/lang/String;I)V
    ...
    invoke-static {v0, v3}, Lcom/android/server/am/ActivityManagerService;->killProcessGroup(II)V
...
.method setDisplayId(I)V
    ...
    iput p1, p0, Lcom/android/server/am/ProcessRecord;->displayId:I
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcom/android/server/am/ProcessRecord;->getDisplayId()I
