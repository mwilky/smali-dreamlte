...
.method private dismissPip()V
    ...
    new-instance v0, Lcom/android/systemui/pip/phone/-$$Lambda$PipMenuActivity$8WMcq8hhQ1gKayuuzAyw250UmEY;

    invoke-direct {v0, p0}, Lcom/android/systemui/pip/phone/-$$Lambda$PipMenuActivity$8WMcq8hhQ1gKayuuzAyw250UmEY;-><init>(Lcom/android/systemui/pip/phone/PipMenuActivity;)V
...
.method private expandPip()V
    ...
    new-instance v0, Lcom/android/systemui/pip/phone/-$$Lambda$PipMenuActivity$Ohs5UuD7jnBdTE2kvH817uQYLns;

    invoke-direct {v0, p0}, Lcom/android/systemui/pip/phone/-$$Lambda$PipMenuActivity$Ohs5UuD7jnBdTE2kvH817uQYLns;-><init>(Lcom/android/systemui/pip/phone/PipMenuActivity;)V
...
.method private hideMenu(Ljava/lang/Runnable;ZZ)V
    ...
    iget-object v10, p0, Lcom/android/systemui/pip/phone/PipMenuActivity;->mExpandButton:Landroid/widget/ImageView;
    ...
    iget-object v7, p0, Lcom/android/systemui/pip/phone/PipMenuActivity;->mMenuContainerAnimator:Landroid/animation/AnimatorSet;
...
.method public static synthetic lambda$dismissPip$11(Lcom/android/systemui/pip/phone/PipMenuActivity;)V
    .locals 2
...
.method public static synthetic lambda$expandPip$10(Lcom/android/systemui/pip/phone/PipMenuActivity;)V
    .locals 2
...
.method static synthetic lambda$onBusEvent$5(Lcom/android/systemui/recents/events/component/HidePipMenuEvent;)V
    .locals 1
...
.method public static synthetic lambda$onBusEvent$6(Lcom/android/systemui/pip/phone/PipMenuActivity;Lcom/android/systemui/recents/events/component/HidePipMenuEvent;)V
    .locals 2

    iget-object v0, p0, Lcom/android/systemui/pip/phone/PipMenuActivity;->mHandler:Landroid/os/Handler;

    new-instance v1, Lcom/android/systemui/pip/phone/-$$Lambda$PipMenuActivity$BF4QuuCjm4Xe-TCCtIY8l9oUf2A;

    invoke-direct {v1, p1}, Lcom/android/systemui/pip/phone/-$$Lambda$PipMenuActivity$BF4QuuCjm4Xe-TCCtIY8l9oUf2A;-><init>(Lcom/android/systemui/recents/events/component/HidePipMenuEvent;)V
...
.method public static synthetic lambda$onCreate$4(Lcom/android/systemui/pip/phone/PipMenuActivity;Landroid/view/View;)V
    .locals 0
...
.method static synthetic lambda$updateActionViews$7(Landroid/view/View;Landroid/view/MotionEvent;)Z
    .locals 1
...
.method static synthetic lambda$updateActionViews$8(Landroid/widget/ImageView;Landroid/graphics/drawable/Drawable;)V
    .locals 1
...
.method static synthetic lambda$updateActionViews$9(Landroid/app/RemoteAction;Landroid/view/View;)V
    .locals 3
...
.method private showMenu(ILandroid/graphics/Rect;Landroid/graphics/Rect;ZZ)V
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/systemui/pip/phone/PipMenuActivity;->cancelDelayedFinish()V
    ...
    iget-object v12, v0, Lcom/android/systemui/pip/phone/PipMenuActivity;->mExpandButton:Landroid/widget/ImageView;

    sget-object v13, Landroid/view/View;->ALPHA:Landroid/util/Property;

    new-array v14, v5, [F

    iget-object v5, v0, Lcom/android/systemui/pip/phone/PipMenuActivity;->mExpandButton:Landroid/widget/ImageView;
    ...
    :cond_7
    invoke-direct/range {p0 .. p0}, Lcom/android/systemui/pip/phone/PipMenuActivity;->notifyUnregisterInputConsumer()V
...
.method private updateActionViews(Landroid/graphics/Rect;)V
    ...
    sget-object v1, Lcom/android/systemui/pip/phone/-$$Lambda$PipMenuActivity$5KxcEBLthzRh1RBn1JPEuSvBnIg;->INSTANCE:Lcom/android/systemui/pip/phone/-$$Lambda$PipMenuActivity$5KxcEBLthzRh1RBn1JPEuSvBnIg;
    ...
    new-instance v8, Lcom/android/systemui/pip/phone/-$$Lambda$PipMenuActivity$kVQYq5wYvCRMgtDCy7rvYXE4e3g;

    invoke-direct {v8, v6}, Lcom/android/systemui/pip/phone/-$$Lambda$PipMenuActivity$kVQYq5wYvCRMgtDCy7rvYXE4e3g;-><init>(Landroid/widget/ImageView;)V

    iget-object v9, p0, Lcom/android/systemui/pip/phone/PipMenuActivity;->mHandler:Landroid/os/Handler;

    invoke-virtual {v7, p0, v8, v9}, Landroid/graphics/drawable/Icon;->loadDrawableAsync(Landroid/content/Context;Landroid/graphics/drawable/Icon$OnDrawableLoadedListener;Landroid/os/Handler;)V
    ...
    invoke-virtual {v5}, Landroid/app/RemoteAction;->isEnabled()Z

    move-result v7

    if-eqz v7, :cond_5

    new-instance v7, Lcom/android/systemui/pip/phone/-$$Lambda$PipMenuActivity$3IAn5E3aMQxFEhESGWwNBh-WeIU;

    invoke-direct {v7, v5}, Lcom/android/systemui/pip/phone/-$$Lambda$PipMenuActivity$3IAn5E3aMQxFEhESGWwNBh-WeIU;-><init>(Landroid/app/RemoteAction;)V
    ...
    iget v8, p0, Lcom/android/systemui/pip/phone/PipMenuActivity;->mBetweenActionPaddingLand:I
...
.method public final onBusEvent(Lcom/android/systemui/recents/events/component/HidePipMenuEvent;)V
    ...
    new-instance v0, Lcom/android/systemui/pip/phone/-$$Lambda$PipMenuActivity$4qYDz10Rw1gUuPPoPy77k6EyUBs;

    invoke-direct {v0, p0, p1}, Lcom/android/systemui/pip/phone/-$$Lambda$PipMenuActivity$4qYDz10Rw1gUuPPoPy77k6EyUBs;-><init>(Lcom/android/systemui/pip/phone/PipMenuActivity;Lcom/android/systemui/recents/events/component/HidePipMenuEvent;)V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    new-instance v3, Lcom/android/systemui/pip/phone/-$$Lambda$PipMenuActivity$WvtwNwFY4S4VeIJ5ZxsSTL51DAs;

    invoke-direct {v3, p0}, Lcom/android/systemui/pip/phone/-$$Lambda$PipMenuActivity$WvtwNwFY4S4VeIJ5ZxsSTL51DAs;-><init>(Lcom/android/systemui/pip/phone/PipMenuActivity;)V
    ...
    new-instance v3, Lcom/android/systemui/pip/phone/-$$Lambda$PipMenuActivity$70yHDyzrwE1GNEVEQrmSEL7H6fY;

    invoke-direct {v3, p0}, Lcom/android/systemui/pip/phone/-$$Lambda$PipMenuActivity$70yHDyzrwE1GNEVEQrmSEL7H6fY;-><init>(Lcom/android/systemui/pip/phone/PipMenuActivity;)V
    ...
    new-instance v2, Lcom/android/systemui/pip/phone/-$$Lambda$PipMenuActivity$XrbqAt128TykA2bnzcA2djOz8lo;

    invoke-direct {v2, p0}, Lcom/android/systemui/pip/phone/-$$Lambda$PipMenuActivity$XrbqAt128TykA2bnzcA2djOz8lo;-><init>(Lcom/android/systemui/pip/phone/PipMenuActivity;)V
    ...
    new-instance v1, Lcom/android/systemui/pip/phone/-$$Lambda$PipMenuActivity$YOeS_llXN6jKZLtC4kPfnX-YD-8;

    invoke-direct {v1, p0}, Lcom/android/systemui/pip/phone/-$$Lambda$PipMenuActivity$YOeS_llXN6jKZLtC4kPfnX-YD-8;-><init>(Lcom/android/systemui/pip/phone/PipMenuActivity;)V
