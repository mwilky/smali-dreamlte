...
.method private initCapturedView(II)V
    ...
    invoke-static {v0}, Lcom/android/systemui/wallpaper/WallpaperUtils;->getAodCapturedBitmap(Landroid/content/Context;)Landroid/graphics/Bitmap;
    ...
    const-string v3, "initCapturedView(): aodCaptureBitmap isn\'t exist"
    ...
    const-string v5, "/Android/data/com.sec.android.app.launcher/cache/homescreenPreview.png"
    ...
    :cond_2
    const-string v5, "KeyguardInfinityPreview"

    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string v7, "initCapturedView(): "
    ...
    :try_start_0
    const-string v5, "android.resource://com.sec.android.app.wallpaperchooser/drawable/default_home_dummy"

    invoke-static {v5}, Landroid/net/Uri;->parse(Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v5

    iget-object v6, p0, Lcom/android/systemui/infinity/preview/KeyguardInfinityPreview;->mContext:Landroid/content/Context;
