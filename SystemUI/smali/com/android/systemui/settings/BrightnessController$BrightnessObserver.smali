...
# instance fields
.field private final BRIGHTNESS_EYE_STRAIN_DIALOG_URI:Landroid/net/Uri;
...
.method public constructor <init>(Lcom/android/systemui/settings/BrightnessController;Landroid/os/Handler;)V
    ...
    iput-object p1, p0, Lcom/android/systemui/settings/BrightnessController$BrightnessObserver;->BRIGHTNESS_EYE_STRAIN_DIALOG_URI:Landroid/net/Uri;
    ...
    const-string/jumbo p1, "pms_notification_panel_brightness_adjustment"
...
.method public onChange(ZLandroid/net/Uri;)V
    ...
    const-string v1, "BrightnessObserver.onChanged() : BRIGHTNESS_MODE_URI"
    ...
    const-string v1, "BrightnessObserver.onChanged() : BRIGHTNESS_URI"
    ...
    :cond_3
    iget-object v0, p0, Lcom/android/systemui/settings/BrightnessController$BrightnessObserver;->BRIGHTNESS_PMS_MARKER_SCREEN_URI:Landroid/net/Uri;
    ...
    const-string v1, "BrightnessObserver.onChanged() : BRIGHTNESS_PMS_MARKER_SCREEN_URI"
    ...
    :cond_4
    iget-object v0, p0, Lcom/android/systemui/settings/BrightnessController$BrightnessObserver;->HIGH_BRIGHTNESS_MODE_URI:Landroid/net/Uri;
    ...
    const-string v1, "BrightnessObserver.onChanged() : HIGH_BRIGHTNESS_MODE_URI"
    ...
    invoke-static {v1}, Lcom/android/systemui/settings/BrightnessController;->access$400(Lcom/android/systemui/settings/BrightnessController;)Ljava/lang/Runnable;
    ...
    :cond_5
    iget-object v0, p0, Lcom/android/systemui/settings/BrightnessController$BrightnessObserver;->BRIGHTNESS_EYE_STRAIN_DIALOG_URI:Landroid/net/Uri;
    ...
    const-string v1, "BrightnessObserver.onChanged() : BRIGHTNESS_EYE_STRAIN_DIALOG_URI"
    ...
    invoke-static {v1}, Lcom/android/systemui/settings/BrightnessController;->access$500(Lcom/android/systemui/settings/BrightnessController;)Ljava/lang/Runnable;
    ...
    :cond_6
    iget-object v0, p0, Lcom/android/systemui/settings/BrightnessController$BrightnessObserver;->BRIGHTNESS_OUTDOOR_MODE_URI:Landroid/net/Uri;
    ...
    const-string v1, "BrightnessObserver.onChanged() : BRIGHTNESS_OUTDOOR_MODE_URI"
    ...
    invoke-static {v1}, Lcom/android/systemui/settings/BrightnessController;->access$600(Lcom/android/systemui/settings/BrightnessController;)Ljava/lang/Runnable;
    ...
    :cond_7
    iget-object v0, p0, Lcom/android/systemui/settings/BrightnessController$BrightnessObserver;->SYSTEM_BRIGHTNESS_ADJUSTMENT_URI:Landroid/net/Uri;
    ...
    invoke-static {v2}, Lcom/android/systemui/settings/BrightnessController;->access$000(Lcom/android/systemui/settings/BrightnessController;)Ljava/lang/String;
    ...
    const-string v3, "BrightnessObserver.onChanged() : SYSTEM_BRIGHTNESS_ADJUSTMENT_URI = "
    ...
    invoke-interface {v1, v2}, Lcom/android/systemui/settings/ToggleSlider;->setSliderEnabled(Z)V
    ...
    const-string v2, "BrightnessObserver.onChanged() : URI = "
    ...
    invoke-static {v0}, Lcom/android/systemui/settings/BrightnessController;->access$900(Lcom/android/systemui/settings/BrightnessController;)Ljava/util/ArrayList;
...
.method public startObserving()V
    ...
    iget-object v1, p0, Lcom/android/systemui/settings/BrightnessController$BrightnessObserver;->BRIGHTNESS_EYE_STRAIN_DIALOG_URI:Landroid/net/Uri;
