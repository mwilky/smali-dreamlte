...
# virtual methods
.method public addLockedTask(Ljava/lang/String;Lcom/android/systemui/shared/recents/model/TaskLockInfo;)V
    .locals 5
    ...
    invoke-static {v2}, Lcom/android/systemui/OverviewProxyService;->access$300(Lcom/android/systemui/OverviewProxyService;)Lcom/android/systemui/util/TaskLockDbHelper;

    move-result-object v2

    iget-object v3, p2, Lcom/android/systemui/shared/recents/model/TaskLockInfo;->componentName:Ljava/lang/String;

    iget-object v4, p2, Lcom/android/systemui/shared/recents/model/TaskLockInfo;->affinityName:Ljava/lang/String;

    invoke-virtual {v2, p1, v3, v4}, Lcom/android/systemui/util/TaskLockDbHelper;->createOrUpdateTaskLock(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)J
    :try_end_0
...
.method public loadLockedTasks()Ljava/util/Map;
    ...
    invoke-virtual {v2}, Lcom/android/systemui/util/TaskLockDbHelper;->getTaskLockAllAsTaskLockInfo()Ljava/util/HashMap;
...
.method public removeLockedTask(Ljava/lang/String;)V
    .locals 3
    ...
    invoke-virtual {v2, p1}, Lcom/android/systemui/util/TaskLockDbHelper;->deleteTaskLock(Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
