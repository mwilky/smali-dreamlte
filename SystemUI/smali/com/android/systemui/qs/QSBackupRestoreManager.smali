...
.method private createBackupFile(Ljava/lang/String;I)I
    ...
    invoke-direct {p0, v1}, Lcom/android/systemui/qs/QSBackupRestoreManager;->deleteFile(Ljava/lang/String;)V
...
.method public static decrypt(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)Ljava/io/File;
    ...
    invoke-static {v2, p3}, Lcom/android/systemui/qs/QSBackupRestoreManager;->decryptStream(Ljava/io/InputStream;I)Ljava/io/InputStream;
...
.method public static decryptStream(Ljava/io/InputStream;I)Ljava/io/InputStream;
    ...
    sget-object v2, Lcom/android/systemui/qs/QSBackupRestoreManager;->mSalt:[B
    ...
    sput-object v2, Lcom/android/systemui/qs/QSBackupRestoreManager;->mSecretKey:Ljavax/crypto/spec/SecretKeySpec;
    ...
    :goto_0
    sget-object v2, Lcom/android/systemui/qs/QSBackupRestoreManager;->mCipher:Ljavax/crypto/Cipher;

    const/4 v3, 0x2

    sget-object v4, Lcom/android/systemui/qs/QSBackupRestoreManager;->mSecretKey:Ljavax/crypto/spec/SecretKeySpec;
    ...
    sget-object v3, Lcom/android/systemui/qs/QSBackupRestoreManager;->mCipher:Ljavax/crypto/Cipher;
...
.method public static encrypt(Ljava/io/File;Ljava/lang/String;I)Ljava/io/File;
    ...
    invoke-static {v3, p2}, Lcom/android/systemui/qs/QSBackupRestoreManager;->encryptStream(Ljava/io/OutputStream;I)Ljava/io/OutputStream;
...
.method public static encryptStream(Ljava/io/OutputStream;I)Ljava/io/OutputStream;
    ...
    sput-object v3, Lcom/android/systemui/qs/QSBackupRestoreManager;->mSalt:[B
    ...
    sput-object v3, Lcom/android/systemui/qs/QSBackupRestoreManager;->mSecretKey:Ljavax/crypto/spec/SecretKeySpec;
...
.method public static generatePBKDF2SecretKey()Ljavax/crypto/spec/SecretKeySpec;
    ...
    sget-object v2, Lcom/android/systemui/qs/QSBackupRestoreManager;->mSecurityPassword:Ljava/lang/String;
    ...
    sget-object v5, Lcom/android/systemui/qs/QSBackupRestoreManager;->mSalt:[B
...
.method private generateResultXML(Ljava/io/File;)Ljava/io/File;
    ...
    invoke-interface {v0, v3, v5}, Lorg/xmlpull/v1/XmlSerializer;->startDocument(Ljava/lang/String;Ljava/lang/Boolean;)V
    ...
    check-cast v7, Lcom/android/systemui/qs/QSBackupRestoreManager$Callback;

    invoke-interface {v7}, Lcom/android/systemui/qs/QSBackupRestoreManager$Callback;->isValidDB()Z

    move-result v8

    invoke-interface {v7, v8}, Lcom/android/systemui/qs/QSBackupRestoreManager$Callback;->onBackup(Z)Ljava/lang/String;
    ...
    invoke-interface {v0, v12, v6}, Lorg/xmlpull/v1/XmlSerializer;->startTag(Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;
...
.method private loadRestoreFile(Ljava/io/File;)Z
    ...
    const-string v8, "QSBackupRestoreManager"
    ...
    iget-object v8, p0, Lcom/android/systemui/qs/QSBackupRestoreManager;->mQSBnRMap:Ljava/util/LinkedHashMap;
    ...
    check-cast v8, Lcom/android/systemui/qs/QSBackupRestoreManager$Callback;
    ...
    invoke-interface {v8, v9}, Lcom/android/systemui/qs/QSBackupRestoreManager$Callback;->onRestore(Ljava/lang/String;)V
...
.method private startBackupQS(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;)V
    ...
    sget-object v2, Lcom/android/systemui/qs/QSBackupRestoreManager$ERR_CODE;->SUCCESS:Lcom/android/systemui/qs/QSBackupRestoreManager$ERR_CODE;
    ...
    :try_start_1
    invoke-direct {v14, v15, v13}, Lcom/android/systemui/qs/QSBackupRestoreManager;->createBackupFile(Ljava/lang/String;I)I
    ...
    invoke-direct/range {v4 .. v11}, Lcom/android/systemui/qs/QSBackupRestoreManager;->sendResponse(Landroid/content/Context;Ljava/lang/String;ILcom/android/systemui/qs/QSBackupRestoreManager$ERR_CODE;ILjava/lang/String;Ljava/lang/String;)V
    ...
    :goto_1
    const-string v12, "com.samsung.android.intent.action.RESPONSE_BACKUP_QUICKPANEL2"

    const/4 v4, 0x1

    sget-object v5, Lcom/android/systemui/qs/QSBackupRestoreManager$ERR_CODE;->INVALID_DATA:Lcom/android/systemui/qs/QSBackupRestoreManager$ERR_CODE;
    ...
    invoke-direct/range {v10 .. v17}, Lcom/android/systemui/qs/QSBackupRestoreManager;->sendResponse(Landroid/content/Context;Ljava/lang/String;ILcom/android/systemui/qs/QSBackupRestoreManager$ERR_CODE;ILjava/lang/String;Ljava/lang/String;)V
...
.method private startRestoreQS(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)V
    ...
    :try_start_0
    invoke-static/range {p6 .. p6}, Lcom/android/systemui/qs/QSBackupRestoreManager;->streamCrypt(Ljava/lang/String;)V

    const-string v0, "encrypt_quickpanel.xml"

    const-string v4, "decrypt_quickpanel.xml"
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_1
    ...
    :try_start_1
    invoke-static {v14, v0, v4, v15}, Lcom/android/systemui/qs/QSBackupRestoreManager;->decrypt(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)Ljava/io/File;

    move-result-object v0

    move-object/from16 v11, p0

    invoke-direct {v11, v0}, Lcom/android/systemui/qs/QSBackupRestoreManager;->loadRestoreFile(Ljava/io/File;)Z
    ...
    sget-object v2, Lcom/android/systemui/qs/QSBackupRestoreManager$ERR_CODE;->INVALID_DATA:Lcom/android/systemui/qs/QSBackupRestoreManager$ERR_CODE;
    ...
    :goto_0
    const-string v6, "com.samsung.android.intent.action.RESPONSE_RESTORE_QUICKPANEL2"

    const/4 v7, 0x1

    sget-object v8, Lcom/android/systemui/qs/QSBackupRestoreManager$ERR_CODE;->INVALID_DATA:Lcom/android/systemui/qs/QSBackupRestoreManager$ERR_CODE;
...
.method public static streamCrypt(Ljava/lang/String;)V
    ...
    sput-object v2, Lcom/android/systemui/qs/QSBackupRestoreManager;->mCipher:Ljavax/crypto/Cipher;
...
.method public createResultFile(Ljava/lang/String;I)Z
    ...
    const-string/jumbo v2, "quickpanel.xml"
    ...
    invoke-direct {p0, v3}, Lcom/android/systemui/qs/QSBackupRestoreManager;->generateResultXML(Ljava/io/File;)Ljava/io/File;
    ...
    const-string v6, "Backup file size error"
    ...
    const-string v6, "encrypt_"

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string/jumbo v6, "quickpanel.xml"
    ...
    invoke-static {v4, v5, p2}, Lcom/android/systemui/qs/QSBackupRestoreManager;->encrypt(Ljava/io/File;Ljava/lang/String;I)Ljava/io/File;
    :try_end_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_1
