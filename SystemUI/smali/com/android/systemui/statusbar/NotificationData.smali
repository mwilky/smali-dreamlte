...
.method public dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2, v6, v7}, Lcom/android/systemui/statusbar/NotificationData;->dumpEntry(Ljava/io/PrintWriter;Ljava/lang/String;ILcom/android/systemui/statusbar/NotificationData$Entry;)V
    ...
    iget-object v3, p0, Lcom/android/systemui/statusbar/NotificationData;->mCustomLayoutEntries:Ljava/util/ArrayList;
    ...
    const-string v5, "custom notifications : "
    ...
    iget-object v6, p0, Lcom/android/systemui/statusbar/NotificationData;->mCustomLayoutEntries:Ljava/util/ArrayList;
    ...
    :cond_3
    iget-object v4, p0, Lcom/android/systemui/statusbar/NotificationData;->mCustomBigLayoutEntries:Ljava/util/ArrayList;
    ...
    const-string v5, "custom big notifications : "
    ...
    iget-object v6, p0, Lcom/android/systemui/statusbar/NotificationData;->mCustomBigLayoutEntries:Ljava/util/ArrayList;
    ...
    :cond_4
    iget-object v4, p0, Lcom/android/systemui/statusbar/NotificationData;->mCustomHeadsupLayoutEntries:Ljava/util/ArrayList;
    ...
    const-string v5, "custom headsup notifications : "
    ...
    iget-object v5, p0, Lcom/android/systemui/statusbar/NotificationData;->mCustomHeadsupLayoutEntries:Ljava/util/ArrayList;
...
.method public filterAndSort()V
    ...
    iget-object v1, p0, Lcom/android/systemui/statusbar/NotificationData;->mSortedAndFiltered:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v5}, Lcom/android/systemui/statusbar/NotificationData;->shouldFilterOut(Lcom/android/systemui/statusbar/NotificationData$Entry;)Z
    ...
    const-string v7, "com.samsung.systemui.notilus"
    ...
    iget-object v6, v5, Lcom/android/systemui/statusbar/NotificationData$Entry;->channel:Landroid/app/NotificationChannel;
    ...
    const-string v7, "notilus_service"
    ...
    iget-object v6, v5, Lcom/android/systemui/statusbar/NotificationData$Entry;->key:Ljava/lang/String;

    invoke-direct {p0, v6}, Lcom/android/systemui/statusbar/NotificationData;->canShowBadge(Ljava/lang/String;)Z
    ...
    :cond_3
    iget v4, p0, Lcom/android/systemui/statusbar/NotificationData;->mNotificationNumberSum:I

    if-eq v4, v3, :cond_5

    iget-object v4, p0, Lcom/android/systemui/statusbar/NotificationData;->mNotificationSumCallback:Lcom/android/systemui/statusbar/NotificationData$NotificationSumCallback;

    if-eqz v4, :cond_4

    iget-object v4, p0, Lcom/android/systemui/statusbar/NotificationData;->mNotificationSumCallback:Lcom/android/systemui/statusbar/NotificationData$NotificationSumCallback;

    invoke-interface {v4, v3}, Lcom/android/systemui/statusbar/NotificationData$NotificationSumCallback;->onNotificationSumChanged(I)V

    :cond_4
    iput v3, p0, Lcom/android/systemui/statusbar/NotificationData;->mNotificationNumberSum:I
...
.method public getCmasNotificationKey()Ljava/lang/String;
    ...
    invoke-virtual {p0, v3}, Lcom/android/systemui/statusbar/NotificationData;->isCmasNotification(Lcom/android/systemui/statusbar/NotificationData$Entry;)Z
...
.method public isCmasNotification(Lcom/android/systemui/statusbar/NotificationData$Entry;)Z
    ...
    const-string v1, "com.android.statusbartest"
...
.method protected isExemptFromDndVisualSuppression(Lcom/android/systemui/statusbar/NotificationData$Entry;)Z
    ...
    invoke-virtual {v0, v2}, Lcom/android/systemui/statusbar/NotificationEntryManager;->getSecNotiBlockableByMetaData(Ljava/lang/String;)Z
...
.method public shouldFilterOut(Lcom/android/systemui/statusbar/NotificationData$Entry;)Z
    ...
    invoke-virtual {v1, p1}, Lcom/android/systemui/statusbar/NotificationEntryManager;->filterOutForKnoxContainer(Lcom/android/systemui/statusbar/NotificationData$Entry;)Z
