...
.method private handleRemoteInput(Landroid/view/View;Landroid/app/PendingIntent;)Z
    ...
    invoke-interface {v12}, Lcom/android/systemui/statusbar/NotificationPresenter;->isPresenterLockScreenSecure()Z

    move-result v12

    if-eqz v12, :cond_d

    sget-boolean v12, Lcom/android/systemui/Rune;->NOTI_SUPPORT_DOUBLETAP_ON_LOCKSCREEN:Z
    ...
    invoke-interface {v12}, Lcom/android/systemui/statusbar/NotificationPresenter;->isPresenterShadeLocked()Z
    ...
    :cond_c
    invoke-virtual {v8, v6}, Lcom/android/systemui/statusbar/ExpandableNotificationRow;->setUserExpanded(Z)V

    invoke-virtual {v8, v4}, Lcom/android/systemui/statusbar/ExpandableNotificationRow;->makeInactive(Z)V
    ...
    :cond_10
    sget-boolean v11, Lcom/android/systemui/Rune;->SYSUI_SUPPORT_APPLOCK:Z

    if-eqz v11, :cond_11

    iget-object v11, v0, Lcom/android/systemui/statusbar/NotificationRemoteInputManager$1;->this$0:Lcom/android/systemui/statusbar/NotificationRemoteInputManager;

    iget-object v11, v11, Lcom/android/systemui/statusbar/NotificationRemoteInputManager;->mActivityManager:Landroid/app/ActivityManager;

    invoke-virtual/range {p2 .. p2}, Landroid/app/PendingIntent;->getTargetPackage()Ljava/lang/String;

    move-result-object v12

    invoke-virtual {v11, v12}, Landroid/app/ActivityManager;->isAppLockedPackage(Ljava/lang/String;)Z
    ...
    invoke-static {v11, v2}, Lcom/android/systemui/statusbar/NotificationRemoteInputManager;->access$100(Lcom/android/systemui/statusbar/NotificationRemoteInputManager;Landroid/app/PendingIntent;)V
    ...
    invoke-static {v4, v15, v0}, Lcom/android/systemui/util/SystemUIAnalytics;->sendEventLog(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method private superOnClickHandler(Landroid/view/View;Landroid/app/PendingIntent;Landroid/content/Intent;)Z
    ...
    invoke-super/range {v1 .. v6}, Landroid/widget/RemoteViews$OnClickHandler;->onClickHandler(Landroid/view/View;Landroid/app/PendingIntent;Landroid/content/Intent;II)Z
...
.method public onClickHandler(Landroid/view/View;Landroid/app/PendingIntent;Landroid/content/Intent;)Z
    ...
    const-string v4, "1119"

    invoke-static {v3, v4, v2}, Lcom/android/systemui/util/SystemUIAnalytics;->sendEventLog(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
