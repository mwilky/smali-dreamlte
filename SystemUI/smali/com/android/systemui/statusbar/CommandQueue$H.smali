...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-interface {v2, v3, v4, v5}, Lcom/android/systemui/statusbar/CommandQueue$Callbacks;->onFingerprintEvent(IILjava/lang/String;)V
    ...
    const-string/jumbo v3, "snapCaller"
    ...
    invoke-interface {v4, v5, v3}, Lcom/android/systemui/statusbar/CommandQueue$Callbacks;->showSnapWindowGuideView(ILjava/lang/String;)V
    ...
    invoke-interface {v4, v5, v6, v7}, Lcom/android/systemui/statusbar/CommandQueue$Callbacks;->updateRestartButton(IZZ)V
    ...
    :goto_6
    invoke-interface {v4, v5, v6}, Lcom/android/systemui/statusbar/CommandQueue$Callbacks;->notifyRequestedSystemKey(ZZ)V
    ...
    invoke-interface {v3, v4, v5, v6}, Lcom/android/systemui/statusbar/CommandQueue$Callbacks;->setNavigationBarShortcut(Ljava/lang/String;Landroid/widget/RemoteViews;I)V
    ...
    invoke-interface {v3, v1}, Lcom/android/systemui/statusbar/CommandQueue$Callbacks;->animateExpandLockedShadePanel(Landroid/service/notification/StatusBarNotification;)V
    ...
    invoke-interface {v2, v3}, Lcom/android/systemui/statusbar/CommandQueue$Callbacks;->sendKeyEventToDesktopTaskbar(Landroid/view/KeyEvent;)V
    ...
    :goto_1c
    invoke-interface {v4, v5}, Lcom/android/systemui/statusbar/CommandQueue$Callbacks;->handleShowGlobalActionsMenu(Z)V
