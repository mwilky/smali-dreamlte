...
.method static synthetic access$1000(Lcom/android/systemui/statusbar/NotificationMenuRow;)F
    .locals 1
...
.method static synthetic access$600(Lcom/android/systemui/statusbar/NotificationMenuRow;)V
    .locals 0
...
.method static synthetic access$700(Lcom/android/systemui/statusbar/NotificationMenuRow;)Z
    .locals 1
...
.method static synthetic access$702(Lcom/android/systemui/statusbar/NotificationMenuRow;Z)Z
    .locals 0
...
.method static synthetic access$800(Lcom/android/systemui/statusbar/NotificationMenuRow;F)V
    .locals 0
...
.method static synthetic access$902(Lcom/android/systemui/statusbar/NotificationMenuRow;Z)Z
    .locals 0
...
.method public static createAppOpsItem(Landroid/content/Context;Z)Lcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin$MenuItem;
    .locals 8
    ...
    check-cast v0, Lcom/android/systemui/statusbar/SecAppOpsInfo;

    new-instance v7, Lcom/android/systemui/statusbar/NotificationMenuRow$NotificationMenuItem;
    ...
    invoke-direct/range {v1 .. v6}, Lcom/android/systemui/statusbar/NotificationMenuRow$NotificationMenuItem;-><init>(Landroid/content/Context;Ljava/lang/String;Lcom/android/systemui/statusbar/NotificationGuts$GutsContent;IZ)V

    return-object v1
.end method

.method public static createFreeformItem(Landroid/content/Context;Z)Lcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin$MenuItem;
    .locals 10
    ...
    new-instance v9, Lcom/android/systemui/statusbar/NotificationMenuRow$NotificationFreeformMenuItem;
    ...
    invoke-direct/range {v2 .. v7}, Lcom/android/systemui/statusbar/NotificationMenuRow$NotificationFreeformMenuItem;-><init>(Landroid/content/Context;Ljava/lang/String;Lcom/android/systemui/statusbar/NotificationGuts$GutsContent;IZ)V

    return-object v2
.end method

.method public static createInfoItem(Landroid/content/Context;Z)Lcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin$MenuItem;
    .locals 10
    ...
    new-instance v9, Lcom/android/systemui/statusbar/NotificationMenuRow$NotificationMenuItem;
    ...
    invoke-direct/range {v3 .. v8}, Lcom/android/systemui/statusbar/NotificationMenuRow$NotificationMenuItem;-><init>(Landroid/content/Context;Ljava/lang/String;Lcom/android/systemui/statusbar/NotificationGuts$GutsContent;IZ)V
...
.method private createMenuViews(Z)V
    ...
    invoke-virtual {p0, v2}, Lcom/android/systemui/statusbar/NotificationMenuRow;->supportFreeform(Landroid/service/notification/StatusBarNotification;)Z
    ...
    invoke-static {v5, v1}, Lcom/android/systemui/statusbar/NotificationMenuRow;->createFreeformItem(Landroid/content/Context;Z)Lcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin$MenuItem;
    ...
    invoke-static {v5, v1}, Lcom/android/systemui/statusbar/NotificationMenuRow;->createSnoozeItem(Landroid/content/Context;Z)Lcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin$MenuItem;
    ...
    :cond_3
    iget-object v2, p0, Lcom/android/systemui/statusbar/NotificationMenuRow;->mContext:Landroid/content/Context;

    invoke-static {v2, v1}, Lcom/android/systemui/statusbar/NotificationMenuRow;->createInfoItem(Landroid/content/Context;Z)Lcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin$MenuItem;

    move-result-object v2

    iput-object v2, p0, Lcom/android/systemui/statusbar/NotificationMenuRow;->mInfoItem:Lcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin$MenuItem;
    ...
    invoke-static {v2, v1}, Lcom/android/systemui/statusbar/NotificationMenuRow;->createAppOpsItem(Landroid/content/Context;Z)Lcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin$MenuItem;

    move-result-object v2

    iput-object v2, p0, Lcom/android/systemui/statusbar/NotificationMenuRow;->mAppOpsItem:Lcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin$MenuItem;

    iget-object v2, p0, Lcom/android/systemui/statusbar/NotificationMenuRow;->mMenuItems:Ljava/util/ArrayList;

    iget-object v4, p0, Lcom/android/systemui/statusbar/NotificationMenuRow;->mAppOpsItem:Lcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin$MenuItem;
    ...
    iput-object v2, p0, Lcom/android/systemui/statusbar/NotificationMenuRow;->mMenuContainer:Landroid/widget/FrameLayout;
    ...
    invoke-direct {p0, v3}, Lcom/android/systemui/statusbar/NotificationMenuRow;->resetState(Z)V

    goto :goto_5

    :cond_6
    iput-boolean v3, p0, Lcom/android/systemui/statusbar/NotificationMenuRow;->mIconsPlaced:Z

    invoke-direct {p0}, Lcom/android/systemui/statusbar/NotificationMenuRow;->setMenuLocation()V

    iget-boolean v2, p0, Lcom/android/systemui/statusbar/NotificationMenuRow;->mIsUserTouching:Z
    ...
    invoke-direct {p0, v2, v3, v4}, Lcom/android/systemui/statusbar/NotificationMenuRow;->showMenu(Landroid/view/View;FF)V
...
.method public static createSnoozeItem(Landroid/content/Context;Z)Lcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin$MenuItem;
    .locals 10
    ...
    check-cast v1, Lcom/android/systemui/statusbar/SecNotificationSnooze;
    ...
    invoke-direct/range {v2 .. v7}, Lcom/android/systemui/statusbar/NotificationMenuRow$NotificationMenuItem;-><init>(Landroid/content/Context;Ljava/lang/String;Lcom/android/systemui/statusbar/NotificationGuts$GutsContent;IZ)V
...
.method private resetState(Z)V
    ...
    invoke-virtual {p0}, Lcom/android/systemui/statusbar/NotificationMenuRow;->cancelFadeAnimation()V
...
.method private setMenuLocation()V
    ...
    iget v7, p0, Lcom/android/systemui/statusbar/NotificationMenuRow;->mIconPadding:I
...
.method public setAppName(Ljava/lang/String;)V
    ...
    invoke-interface {v4}, Lcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin$MenuItem;->getGutsView()Landroid/view/View;
...
.method public supportFreeform(Landroid/service/notification/StatusBarNotification;)Z
    ...
    invoke-virtual {v2}, Lcom/android/systemui/util/SettingsHelper;->isNotificationLaunchFreeformEnabled()Z
    ...
    const-string v4, "!isFreemformEnabled"
    ...
    const-string v5, "intent is not Activity"
    ...
    invoke-static {v5, v2, v4, v6}, Lcom/android/systemui/statusbar/policy/PreviewInflater;->getTargetActivityInfo(Landroid/content/Context;Landroid/content/Intent;IZ)Landroid/content/pm/ActivityInfo;

    move-result-object v5

    if-eqz v5, :cond_4

    iget v7, v5, Landroid/content/pm/ActivityInfo;->resizeMode:I

    invoke-static {v7}, Landroid/content/pm/ActivityInfo;->isResizeableMode(I)Z
    ...
    const-string v8, "isResizeableMode : "
    ...
    const-string/jumbo v8, "unresizable : "
...
.method public updateMenuIconTint()V
    .locals 10
    ...
    invoke-virtual {v0}, Lcom/android/systemui/statusbar/NotificationColorPicker;->isNeedToRevertByUserSetting()Z
    ...
    invoke-interface {v6}, Lcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin$MenuItem;->getMenuView()Landroid/view/View;

    move-result-object v6

    instance-of v7, v6, Lcom/android/systemui/statusbar/AlphaOptimizedImageView;

    if-eqz v7, :cond_7

    move-object v7, v6

    check-cast v7, Lcom/android/systemui/statusbar/AlphaOptimizedImageView;
    ...
    :goto_3
    invoke-virtual {v7}, Lcom/android/systemui/statusbar/AlphaOptimizedImageView;->clearColorFilter()V
    ...
    :goto_4
    invoke-virtual {v0, v9}, Lcom/android/systemui/statusbar/NotificationColorPicker;->getColor(I)I

    move-result v9

    invoke-virtual {v7, v9}, Lcom/android/systemui/statusbar/AlphaOptimizedImageView;->setColorFilter(I)V
