...
.implements Lcom/android/systemui/globalactions/presentation/strategies/OnKeyListenerStrategy;


# instance fields
.field mConditionChecker:Lcom/android/systemui/globalactions/util/ConditionChecker;

.field mGlobalActions:Lcom/android/systemui/globalactions/presentation/SecGlobalActions;

.field mKnoxCustomManagerWrapper:Lcom/android/systemui/globalactions/util/KnoxCustomManagerWrapper;

.field mLogWrapper:Lcom/android/systemui/globalactions/util/LogWrapper;
...
.method public constructor <init>(Lcom/android/systemui/globalactions/presentation/viewmodel/ActionViewModelFactory;Lcom/android/systemui/globalactions/util/ConditionChecker;Lcom/android/systemui/globalactions/util/KnoxCustomManagerWrapper;Lcom/android/systemui/globalactions/util/ProKioskManagerWrapper;Lcom/android/systemui/globalactions/util/LogWrapper;Lcom/android/systemui/globalactions/presentation/SecGlobalActions;)V
    ...
    iput-object p6, p0, Lcom/android/systemui/globalactions/features/KnoxSDKStrategy;->mGlobalActions:Lcom/android/systemui/globalactions/presentation/SecGlobalActions;

    iput-object p1, p0, Lcom/android/systemui/globalactions/features/KnoxSDKStrategy;->mViewModelFactory:Lcom/android/systemui/globalactions/presentation/viewmodel/ActionViewModelFactory;

    iput-object p2, p0, Lcom/android/systemui/globalactions/features/KnoxSDKStrategy;->mConditionChecker:Lcom/android/systemui/globalactions/util/ConditionChecker;
    ...
    iput-object p5, p0, Lcom/android/systemui/globalactions/features/KnoxSDKStrategy;->mLogWrapper:Lcom/android/systemui/globalactions/util/LogWrapper;
...
.method public onCreateActions(Lcom/android/systemui/globalactions/presentation/SecGlobalActions;)V
    ...
    iget-object v0, p0, Lcom/android/systemui/globalactions/features/KnoxSDKStrategy;->mConditionChecker:Lcom/android/systemui/globalactions/util/ConditionChecker;
    ...
    invoke-interface {p1, v0}, Lcom/android/systemui/globalactions/presentation/SecGlobalActions;->setOverrideDefaultActions(Z)V
    ...
    iget-object v1, p0, Lcom/android/systemui/globalactions/features/KnoxSDKStrategy;->mViewModelFactory:Lcom/android/systemui/globalactions/presentation/viewmodel/ActionViewModelFactory;

    const-string/jumbo v2, "power"

    invoke-interface {v1, p1, v2}, Lcom/android/systemui/globalactions/presentation/viewmodel/ActionViewModelFactory;->createActionViewModel(Lcom/android/systemui/globalactions/presentation/SecGlobalActions;Ljava/lang/String;)Lcom/android/systemui/globalactions/presentation/viewmodel/ActionViewModel;

    move-result-object v1

    invoke-interface {p1, v1}, Lcom/android/systemui/globalactions/presentation/SecGlobalActions;->addAction(Lcom/android/systemui/globalactions/presentation/viewmodel/ActionViewModel;)V
    ...
    invoke-virtual {v2, v3}, Lcom/android/systemui/globalactions/presentation/viewmodel/ActionInfo;->setViewType(Lcom/android/systemui/globalactions/presentation/viewmodel/ViewType;)V
    ...
    iget-object v0, p0, Lcom/android/systemui/globalactions/features/KnoxSDKStrategy;->mViewModelFactory:Lcom/android/systemui/globalactions/presentation/viewmodel/ActionViewModelFactory;
    ...
    :cond_4
    invoke-interface {p1, v1}, Lcom/android/systemui/globalactions/presentation/SecGlobalActions;->setOverrideDefaultActions(Z)V
    ...
    invoke-interface {p1, v0}, Lcom/android/systemui/globalactions/presentation/SecGlobalActions;->clearActions(Ljava/lang/String;)V
    ...
    iget-object v3, p0, Lcom/android/systemui/globalactions/features/KnoxSDKStrategy;->mViewModelFactory:Lcom/android/systemui/globalactions/presentation/viewmodel/ActionViewModelFactory;

    const-string v4, "knox_custom"

    invoke-interface {v3, p1, v4}, Lcom/android/systemui/globalactions/presentation/viewmodel/ActionViewModelFactory;->createActionViewModel(Lcom/android/systemui/globalactions/presentation/SecGlobalActions;Ljava/lang/String;)Lcom/android/systemui/globalactions/presentation/viewmodel/ActionViewModel;
    ...
    invoke-interface {v3, v4}, Lcom/android/systemui/globalactions/presentation/viewmodel/ActionViewModel;->setIcon(Landroid/graphics/drawable/BitmapDrawable;)V

    invoke-virtual {v2}, Lcom/android/systemui/globalactions/util/PowerItemWrapper;->getText()Ljava/lang/String;

    move-result-object v4

    invoke-interface {v3, v4}, Lcom/android/systemui/globalactions/presentation/viewmodel/ActionViewModel;->setText(Ljava/lang/String;)V

    invoke-virtual {v2}, Lcom/android/systemui/globalactions/util/PowerItemWrapper;->getIntent()Landroid/content/Intent;

    move-result-object v4

    invoke-interface {v3, v4}, Lcom/android/systemui/globalactions/presentation/viewmodel/ActionViewModel;->setIntent(Landroid/content/Intent;)V

    invoke-virtual {v2}, Lcom/android/systemui/globalactions/util/PowerItemWrapper;->getIntentAction()I

    move-result v4

    invoke-interface {v3, v4}, Lcom/android/systemui/globalactions/presentation/viewmodel/ActionViewModel;->setIntentAction(I)V

    invoke-interface {p1, v3}, Lcom/android/systemui/globalactions/presentation/SecGlobalActions;->addAction(Lcom/android/systemui/globalactions/presentation/viewmodel/ActionViewModel;)V
...
.method public onInitialize(Z)V
    ...
    iget-object v0, p0, Lcom/android/systemui/globalactions/features/KnoxSDKStrategy;->mLogWrapper:Lcom/android/systemui/globalactions/util/LogWrapper;
    ...
    iget-object v0, p0, Lcom/android/systemui/globalactions/features/KnoxSDKStrategy;->mGlobalActions:Lcom/android/systemui/globalactions/presentation/SecGlobalActions;
...
.method public onKeyListenerAction(II)Z
    ...
    invoke-interface {v0}, Lcom/android/systemui/globalactions/presentation/SecGlobalActions;->isActionConfirming()Z
    ...
    iget-object v2, p0, Lcom/android/systemui/globalactions/features/KnoxSDKStrategy;->mViewModelFactory:Lcom/android/systemui/globalactions/presentation/viewmodel/ActionViewModelFactory;

    iget-object v3, p0, Lcom/android/systemui/globalactions/features/KnoxSDKStrategy;->mGlobalActions:Lcom/android/systemui/globalactions/presentation/SecGlobalActions;

    const-string/jumbo v4, "pro_kiosk"

    invoke-interface {v2, v3, v4}, Lcom/android/systemui/globalactions/presentation/viewmodel/ActionViewModelFactory;->createActionViewModel(Lcom/android/systemui/globalactions/presentation/SecGlobalActions;Ljava/lang/String;)Lcom/android/systemui/globalactions/presentation/viewmodel/ActionViewModel;

    move-result-object v2

    invoke-interface {v0, v2}, Lcom/android/systemui/globalactions/presentation/SecGlobalActions;->addAction(Lcom/android/systemui/globalactions/presentation/viewmodel/ActionViewModel;)V
    ...
    invoke-interface {v0}, Lcom/android/systemui/globalactions/presentation/view/ExtendableGlobalActionsView;->updateViewList()V
    ...
    invoke-interface {v0}, Lcom/android/systemui/globalactions/presentation/view/ExtendableGlobalActionsView;->forceRequestLayout()V
