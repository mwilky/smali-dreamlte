...
.method public registerInputConsumer()V
    ...
    const-string v2, "[Pip] registerInputConsumer - "
    ...
    invoke-interface {v1, v2, v4, v0}, Landroid/view/IWindowManager;->createInputConsumer(Landroid/os/IBinder;Ljava/lang/String;Landroid/view/InputChannel;)V
    :try_end_0
    ...
    invoke-interface {v1, v3}, Lcom/android/systemui/shared/system/InputConsumerController$RegistrationListener;->onRegistrationChanged(Z)V
...
.method public unregisterInputConsumer()V
    ...
    const-string v1, "[Pip] unregisterInputConsumer"
