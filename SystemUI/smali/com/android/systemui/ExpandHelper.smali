...
.method private finishExpanding(ZFZ)V
    ...
    const-string v8, "1123"

    goto :goto_8

    :cond_10
    const-string v8, "1121"
    ...
    const-string v8, "1124"

    goto :goto_8

    :cond_12
    const-string v8, "1122"

    :goto_8
    iget-boolean v9, p0, Lcom/android/systemui/ExpandHelper;->mIsMultiTouch:Z

    if-eqz v9, :cond_13

    const-string v9, "Two finger swipe"

    goto :goto_9

    :cond_13
    const-string v9, "One finger swipe"

    :goto_9
    invoke-static {v4, v8, v9}, Lcom/android/systemui/util/SystemUIAnalytics;->sendEventLog(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iput v4, p0, Lcom/android/systemui/ExpandHelper;->mInitialTouchY:F

    invoke-virtual {p1}, Landroid/view/MotionEvent;->getRawX()F

    move-result v4

    iput v4, p0, Lcom/android/systemui/ExpandHelper;->mInitialTouchX:F
