...
.method public dump(Ljava/io/PrintWriter;)V
    ...
    iget-object v0, p0, Lcom/android/systemui/recents/RecentsImpl;->mTaskLockDbHelper:Lcom/android/systemui/util/TaskLockDbHelper;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/android/systemui/recents/RecentsImpl;->mTaskLockDbHelper:Lcom/android/systemui/util/TaskLockDbHelper;

    invoke-virtual {v0, p1}, Lcom/android/systemui/util/TaskLockDbHelper;->dump(Ljava/io/PrintWriter;)V
...
.method public onBootCompleted()V
    ...
    new-instance v0, Lcom/android/systemui/util/TaskLockDbHelper;

    iget-object v1, p0, Lcom/android/systemui/recents/RecentsImpl;->mContext:Landroid/content/Context;

    invoke-direct {v0, v1}, Lcom/android/systemui/util/TaskLockDbHelper;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/android/systemui/recents/RecentsImpl;->mTaskLockDbHelper:Lcom/android/systemui/util/TaskLockDbHelper;
    ...
    invoke-static {v0, v1, v2}, Lcom/android/systemui/util/FOTAUtils;->transferTaskLockPrefMtoN(Landroid/content/Context;Ljava/lang/String;Z)V

    iget-object v0, p0, Lcom/android/systemui/recents/RecentsImpl;->mContext:Landroid/content/Context;

    invoke-static {v0}, Lcom/android/systemui/util/FOTAUtils;->transferTaskLockPrefNtoO(Landroid/content/Context;)V
    ...
    invoke-direct {v1, v3}, Lcom/android/systemui/shared/recents/model/RecentsTaskLoadPlan;-><init>(Landroid/content/Context;)V

    const/4 v3, -0x1

    invoke-virtual {v0, v1, v3}, Lcom/android/systemui/shared/recents/model/RecentsTaskLoader;->preloadTasks(Lcom/android/systemui/shared/recents/model/RecentsTaskLoadPlan;I)V
    ...
    iput-boolean v2, v3, Lcom/android/systemui/shared/recents/model/RecentsTaskLoadPlan$Options;->onlyLoadForCache:Z

    invoke-virtual {v0, v1, v3}, Lcom/android/systemui/shared/recents/model/RecentsTaskLoader;->loadTasks(Lcom/android/systemui/shared/recents/model/RecentsTaskLoadPlan;Lcom/android/systemui/shared/recents/model/RecentsTaskLoadPlan$Options;)V
...
.method public showNextTask()V
    ...
    const v13, 0x7f0100b7

    const v14, 0x7f0100b0
    ...
    const v13, 0x7f0100ba

    const v14, 0x7f0100b9
...
.method public toggleRecents(I)V
    ...
    const-string/jumbo v6, "recentapps"
...
.method public final updateDefaultTaskLockIfNeeded()V
    ...
    :cond_1
    iget-object v5, p0, Lcom/android/systemui/recents/RecentsImpl;->mTaskLockDbHelper:Lcom/android/systemui/util/TaskLockDbHelper;

    const/4 v6, 0x1

    invoke-virtual {v5, v4, v6}, Lcom/android/systemui/util/TaskLockDbHelper;->createOrUpdateDefaultPkgLock(Ljava/lang/String;Z)J
