...
.method static generateHtml(Ljava/util/Map;Ljava/util/Map;Ljava/io/PrintWriter;)V
    ...
    const-string v4, "//Written Offer for Source Code"
    ...
    iget-object v9, v8, Lcom/android/settingslib/license/LicenseHtmlGeneratorFromXml$ContentIdAndFileNames;->mFileNameList:Ljava/util/List;
    ...
    invoke-virtual {p2, v9, v10}, Ljava/io/PrintWriter;->format(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/PrintWriter;

    const-string v9, "<div class=\"file-list\">"
    ...
    const-string v9, "<div class=\"label\">Notices for file(s):</div>"
    ...
    invoke-virtual {p2, v11, v12}, Ljava/io/PrintWriter;->format(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/PrintWriter;

    goto :goto_3

    :cond_3
    const-string v9, "</div><!-- file-list -->"
    ...
    iget-object v9, v8, Lcom/android/settingslib/license/LicenseHtmlGeneratorFromXml$ContentIdAndFileNames;->mContentId:Ljava/lang/String;
    ...
    const-string v9, "</pre><!-- license-text -->"

    invoke-virtual {p2, v9}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    const-string v9, "</td></tr><!-- same-license -->"
