...
.method private isBleWearableDevice(Lcom/android/settingslib/bluetooth/CachedBluetoothDevice;)Z
    ...
    const-string v7, "] is LE gear device."
    ...
    const-string v8, "isBleWearableDevice :: ["
    ...
    const-string v8, "] is LE gear device."
    ...
    const-string v6, "isBleWearableDevice :: ["
...
.method private isSpenDevice(Ljava/lang/String;Lcom/android/settingslib/bluetooth/CachedBluetoothDevice;)Z
    ...
    const-string v2, "isSpenDevice :: skip device listing, ["
    ...
    const-string v2, "] is Spen device"
...
.method public addDevice(Lcom/android/settingslib/bluetooth/LocalBluetoothAdapter;Lcom/android/settingslib/bluetooth/LocalBluetoothProfileManager;Landroid/bluetooth/BluetoothDevice;)Lcom/android/settingslib/bluetooth/CachedBluetoothDevice;
    ...
    const-string v3, "addDevice :: newDevice is added already"
    ...
    invoke-virtual {v2, v0}, Lcom/android/settingslib/bluetooth/BluetoothEventManager;->dispatchDeviceAdded(Lcom/android/settingslib/bluetooth/CachedBluetoothDevice;)V
...
.method public declared-synchronized addRestoredDevices(Ljava/util/List;)V
    ...
    const-string v3, "addRestoredDevices :: newDevice is added already"
    ...
    invoke-virtual {v1, v2}, Lcom/android/settingslib/bluetooth/CachedBluetoothDevice;->setSequence(I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized addSyncedDevices(Ljava/util/List;)V
    ...
    const-string v4, "addSyncedDevices :: newDevice is added already - "
...
.method public needListFiltering(Lcom/android/settingslib/bluetooth/CachedBluetoothDevice;Z)Z
    ...
    invoke-virtual {v7}, Lcom/android/settingslib/bluetooth/CachedBluetoothDevice;->getManufacturerData()Lcom/samsung/android/settingslib/bluetooth/ManufacturerData;

    move-result-object v8

    if-eqz v8, :cond_6

    invoke-virtual {v7}, Lcom/android/settingslib/bluetooth/CachedBluetoothDevice;->getType()I
    ...
    invoke-static {v3, v6, v8, v9}, Lcom/android/settingslib/bluetooth/Utils;->compareSameWithGear(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string v2, "compareSameWithGear :: It is not gear name format."
    ...
    const-string v2, "compareSameWithGear :: It is not gear device."
    ...
    invoke-virtual {v5}, Lcom/android/settingslib/bluetooth/CachedBluetoothDevice;->getType()I
    ...
    invoke-static {v0, v6, v7}, Lcom/android/settingslib/bluetooth/Utils;->compareSameWithGear(ILjava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, v5}, Lcom/android/settingslib/bluetooth/BluetoothEventManager;->dispatchDeviceRemoved(Lcom/android/settingslib/bluetooth/CachedBluetoothDevice;)V
...
.method public declared-synchronized onBluetoothStateChanged(I)V
    ...
    invoke-virtual {v3, v1}, Lcom/android/settingslib/bluetooth/CachedBluetoothDevice;->setVisible(Z)V
    ...
    invoke-virtual {v1}, Lcom/android/settingslib/bluetooth/CachedBluetoothDevice;->clearProfileConnectionState()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized onDeviceUnpaired(Lcom/android/settingslib/bluetooth/CachedBluetoothDevice;)V
    ...
    const-string/jumbo v5, "onDeviceUnpaired: Unpair device="
    ...
    const-string/jumbo v4, "onDeviceUnpaired: Unpair mapped device="
...
.method public declared-synchronized onHiSyncIdChanged(J)V
    ...
    const-string/jumbo v6, "onHiSyncIdChanged: removed from UI device="
...
.method public declared-synchronized onScanningStateChanged(Z)V
    ...
    invoke-virtual {v2, v1}, Lcom/android/settingslib/bluetooth/CachedBluetoothDevice;->setVisible(Z)V
...
.method public removeRestoredDevice(Lcom/android/settingslib/bluetooth/CachedBluetoothDevice;)V
    ...
    const-string v3, "com.samsung.android.intent.action.NOTIFY_REMOVED_SYNC_DEVICE_BLUETOOTH"

    invoke-virtual {v2, v3}, Landroid/content/Intent;->setAction(Ljava/lang/String;)Landroid/content/Intent;

    const-string v3, "com.samsung.android.intent.extra.IS_SYNC_DEVICE_BLUETOOTH"
