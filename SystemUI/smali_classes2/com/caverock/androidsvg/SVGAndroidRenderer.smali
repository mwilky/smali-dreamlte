...
.method private static arcTo(FFFFFZZFFLcom/caverock/androidsvg/SVG$PathInterface;)V
    ...
    div-float v23, v21, v17

    div-float v24, v22, v18
    ...
    :goto_1
    mul-float v24, v17, v18

    mul-float v27, v17, v22

    sub-float v24, v24, v27

    mul-float v27, v18, v21

    sub-float v24, v24, v27

    mul-float v27, v17, v22

    mul-float v30, v18, v21

    add-float v27, v27, v30

    div-float v24, v24, v27

    const/16 v26, 0x0

    cmpg-float v27, v24, v26
    ...
    mul-float v27, v28, v13

    sub-float v24, v24, v27

    add-float v0, v14, v24

    mul-float v24, v28, v7

    mul-float v27, v10, v13

    add-float v24, v24, v27

    add-float v1, v25, v24

    sub-float v24, v11, v7

    div-float v24, v24, v32

    sub-float v27, v12, v13
    ...
    mul-float v11, v24, v6

    mul-float v12, v27, v7

    add-float/2addr v11, v12

    mul-float v12, v24, v7

    mul-float v13, v27, v6
    ...
    invoke-static {v10, v11, v6, v7}, Lcom/caverock/androidsvg/SVGAndroidRenderer;->arcToBeziers(DD)[F
    ...
    invoke-interface/range {v52 .. v58}, Lcom/caverock/androidsvg/SVG$PathInterface;->cubicTo(FFFFFF)V
...
.method private calculateMarkerPositions(Lcom/caverock/androidsvg/SVG$PolyLine;)Ljava/util/List;
    ...
    iget v8, v4, Lcom/caverock/androidsvg/SVGAndroidRenderer$MarkerVector;->x:F

    sub-float v17, v5, v8

    iget v8, v4, Lcom/caverock/androidsvg/SVGAndroidRenderer$MarkerVector;->y:F
    ...
    :cond_1
    instance-of v2, v0, Lcom/caverock/androidsvg/SVG$Polygon;

    if-eqz v2, :cond_2

    iget-object v2, v0, Lcom/caverock/androidsvg/SVG$PolyLine;->points:[F
    ...
    invoke-virtual {v4, v2, v5}, Lcom/caverock/androidsvg/SVGAndroidRenderer$MarkerVector;->add(FF)V

    invoke-interface {v3, v4}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    new-instance v6, Lcom/caverock/androidsvg/SVGAndroidRenderer$MarkerVector;

    iget v7, v4, Lcom/caverock/androidsvg/SVGAndroidRenderer$MarkerVector;->x:F

    sub-float v17, v2, v7

    iget v7, v4, Lcom/caverock/androidsvg/SVGAndroidRenderer$MarkerVector;->y:F
    ...
    invoke-interface {v3, v11, v6}, Ljava/util/List;->set(ILjava/lang/Object;)Ljava/lang/Object;
...
.method private enumerateTextSpans(Lcom/caverock/androidsvg/SVG$TextContainer;Lcom/caverock/androidsvg/SVGAndroidRenderer$TextProcessor;)V
    ...
    iget-object v4, v4, Lcom/caverock/androidsvg/SVG$TextSequence;->text:Ljava/lang/String;
    ...
    invoke-direct {p0, v4, v2, v5}, Lcom/caverock/androidsvg/SVGAndroidRenderer;->textXMLSpaceTransform(Ljava/lang/String;ZZ)Ljava/lang/String;

    move-result-object v4

    invoke-virtual {p2, v4}, Lcom/caverock/androidsvg/SVGAndroidRenderer$TextProcessor;->processText(Ljava/lang/String;)V

    goto :goto_1

    :cond_1
    invoke-direct {p0, v3, p2}, Lcom/caverock/androidsvg/SVGAndroidRenderer;->processTextChild(Lcom/caverock/androidsvg/SVG$SvgObject;Lcom/caverock/androidsvg/SVGAndroidRenderer$TextProcessor;)V
...
.method private extractRawText(Lcom/caverock/androidsvg/SVG$TextContainer;Ljava/lang/StringBuilder;)V
    ...
    invoke-direct {p0, v4, p2}, Lcom/caverock/androidsvg/SVGAndroidRenderer;->extractRawText(Lcom/caverock/androidsvg/SVG$TextContainer;Ljava/lang/StringBuilder;)V
...
.method private fillWithPattern(Lcom/caverock/androidsvg/SVG$SvgElement;Landroid/graphics/Path;Lcom/caverock/androidsvg/SVG$Pattern;)V
    ...
    invoke-direct {v5, v6, v12, v15, v4}, Lcom/caverock/androidsvg/SVG$Box;-><init>(FFFF)V
...
.method private makeLinearGradient(ZLcom/caverock/androidsvg/SVG$Box;Lcom/caverock/androidsvg/SVG$SvgLinearGradient;)V
    ...
    iget-object v6, v6, Lcom/caverock/androidsvg/SVG$Style;->stopOpacity:Ljava/lang/Float;

    invoke-virtual {v6}, Ljava/lang/Float;->floatValue()F

    move-result v6

    invoke-direct {v0, v6}, Lcom/caverock/androidsvg/SVGAndroidRenderer;->clamp255(F)I

    move-result v6

    shl-int/lit8 v6, v6, 0x18

    iget v1, v12, Lcom/caverock/androidsvg/SVG$Colour;->colour:I
    ...
    iget-object v6, v3, Lcom/caverock/androidsvg/SVG$SvgLinearGradient;->spreadMethod:Lcom/caverock/androidsvg/SVG$GradientSpread;
    ...
    invoke-virtual {v6, v0}, Landroid/graphics/LinearGradient;->setLocalMatrix(Landroid/graphics/Matrix;)V
...
.method private makeRadialGradient(ZLcom/caverock/androidsvg/SVG$Box;Lcom/caverock/androidsvg/SVG$SvgRadialGradient;)V
    ...
    iget-object v6, v3, Lcom/caverock/androidsvg/SVG$SvgRadialGradient;->spreadMethod:Lcom/caverock/androidsvg/SVG$GradientSpread;
    ...
    invoke-virtual {v6, v2}, Landroid/graphics/RadialGradient;->setLocalMatrix(Landroid/graphics/Matrix;)V
...
.method private renderMarkers(Lcom/caverock/androidsvg/SVG$GraphicsElement;)V
    ...
    invoke-direct {v6, p0, v7}, Lcom/caverock/androidsvg/SVGAndroidRenderer$MarkerPositionCalculator;-><init>(Lcom/caverock/androidsvg/SVGAndroidRenderer;Lcom/caverock/androidsvg/SVG$PathDefinition;)V
    ...
    check-cast v6, Lcom/caverock/androidsvg/SVG$Line;

    invoke-direct {p0, v6}, Lcom/caverock/androidsvg/SVGAndroidRenderer;->calculateMarkerPositions(Lcom/caverock/androidsvg/SVG$Line;)Ljava/util/List;
    ...
    invoke-direct {p0, v6}, Lcom/caverock/androidsvg/SVGAndroidRenderer;->calculateMarkerPositions(Lcom/caverock/androidsvg/SVG$PolyLine;)Ljava/util/List;
...
.method private updateParentBoundingBox(Lcom/caverock/androidsvg/SVG$SvgElement;)V
    ...
    invoke-direct {v2, v7, v8, v3, v4}, Landroid/graphics/RectF;-><init>(FFFF)V
...
.method private updateStyle(Lcom/caverock/androidsvg/SVGAndroidRenderer$RendererState;Lcom/caverock/androidsvg/SVG$Style;)V
    ...
    invoke-virtual {v0, v5, v6, v7}, Lcom/caverock/androidsvg/SVGExternalFileResolver;->resolveFont(Ljava/lang/String;ILjava/lang/String;)Landroid/graphics/Typeface;
    ...
    invoke-direct {p0, v4, v5, v6}, Lcom/caverock/androidsvg/SVGAndroidRenderer;->checkGenericFont(Ljava/lang/String;Ljava/lang/Integer;Lcom/caverock/androidsvg/SVG$Style$FontStyle;)Landroid/graphics/Typeface;
