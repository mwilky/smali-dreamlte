...
.method public constructor <init>(Lcom/android/systemui/statusbar/ScrimView;Lcom/android/systemui/statusbar/ScrimView;Lcom/android/internal/util/function/TriConsumer;Ljava/util/function/Consumer;Lcom/android/systemui/statusbar/phone/DozeParameters;Landroid/app/AlarmManager;)V
    ...
    iput v1, p0, Lcom/android/systemui/statusbar/phone/ScrimController;->mScrimBouncerColor:I
...
.method private applyExpansionToAlpha()V
    ...
    invoke-virtual {v1, v2}, Lcom/android/systemui/statusbar/phone/ScrimState;->getBehindAlpha(F)F
...
.method private dispatchScrimsVisible()V
    ...
    invoke-virtual {v1}, Lcom/android/systemui/statusbar/ScrimView;->getViewRootImpl()Landroid/view/ViewRootImpl;
    ...
    invoke-virtual {v1}, Landroid/view/ViewRootImpl;->setForceDraw()V
...
.method private updateScrimColor(Landroid/view/View;FI)V
    ...
    iget v1, p0, Lcom/android/systemui/statusbar/phone/ScrimController;->mScrimBouncerColor:I

    invoke-virtual {v0, v1}, Lcom/android/systemui/statusbar/ScrimView;->setTint(I)V
...
.method public setPanelExpansion(F)V
    ...
    iput v1, p0, Lcom/android/systemui/statusbar/phone/ScrimController;->mExpansionFraction:F
...
.method public setScrimAlphaForKeyguard(Z)V
    ...
    const-string v2, "setScrimAlphaForKeyguard : mWhiteKeyguardWallpaper = "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean v2, p0, Lcom/android/systemui/statusbar/phone/ScrimController;->mWhiteKeyguardWallpaper:Z
...
.method protected updateScrims()V
    ...
    iget-object v5, p0, Lcom/android/systemui/statusbar/phone/ScrimController;->mSystemColors:Lcom/android/internal/colorextraction/ColorExtractor$GradientColors;
    ...
    invoke-virtual {v4, v5, v3}, Lcom/android/systemui/statusbar/ScrimView;->setColors(Lcom/android/internal/colorextraction/ColorExtractor$GradientColors;Z)V
    ...
    invoke-static {v3, v4, v5}, Lcom/android/internal/graphics/ColorUtils;->calculateMinimumBackgroundAlpha(IIF)I
    ...
    invoke-direct {p0, v6}, Lcom/android/systemui/statusbar/phone/ScrimController;->dispatchScrimState(F)V
    ...
    :cond_9
    iget v3, p0, Lcom/android/systemui/statusbar/phone/ScrimController;->mCurrentBehindAlpha:F
    ...
    iget v3, p0, Lcom/android/systemui/statusbar/phone/ScrimController;->mNotificationDensity:F

    invoke-virtual {v2, v3}, Lcom/android/systemui/statusbar/phone/ScrimState;->getBehindAlpha(F)F
    ...
    :cond_c
    :goto_7
    sget-boolean v2, Lcom/android/systemui/Rune;->KEYWI_SUPPORT_PROPORTIONAL_DIM:Z
    ...
    iget v2, p0, Lcom/android/systemui/statusbar/phone/ScrimController;->mScrimAlphaForKeyguard:F
