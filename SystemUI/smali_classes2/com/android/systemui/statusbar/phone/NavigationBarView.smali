...
# instance fields
.field protected mAccessibilityIcon:Lcom/android/systemui/statusbar/policy/KeyButtonDrawable;
...
.field protected mBackButtonBounds:Landroid/graphics/Rect;
...
.field protected mBarTransitions:Lcom/android/systemui/statusbar/phone/NavigationBarTransitions;
...
.field protected mDownHitTarget:I

.field private mGestureConsumer:Ljava/util/function/Consumer;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/function/Consumer<",
...
.field protected mGestureRestartButton:Lcom/android/systemui/statusbar/phone/ButtonDispatcher;

.field protected mGestureRotateButton:Lcom/android/systemui/statusbar/phone/ButtonDispatcher;

.field private mHandler:Lcom/android/systemui/statusbar/phone/NavigationBarView$H;

.field protected mHomeButtonBounds:Landroid/graphics/Rect;
...
.field protected mRecentsButtonBounds:Landroid/graphics/Rect;
...
.field protected mRestartIcon:Lcom/android/systemui/statusbar/policy/KeyButtonDrawable;

.field private mRotateBtnStyle:I

.field protected mRotateSuggestionIcon:Lcom/android/systemui/statusbar/policy/TintedKeyButtonDrawable;

.field mRotatedViews:[Landroid/view/View;

.field protected mRotationButtonBounds:Landroid/graphics/Rect;

.field mShowAccessibilityButton:Z

.field mShowMenu:Z

.field mShowRestartButton:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    new-instance v2, Lcom/android/systemui/statusbar/phone/interactor/GestureHintSettingImpl;

    invoke-direct {v2, p1}, Lcom/android/systemui/statusbar/phone/interactor/GestureHintSettingImpl;-><init>(Landroid/content/Context;)V

    new-instance v3, Lcom/android/systemui/statusbar/phone/interactor/GestureWhileHiddenSettingImpl;

    invoke-direct {v3, p1}, Lcom/android/systemui/statusbar/phone/interactor/GestureWhileHiddenSettingImpl;-><init>(Landroid/content/Context;)V

    invoke-direct {v0, p1, v1, v2, v3}, Lcom/android/systemui/recents/RecentsOnboarding;-><init>(Landroid/content/Context;Lcom/android/systemui/OverviewProxyService;Lcom/android/systemui/statusbar/phone/interactor/GestureHintSetting;Lcom/android/systemui/statusbar/phone/interactor/GestureWhileHiddenSetting;)V
    ...
    iput-object v0, p0, Lcom/android/systemui/statusbar/phone/NavigationBarView;->mGestureRotateButton:Lcom/android/systemui/statusbar/phone/ButtonDispatcher;

    new-instance v0, Lcom/android/systemui/statusbar/phone/ButtonDispatcher;

    invoke-direct {v0, v2}, Lcom/android/systemui/statusbar/phone/ButtonDispatcher;-><init>(I)V

    iput-object v0, p0, Lcom/android/systemui/statusbar/phone/NavigationBarView;->mGestureRestartButton:Lcom/android/systemui/statusbar/phone/ButtonDispatcher;
...
.method private setUpSwipeUpOnboarding(Z)V
    ...
    invoke-virtual {v0}, Lcom/android/systemui/recents/RecentsOnboarding;->initSwipeUpAndHoldOnboarding()V
...
.method public getGestureRestartButton()Lcom/android/systemui/statusbar/phone/ButtonDispatcher;
    .locals 1

    iget-object v0, p0, Lcom/android/systemui/statusbar/phone/NavigationBarView;->mGestureRestartButton:Lcom/android/systemui/statusbar/phone/ButtonDispatcher;

    return-object v0
.end method

.method public getGestureRotateButton()Lcom/android/systemui/statusbar/phone/ButtonDispatcher;
    .locals 1

    iget-object v0, p0, Lcom/android/systemui/statusbar/phone/NavigationBarView;->mGestureRotateButton:Lcom/android/systemui/statusbar/phone/ButtonDispatcher;
...
.method public getHomeDrawable(Landroid/content/Context;Landroid/content/Context;)Lcom/android/systemui/statusbar/policy/KeyButtonDrawable;
    ...
    :goto_0
    invoke-virtual {p0, v1}, Lcom/android/systemui/statusbar/phone/NavigationBarView;->orientHomeButton(Lcom/android/systemui/statusbar/policy/KeyButtonDrawable;)V
...
.method public getRestartButton()Lcom/android/systemui/statusbar/phone/ButtonDispatcher;
    .locals 2
...
.method protected onDetachedFromWindow()V
    ...
    iput-object v1, p0, Lcom/android/systemui/statusbar/phone/NavigationBarView;->mGestureHelper:Lcom/android/systemui/plugins/statusbar/phone/NavGesture$GestureHelper;
    ...
    iget-object v0, p0, Lcom/android/systemui/statusbar/phone/NavigationBarView;->mGestureConsumer:Ljava/util/function/Consumer;
...
.method protected onLayout(ZIIII)V
    ...
    invoke-virtual {p0}, Lcom/android/systemui/statusbar/phone/NavigationBarView;->getMeasuredWidth()I

    move-result v1

    invoke-virtual {v0, v1}, Lcom/android/systemui/recents/RecentsOnboarding;->setNavBarWidth(I)V
...
.method public onPluginDisconnected(Lcom/android/systemui/plugins/statusbar/phone/NavGesture;)V
    ...
    iget-object v1, p0, Lcom/android/systemui/statusbar/phone/NavigationBarView;->mGestureConsumer:Ljava/util/function/Consumer;
...
.method public resetBarTransitions()V
    .locals 1
    ...
    invoke-virtual {v0}, Lcom/android/systemui/statusbar/phone/NavigationBarTransitions;->onDestroy()V
...
.method protected setGestureConsumer(Ljava/util/function/Consumer;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lcom/android/systemui/statusbar/phone/NavigationBarView;->mGestureConsumer:Ljava/util/function/Consumer;
...
.method public setMenuVisibility(ZZ)V
    ...
    iget-boolean v0, p0, Lcom/android/systemui/statusbar/phone/NavigationBarView;->mShowRestartButton:Z
...
.method protected setSlippery(Z)V
    .locals 5
...
.method public updateNavButtonIcons()V
    ...
    invoke-virtual {p0, v3, v4}, Lcom/android/systemui/statusbar/phone/NavigationBarView;->getBackIconWithAlt(ZZ)Lcom/android/systemui/statusbar/policy/KeyButtonDrawable;
    ...
    :goto_8
    sget-boolean v10, Lcom/android/systemui/Rune;->NAVBAR_ENABLED:Z
    ...
    invoke-virtual {v10}, Landroid/animation/LayoutTransition;->getTransitionListeners()Ljava/util/List;
    ...
    invoke-virtual {v10, v11}, Landroid/animation/LayoutTransition;->addTransitionListener(Landroid/animation/LayoutTransition$TransitionListener;)V
    ...
    :goto_b
    invoke-virtual {v10, v11}, Lcom/android/systemui/statusbar/phone/ButtonDispatcher;->setVisibility(I)V
    ...
    :cond_12
    invoke-virtual {v10, v2}, Lcom/android/systemui/statusbar/phone/ButtonDispatcher;->setVisibility(I)V
...
.method protected updateSlippery()V
    ...
    :goto_1
    invoke-virtual {p0, v0}, Lcom/android/systemui/statusbar/phone/NavigationBarView;->setSlippery(Z)V
