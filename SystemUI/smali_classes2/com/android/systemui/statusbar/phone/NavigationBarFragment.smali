...
.field mNavBarFragmentFeature:Lcom/android/systemui/statusbar/phone/feature/NavBarFragmentFeature;
...
.method private clearButtonListener(Lcom/android/systemui/statusbar/phone/ButtonDispatcher;)V
    .locals 1
    ...
    invoke-virtual {p1, v0}, Lcom/android/systemui/statusbar/phone/ButtonDispatcher;->setOnClickListener(Landroid/view/View$OnClickListener;)V
    ...
    invoke-virtual {p1, v0}, Lcom/android/systemui/statusbar/phone/ButtonDispatcher;->setOnLongClickListener(Landroid/view/View$OnLongClickListener;)V

    invoke-virtual {p1, v0}, Lcom/android/systemui/statusbar/phone/ButtonDispatcher;->setOnHoverListener(Landroid/view/View$OnHoverListener;)V

    :cond_0
    return-void
.end method

.method private clearButtonListeners()V
    .locals 6
    ...
    invoke-direct {p0, v0}, Lcom/android/systemui/statusbar/phone/NavigationBarFragment;->clearButtonListener(Lcom/android/systemui/statusbar/phone/ButtonDispatcher;)V
    ...
    invoke-direct {p0, v1}, Lcom/android/systemui/statusbar/phone/NavigationBarFragment;->clearButtonListener(Lcom/android/systemui/statusbar/phone/ButtonDispatcher;)V
    ...
    invoke-direct {p0, v2}, Lcom/android/systemui/statusbar/phone/NavigationBarFragment;->clearButtonListener(Lcom/android/systemui/statusbar/phone/ButtonDispatcher;)V
    ...
    invoke-direct {p0, v3}, Lcom/android/systemui/statusbar/phone/NavigationBarFragment;->clearButtonListener(Lcom/android/systemui/statusbar/phone/ButtonDispatcher;)V
    ...
    invoke-direct {p0, v4}, Lcom/android/systemui/statusbar/phone/NavigationBarFragment;->clearButtonListener(Lcom/android/systemui/statusbar/phone/ButtonDispatcher;)V
    ...
    invoke-virtual {v5}, Lcom/android/systemui/statusbar/phone/NavigationBarView;->getGestureRotateButton()Lcom/android/systemui/statusbar/phone/ButtonDispatcher;

    move-result-object v5

    invoke-direct {p0, v5}, Lcom/android/systemui/statusbar/phone/NavigationBarFragment;->clearButtonListener(Lcom/android/systemui/statusbar/phone/ButtonDispatcher;)V
...
.method public static create(Landroid/content/Context;Lcom/android/systemui/fragments/FragmentHostManager$FragmentListener;)Landroid/view/View;
    ...
    invoke-static {p0, p1}, Lcom/android/systemui/statusbar/phone/feature/NavBarFragmentFeature;->create(Landroid/content/Context;Lcom/android/systemui/fragments/FragmentHostManager$FragmentListener;)Landroid/view/View;
...
.method private prepareNavigationBarView()V
    ...
    iget-object v0, p0, Lcom/android/systemui/statusbar/phone/NavigationBarFragment;->mNavBarFragmentFeature:Lcom/android/systemui/statusbar/phone/feature/NavBarFragmentFeature;
    ...
    sget-boolean v5, Lcom/android/systemui/Rune;->NAVBAR_SUPPORT_HANDLE_KEY_EVENT_ON_PWM:Z

    if-eqz v5, :cond_1

    iget-object v5, p0, Lcom/android/systemui/statusbar/phone/NavigationBarFragment;->mNavBarFragmentFeature:Lcom/android/systemui/statusbar/phone/feature/NavBarFragmentFeature;

    if-eqz v5, :cond_1

    iget-object v5, p0, Lcom/android/systemui/statusbar/phone/NavigationBarFragment;->mNavBarFragmentFeature:Lcom/android/systemui/statusbar/phone/feature/NavBarFragmentFeature;

    invoke-virtual {v5, v2, v1, v0}, Lcom/android/systemui/statusbar/phone/feature/NavBarFragmentFeature;->blockKeyEventListener(Lcom/android/systemui/statusbar/phone/ButtonDispatcher;Lcom/android/systemui/statusbar/phone/ButtonDispatcher;Lcom/android/systemui/statusbar/phone/ButtonDispatcher;)V
    ...
    new-instance v6, Lcom/android/systemui/statusbar/phone/-$$Lambda$NavigationBarFragment$-5zWkb0xwQ86wYhCk6W_5t9CDxE;

    invoke-direct {v6, p0}, Lcom/android/systemui/statusbar/phone/-$$Lambda$NavigationBarFragment$-5zWkb0xwQ86wYhCk6W_5t9CDxE;-><init>(Lcom/android/systemui/statusbar/phone/NavigationBarFragment;)V

    invoke-virtual {v5, v6}, Lcom/android/systemui/statusbar/phone/ButtonDispatcher;->setOnClickListener(Landroid/view/View$OnClickListener;)V
...
.method public disable(IIZ)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/systemui/statusbar/phone/feature/NavBarFragmentFeature;->adjustDisableFlags(I)I
...
.method public getDisabledFlags1()I
    .locals 1
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    :cond_1
    invoke-virtual {p0}, Lcom/android/systemui/statusbar/phone/NavigationBarFragment;->repositionNavigationBar()V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    new-instance v0, Lcom/android/systemui/statusbar/phone/feature/NavBarFragmentFeature;

    invoke-virtual {p0}, Lcom/android/systemui/statusbar/phone/NavigationBarFragment;->getContext()Landroid/content/Context;

    move-result-object v1

    invoke-direct {v0, v1, p0}, Lcom/android/systemui/statusbar/phone/feature/NavBarFragmentFeature;-><init>(Landroid/content/Context;Lcom/android/systemui/statusbar/phone/NavigationBarFragment;)V

    iput-object v0, p0, Lcom/android/systemui/statusbar/phone/NavigationBarFragment;->mNavBarFragmentFeature:Lcom/android/systemui/statusbar/phone/feature/NavBarFragmentFeature;

    iget-object v0, p0, Lcom/android/systemui/statusbar/phone/NavigationBarFragment;->mNavBarFragmentFeature:Lcom/android/systemui/statusbar/phone/feature/NavBarFragmentFeature;

    iget v1, p0, Lcom/android/systemui/statusbar/phone/NavigationBarFragment;->mNavigationIconHints:I

    invoke-virtual {v0, p1, v1}, Lcom/android/systemui/statusbar/phone/feature/NavBarFragmentFeature;->onCreate(Landroid/os/Bundle;I)I
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    invoke-virtual {v0, p1, p2, p3}, Lcom/android/systemui/statusbar/phone/feature/NavBarFragmentFeature;->onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
...
.method public onDestroyView()V
    ...
    invoke-virtual {v0}, Lcom/android/systemui/statusbar/phone/feature/NavBarFragmentFeature;->onDestroy()V
    ...
    invoke-virtual {v1}, Lcom/android/systemui/statusbar/phone/NavigationBarView;->resetBarTransitions()V

    invoke-direct {p0}, Lcom/android/systemui/statusbar/phone/NavigationBarFragment;->clearButtonListeners()V
    ...
    invoke-virtual {v1, v2}, Lcom/android/systemui/OverviewProxyService;->removeCallback(Lcom/android/systemui/OverviewProxyService$OverviewProxyListener;)V
    ...
    iget-object v2, p0, Lcom/android/systemui/statusbar/phone/NavigationBarFragment;->mCancelPendingRotationProposal:Ljava/lang/Runnable;
    ...
    iget-object v2, p0, Lcom/android/systemui/statusbar/phone/NavigationBarFragment;->mRemoveRotationProposal:Ljava/lang/Runnable;
...
.method public onRotationProposal(IZ)V
    ...
    iget-object v2, p0, Lcom/android/systemui/statusbar/phone/NavigationBarFragment;->mNavBarFragmentFeature:Lcom/android/systemui/statusbar/phone/feature/NavBarFragmentFeature;

    if-eqz v2, :cond_0

    iget-object v2, p0, Lcom/android/systemui/statusbar/phone/NavigationBarFragment;->mNavBarFragmentFeature:Lcom/android/systemui/statusbar/phone/feature/NavBarFragmentFeature;

    invoke-virtual {v2}, Lcom/android/systemui/statusbar/phone/feature/NavBarFragmentFeature;->isRotateButtonDisabledByPolicy()Z
    ...
    iget v6, p0, Lcom/android/systemui/statusbar/phone/NavigationBarFragment;->mNavigationBarWindowState:I
    ...
    invoke-virtual {v6}, Lcom/android/systemui/statusbar/phone/NavigationBarView;->isRotateButtonVisible()Z
    ...
    invoke-virtual {p0, v4}, Lcom/android/systemui/statusbar/phone/NavigationBarFragment;->setRotateSuggestionButtonState(Z)V
    ...
    iget-object v5, p0, Lcom/android/systemui/statusbar/phone/NavigationBarFragment;->mRemoveRotationProposal:Ljava/lang/Runnable;
    ...
    invoke-virtual {v4}, Lcom/android/systemui/statusbar/phone/NavigationBarView;->getGestureRotateButton()Lcom/android/systemui/statusbar/phone/ButtonDispatcher;
    ...
    iget-object v6, p0, Lcom/android/systemui/statusbar/phone/NavigationBarFragment;->mNavBarFragmentFeature:Lcom/android/systemui/statusbar/phone/feature/NavBarFragmentFeature;

    if-eqz v6, :cond_c

    iget-object v6, p0, Lcom/android/systemui/statusbar/phone/NavigationBarFragment;->mNavBarFragmentFeature:Lcom/android/systemui/statusbar/phone/feature/NavBarFragmentFeature;

    invoke-virtual {v6, v0, p1}, Lcom/android/systemui/statusbar/phone/feature/NavBarFragmentFeature;->getRotateButtonStyle(II)I
    ...
    invoke-virtual {v6, v5, v3}, Lcom/android/systemui/statusbar/phone/NavigationBarView;->updateRotateSuggestionButtonStyle(IZ)V
    ...
    const-class v4, Lcom/android/systemui/statusbar/phone/NavBarSettingsHelper;

    invoke-static {v4}, Lcom/android/systemui/Dependency;->get(Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object v4

    check-cast v4, Lcom/android/systemui/statusbar/phone/NavBarSettingsHelper;

    invoke-virtual {v4}, Lcom/android/systemui/statusbar/phone/NavBarSettingsHelper;->getNavigationBarGestureEnabled()Z
    ...
    iget-object v4, p0, Lcom/android/systemui/statusbar/phone/NavigationBarFragment;->mCancelPendingRotationProposal:Ljava/lang/Runnable;
...
.method public onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0, p1, v1}, Lcom/android/systemui/statusbar/phone/feature/NavBarFragmentFeature;->onSaveInstanceState(Landroid/os/Bundle;I)V
...
.method public onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    iget-object v1, p0, Lcom/android/systemui/statusbar/phone/NavigationBarFragment;->mNavBarFragmentFeature:Lcom/android/systemui/statusbar/phone/feature/NavBarFragmentFeature;

    iget-object v2, p0, Lcom/android/systemui/statusbar/phone/NavigationBarFragment;->mNavigationBarView:Lcom/android/systemui/statusbar/phone/NavigationBarView;

    iget v4, p0, Lcom/android/systemui/statusbar/phone/NavigationBarFragment;->mNavigationIconHints:I

    iget v5, p0, Lcom/android/systemui/statusbar/phone/NavigationBarFragment;->mDisabledFlags1:I
    ...
    invoke-virtual/range {v1 .. v6}, Lcom/android/systemui/statusbar/phone/feature/NavBarFragmentFeature;->onViewCreated(Landroid/view/View;Landroid/os/Bundle;IILcom/android/systemui/statusbar/phone/StatusBar;)V
...
.method public repositionNavigationBar()V
    .locals 3
...
.method public setCurrentSysuiVisibility(II)V
    .locals 10
    ...
    iput p2, p0, Lcom/android/systemui/statusbar/phone/NavigationBarFragment;->mFullscreenVisibility:I
    ...
    iget v6, p0, Lcom/android/systemui/statusbar/phone/NavigationBarFragment;->mFullscreenVisibility:I
    ...
    invoke-virtual/range {v2 .. v9}, Lcom/android/systemui/statusbar/phone/feature/NavBarFragmentFeature;->computeBarMode(IIIIIII)I
    ...
    iget v3, p0, Lcom/android/systemui/statusbar/phone/NavigationBarFragment;->mSystemUiVisibility:I
    ...
    invoke-virtual/range {v1 .. v6}, Lcom/android/systemui/statusbar/phone/StatusBar;->computeBarMode(IIIII)I
    ...
    :goto_1
    iput v1, p0, Lcom/android/systemui/statusbar/phone/NavigationBarFragment;->mNavigationBarMode:I
    ...
    invoke-virtual {v1, v3, v2, v4, v5}, Lcom/android/systemui/statusbar/phone/LightBarController;->onNavigationVisibilityChanged(IIZI)V
...
.method public setSystemUiVisibility(IIIILandroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    :cond_0
    iget v3, v0, Lcom/android/systemui/statusbar/phone/NavigationBarFragment;->mSystemUiVisibility:I
    ...
    iget v15, v0, Lcom/android/systemui/statusbar/phone/NavigationBarFragment;->mFullscreenVisibility:I
    ...
    :cond_2
    :goto_0
    iput v12, v0, Lcom/android/systemui/statusbar/phone/NavigationBarFragment;->mSystemUiVisibility:I

    iput v11, v0, Lcom/android/systemui/statusbar/phone/NavigationBarFragment;->mFullscreenVisibility:I
    ...
    iget-object v4, v0, Lcom/android/systemui/statusbar/phone/NavigationBarFragment;->mNavBarFragmentFeature:Lcom/android/systemui/statusbar/phone/feature/NavBarFragmentFeature;

    if-eqz v4, :cond_4

    invoke-virtual/range {p0 .. p0}, Lcom/android/systemui/statusbar/phone/NavigationBarFragment;->getView()Landroid/view/View;
    ...
    invoke-virtual/range {v4 .. v11}, Lcom/android/systemui/statusbar/phone/feature/NavBarFragmentFeature;->computeBarMode(IIIIIII)I
    ...
    iget v5, v0, Lcom/android/systemui/statusbar/phone/NavigationBarFragment;->mNavigationBarMode:I

    if-eq v5, v4, :cond_6

    iput v4, v0, Lcom/android/systemui/statusbar/phone/NavigationBarFragment;->mNavigationBarMode:I
    ...
    invoke-virtual {v5, v1, v6}, Lcom/android/systemui/statusbar/phone/NavigationBarView;->onSystemUiVisibilityChanged(II)V

    :cond_6
    iget-object v5, v0, Lcom/android/systemui/statusbar/phone/NavigationBarFragment;->mStatusBar:Lcom/android/systemui/statusbar/phone/StatusBar;

    invoke-virtual {v5}, Lcom/android/systemui/statusbar/phone/StatusBar;->touchAutoHide()V

    :cond_7
    :goto_4
    iget-object v4, v0, Lcom/android/systemui/statusbar/phone/NavigationBarFragment;->mLightBarController:Lcom/android/systemui/statusbar/phone/LightBarController;

    iget v5, v0, Lcom/android/systemui/statusbar/phone/NavigationBarFragment;->mNavigationBarMode:I

    invoke-virtual {v4, v1, v2, v14, v5}, Lcom/android/systemui/statusbar/phone/LightBarController;->onNavigationVisibilityChanged(IIZI)V
...
.method public setWindowState(II)V
    ...
    invoke-virtual {v0, p2}, Lcom/android/systemui/statusbar/phone/feature/NavBarFragmentFeature;->setWindowState(I)V
