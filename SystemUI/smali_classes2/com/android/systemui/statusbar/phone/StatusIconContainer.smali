...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput v1, p0, Lcom/android/systemui/statusbar/phone/StatusIconContainer;->mMaxWidth:I
...
.method private initDimens()V
    ...
    iput v2, p0, Lcom/android/systemui/statusbar/phone/StatusIconContainer;->mStaticDotDiameter:I

    iget v2, p0, Lcom/android/systemui/statusbar/phone/StatusIconContainer;->mIconDotFrameWidth:I

    iget v3, p0, Lcom/android/systemui/statusbar/phone/StatusIconContainer;->mStaticDotDiameter:I
    ...
    iput v2, p0, Lcom/android/systemui/statusbar/phone/StatusIconContainer;->mUnderflowWidth:I
    ...
    iput v2, p0, Lcom/android/systemui/statusbar/phone/StatusIconContainer;->mNotiMinWidth:I

    const/4 v1, 0x0

    iput v1, p0, Lcom/android/systemui/statusbar/phone/StatusIconContainer;->mIconDotFrameWidth:I
...
.method protected onMeasure(II)V
    ...
    :cond_7
    iget v3, p0, Lcom/android/systemui/statusbar/phone/StatusIconContainer;->mMaxWidth:I
...
.method public setMaxWidth(I)V
    ...
    invoke-virtual {p0, p1, v0}, Lcom/android/systemui/statusbar/phone/StatusIconContainer;->setMaxWidth(IZ)V

    return-void
.end method

.method public setMaxWidth(IZ)V
    .locals 3

    iget v0, p0, Lcom/android/systemui/statusbar/phone/StatusIconContainer;->mNotiMinWidth:I

    sub-int/2addr p1, v0

    iget v0, p0, Lcom/android/systemui/statusbar/phone/StatusIconContainer;->mMaxWidth:I

    if-eq v0, p1, :cond_0

    iput p1, p0, Lcom/android/systemui/statusbar/phone/StatusIconContainer;->mMaxWidth:I

    if-eqz p2, :cond_0

    const-string v0, "StatusIconContainer"

    new-instance v1, Ljava/lang/StringBuilder;

    invoke-direct {v1}, Ljava/lang/StringBuilder;-><init>()V

    const-string v2, "setMaxWidth requestLayout : "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v2, p0, Lcom/android/systemui/statusbar/phone/StatusIconContainer;->mMaxWidth:I
