...
.method public constructor <init>(Landroid/content/Context;Lcom/android/systemui/statusbar/phone/DozeScrimController;Lcom/android/systemui/keyguard/KeyguardViewMediator;Lcom/android/systemui/statusbar/phone/ScrimController;Lcom/android/systemui/statusbar/phone/StatusBar;Lcom/android/systemui/statusbar/phone/UnlockMethodCache;)V
    ...
    iput-object v0, p0, Lcom/android/systemui/statusbar/phone/FingerprintUnlockController;->mVibrator:Landroid/os/Vibrator;
...
.method public onFingerprintAcquired(I)V
    ...
    const-string v1, "onFingerprintAcquired( fp wakelock: show bouncer and waking up... ) "
...
.method public onFingerprintAuthenticated(I)V
    ...
    const-string v1, "the fingerprint is authenticated."
    ...
    invoke-virtual {v0}, Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;->resetBouncer()V
...
.method public onFingerprintHelp(ILjava/lang/String;)V
    ...
    iget-object v0, p0, Lcom/android/systemui/statusbar/phone/FingerprintUnlockController;->mVibrator:Landroid/os/Vibrator;
    ...
    invoke-virtual {v0}, Lcom/android/keyguard/KeyguardUpdateMonitor;->isMaxFailedBiometricUnlockAttemptsShort()Z
    ...
    invoke-static {v2, v3, v1}, Landroid/os/VibrationEffect;->semCreateHaptic(IILandroid/os/VibrationEffect$SemMagnitudeType;)Landroid/os/VibrationEffect;

    move-result-object v2

    iget-object v3, p0, Lcom/android/systemui/statusbar/phone/FingerprintUnlockController;->mVibrator:Landroid/os/Vibrator;
...
.method public startWakeAndUnlock(I)V
    ...
    invoke-virtual {v2, v4}, Landroid/os/PowerManager;->setEarlyWakeUp(Z)V
    ...
    invoke-virtual {v2, v5, v6, v7}, Landroid/os/PowerManager;->semWakeUp(JI)V
    ...
    const-string v7, "android.policy:FINGERPRINT"

    invoke-virtual {v2, v5, v6, v7}, Landroid/os/PowerManager;->wakeUp(JLjava/lang/String;)V

    :cond_2
    :goto_0
    const-string v2, "release wake-and-unlock"
    ...
    :pswitch_1
    const-string v2, "MODE_DISMISS"

    invoke-static {v2}, Landroid/os/Trace;->beginSection(Ljava/lang/String;)V

    iget-object v2, p0, Lcom/android/systemui/statusbar/phone/FingerprintUnlockController;->mStatusBarKeyguardViewManager:Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;

    invoke-virtual {v2, v4}, Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;->setBiometricUnlocked(Z)V
    ...
    invoke-virtual {v1, v4}, Lcom/android/systemui/statusbar/phone/StatusBarKeyguardViewManager;->setBiometricUnlocked(Z)V
    ...
    invoke-virtual {v2, v1, v4}, Lcom/android/systemui/statusbar/phone/StatusBar;->updateMediaMetaData(ZZ)V
    ...
    invoke-virtual {v2}, Lcom/android/keyguard/KeyguardUpdateMonitor;->awakenFromDream()V

    :goto_2
    iget-object v2, p0, Lcom/android/systemui/statusbar/phone/FingerprintUnlockController;->mUpdateMonitor:Lcom/android/keyguard/KeyguardUpdateMonitor;

    invoke-virtual {v2}, Lcom/android/keyguard/KeyguardUpdateMonitor;->showAlwaysOnNotification()V
    ...
    invoke-virtual {v2, v1}, Lcom/android/systemui/statusbar/phone/StatusBarWindowManager;->setStatusBarFocusable(Z)V
