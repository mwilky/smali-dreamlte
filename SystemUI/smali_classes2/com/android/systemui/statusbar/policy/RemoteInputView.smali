...
.method private sendRemoteInput()V
    ...
    iget-object v6, p0, Lcom/android/systemui/statusbar/policy/RemoteInputView;->mEntry:Lcom/android/systemui/statusbar/NotificationData$Entry;
    ...
    :goto_0
    iget-object v3, p0, Lcom/android/systemui/statusbar/policy/RemoteInputView;->mRemoteInputQuickSettingsDisabler:Lcom/android/systemui/statusbar/policy/RemoteInputQuickSettingsDisabler;

    invoke-virtual {v3}, Lcom/android/systemui/statusbar/policy/RemoteInputQuickSettingsDisabler;->getRemoteInputActive()Z
    ...
    iget-boolean v3, v3, Lcom/android/systemui/statusbar/policy/RemoteInputQuickSettingsDisabler;->misLandscape:Z

    if-eqz v3, :cond_0

    iget-object v3, p0, Lcom/android/systemui/statusbar/policy/RemoteInputView;->mRemoteInputQuickSettingsDisabler:Lcom/android/systemui/statusbar/policy/RemoteInputQuickSettingsDisabler;

    invoke-virtual {v3, v2}, Lcom/android/systemui/statusbar/policy/RemoteInputQuickSettingsDisabler;->setRemoteInputActive(Z)V
...
.method public onTextChanged(Ljava/lang/CharSequence;III)V
    ...
    iget-object v1, p0, Lcom/android/systemui/statusbar/policy/RemoteInputView;->mSignature:Ljava/lang/String;
    ...
    iget-boolean v2, p0, Lcom/android/systemui/statusbar/policy/RemoteInputView;->mIsSms:Z
    ...
    iget-object v2, p0, Lcom/android/systemui/statusbar/policy/RemoteInputView;->mPrevString:Ljava/lang/String;
    ...
    invoke-virtual {v2, v4}, Lcom/android/systemui/statusbar/policy/RemoteInputView$RemoteEditText;->setText(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v2, v4}, Lcom/android/systemui/statusbar/policy/RemoteInputView$RemoteEditText;->setSelection(I)V
    ...
    :cond_2
    iget v2, p0, Lcom/android/systemui/statusbar/policy/RemoteInputView;->mMaxLength:I
    ...
    invoke-virtual {v2, v3}, Lcom/android/systemui/statusbar/policy/RemoteInputView$RemoteEditText;->setText(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v2, v3}, Lcom/android/systemui/statusbar/policy/RemoteInputView$RemoteEditText;->setSelection(I)V
    ...
    iput-object v2, p0, Lcom/android/systemui/statusbar/policy/RemoteInputView;->mPrevString:Ljava/lang/String;
