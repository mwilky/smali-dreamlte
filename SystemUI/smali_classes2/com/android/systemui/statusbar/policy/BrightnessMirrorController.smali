...
.method public constructor <init>(Lcom/android/systemui/statusbar/phone/StatusBarWindowView;Ljava/util/function/Consumer;)V
    ...
    iput-object v0, p0, Lcom/android/systemui/statusbar/policy/BrightnessMirrorController;->mStatusBarWindowManager:Lcom/android/systemui/statusbar/phone/StatusBarWindowManager;
    ...
    invoke-direct {p0}, Lcom/android/systemui/statusbar/policy/BrightnessMirrorController;->initBrightnessMirrorIcon()V

    return-void
.end method

.method private initBrightnessMirrorIcon()V
    .locals 2
...
.method public hideMirror()V
    ...
    const-string v0, "BrightnessMirrorController"

    const-string v1, "hideMirror cancelled since it\'s not visible"
    ...
    invoke-virtual {v0, v2, v3}, Lcom/android/systemui/statusbar/phone/NotificationPanelView;->setPanelAlpha(IZ)Z

    iget-object v0, p0, Lcom/android/systemui/statusbar/policy/BrightnessMirrorController;->mStatusBarWindowManager:Lcom/android/systemui/statusbar/phone/StatusBarWindowManager;

    invoke-virtual {v0, v1}, Lcom/android/systemui/statusbar/phone/StatusBarWindowManager;->suppressBackdropShowingState(Z)V

    iget-object v0, p0, Lcom/android/systemui/statusbar/policy/BrightnessMirrorController;->mStatusBarWindowManager:Lcom/android/systemui/statusbar/phone/StatusBarWindowManager;

    invoke-virtual {v0}, Lcom/android/systemui/statusbar/phone/StatusBarWindowManager;->wallpaperTypeChanged()V

    return-void
.end method

.method public initMirrorViewState()V
    .locals 4

    const-string v0, "BrightnessMirrorController"

    const-string v1, "initMirrorViewState()"
...
.method public showMirror()V
    ...
    invoke-virtual {v0, v2}, Lcom/android/systemui/statusbar/phone/StatusBarWindowManager;->suppressBackdropShowingState(Z)V
...
.method public updateBrightnessAnimation(IF)V
    ...
    const-string v2, "Brightness_icon_0"
...
.method public updateResources()V
    ...
    invoke-virtual {v2}, Lcom/android/systemui/settings/ToggleSliderView;->applyOpenThemeResources()V

    :cond_0
    const/4 v2, 0x0

    invoke-virtual {p0, v2}, Lcom/android/systemui/statusbar/policy/BrightnessMirrorController;->updateQSColoringResources(Landroid/view/View;)V
