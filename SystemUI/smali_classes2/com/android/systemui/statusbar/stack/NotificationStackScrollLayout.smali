...
.field private final mBackgroundOverlapPaint:Landroid/graphics/Paint;
...
.field private mDoNotShowShelf:Z
...
.field private mDummyHunView:Landroid/view/View;
...
.field private mHeadsUpPadding:I
...
.field private mIsActivityLaunchAnimating:Z
...
.field private mKeyguardStackScrollerAlpha:F
...
.field private mNotificationTop:Lcom/android/systemui/statusbar/SecNotificationTop;

.field private mOldMaxDisplayedNotifications:I
...
.field private mQsBackgroundColor:I
...
.field private mSwipeAnimatorSupplier:Ljava/util/function/Supplier;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->SineInOut33:Landroid/view/animation/Interpolator;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-object v0, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mBackgroundOverlapPaint:Landroid/graphics/Paint;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mIsActivityLaunchAnimating:Z

    new-instance v1, Landroid/graphics/Path;

    invoke-direct {v1}, Landroid/graphics/Path;-><init>()V

    iput-object v1, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mBackgroundPath:Landroid/graphics/Path;
    ...
    iput-object v4, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mTempInt2:[I

    new-instance v4, Ljava/util/HashSet;

    invoke-direct {v4}, Ljava/util/HashSet;-><init>()V

    iput-object v4, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mAnimationFinishedRunnables:Ljava/util/HashSet;

    new-instance v4, Ljava/util/HashSet;

    invoke-direct {v4}, Ljava/util/HashSet;-><init>()V

    iput-object v4, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mClearTransientViewsWhenFinished:Ljava/util/HashSet;

    new-instance v4, Ljava/util/HashSet;

    invoke-direct {v4}, Ljava/util/HashSet;-><init>()V

    iput-object v4, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mHeadsUpChangeAnimations:Ljava/util/HashSet;

    new-instance v4, Lcom/android/systemui/statusbar/stack/NotificationRoundnessManager;

    invoke-direct {v4}, Lcom/android/systemui/statusbar/stack/NotificationRoundnessManager;-><init>()V

    iput-object v4, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mRoundnessManager:Lcom/android/systemui/statusbar/stack/NotificationRoundnessManager;

    new-instance v4, Ljava/util/ArrayList;

    invoke-direct {v4}, Ljava/util/ArrayList;-><init>()V

    iput-object v4, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mTmpList:Ljava/util/ArrayList;
    ...
    iput-object v4, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mRunningAnimationUpdater:Landroid/view/ViewTreeObserver$OnPreDrawListener;

    new-instance v4, Landroid/graphics/Rect;

    invoke-direct {v4}, Landroid/graphics/Rect;-><init>()V

    iput-object v4, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mBackgroundBounds:Landroid/graphics/Rect;

    new-instance v4, Landroid/graphics/Rect;

    invoke-direct {v4}, Landroid/graphics/Rect;-><init>()V

    iput-object v4, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mStartAnimationRect:Landroid/graphics/Rect;

    new-instance v4, Landroid/graphics/Rect;

    invoke-direct {v4}, Landroid/graphics/Rect;-><init>()V

    iput-object v4, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mEndAnimationRect:Landroid/graphics/Rect;

    new-instance v4, Landroid/graphics/Rect;

    invoke-direct {v4, v1, v1, v1, v1}, Landroid/graphics/Rect;-><init>(IIII)V

    iput-object v4, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mCurrentBounds:Landroid/graphics/Rect;
    ...
    iput-object v5, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mTmpSortedChildren:Ljava/util/ArrayList;

    new-instance v5, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout$3;

    invoke-direct {v5, p0}, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout$3;-><init>(Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;)V

    iput-object v5, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mDimEndListener:Landroid/animation/Animator$AnimatorListener;

    new-instance v5, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout$4;

    invoke-direct {v5, p0}, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout$4;-><init>(Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;)V

    iput-object v5, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mDimUpdateListener:Landroid/animation/ValueAnimator$AnimatorUpdateListener;

    new-instance v5, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout$5;

    invoke-direct {v5, p0}, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout$5;-><init>(Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;)V

    iput-object v5, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mShadowUpdater:Landroid/view/ViewTreeObserver$OnPreDrawListener;

    new-instance v5, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout$6;

    invoke-direct {v5, p0}, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout$6;-><init>(Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;)V

    iput-object v5, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mViewPositionComparator:Ljava/util/Comparator;
    ...
    iput-object v5, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mSrcMode:Landroid/graphics/PorterDuffXfermode;

    const/4 v5, 0x0

    iput v5, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mDarkAmount:F

    iput v1, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mMaxDisplayedNotifications:I

    new-instance v5, Landroid/graphics/Rect;

    invoke-direct {v5}, Landroid/graphics/Rect;-><init>()V

    iput-object v5, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mClipRect:Landroid/graphics/Rect;
    ...
    new-instance v5, Lcom/android/systemui/statusbar/stack/-$$Lambda$NotificationStackScrollLayout$jMWJf69jcb2Er7Sg4rletxrm5pw;

    invoke-direct {v5, p0}, Lcom/android/systemui/statusbar/stack/-$$Lambda$NotificationStackScrollLayout$jMWJf69jcb2Er7Sg4rletxrm5pw;-><init>(Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;)V

    iput-object v5, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mAnimateScroll:Ljava/lang/Runnable;

    new-instance v5, Landroid/graphics/Rect;

    invoke-direct {v5}, Landroid/graphics/Rect;-><init>()V

    iput-object v5, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mBackgroundAnimationRect:Landroid/graphics/Rect;

    new-instance v5, Ljava/util/ArrayList;

    invoke-direct {v5}, Ljava/util/ArrayList;-><init>()V

    iput-object v5, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mExpandedHeightListeners:Ljava/util/ArrayList;

    iput-object v4, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mKeyLongPressRunnable:Ljava/lang/Runnable;

    iput-boolean v0, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mHasPerformedKeyLongPress:Z

    iput-boolean v0, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mHasSentForKeyLongPress:Z

    new-instance v4, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout$8;

    invoke-direct {v4, p0}, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout$8;-><init>(Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;)V

    iput-object v4, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mReclamp:Ljava/lang/Runnable;

    iput v1, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mOldMaxDisplayedNotifications:I
    ...
    new-instance v4, Lcom/android/systemui/statusbar/stack/AmbientState;

    invoke-direct {v4, p1}, Lcom/android/systemui/statusbar/stack/AmbientState;-><init>(Landroid/content/Context;)V

    iput-object v4, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mAmbientState:Lcom/android/systemui/statusbar/stack/AmbientState;
    ...
    iput v4, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mBgColor:I
    ...
    invoke-virtual {p0, v4}, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->onConfigChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-direct {v6, v7, p0, v4, v5}, Lcom/android/systemui/ExpandHelper;-><init>(Landroid/content/Context;Lcom/android/systemui/ExpandHelper$Callback;II)V

    iput-object v6, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mExpandHelper:Lcom/android/systemui/ExpandHelper;
    ...
    invoke-virtual {v6, p0}, Lcom/android/systemui/ExpandHelper;->setScrollAdapter(Lcom/android/systemui/statusbar/policy/ScrollAdapter;)V

    new-instance v6, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout$NotificationSwipeHelper;

    invoke-virtual {p0}, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->getContext()Landroid/content/Context;

    move-result-object v7

    invoke-direct {v6, p0, v0, p0, v7}, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout$NotificationSwipeHelper;-><init>(Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;ILcom/android/systemui/SwipeHelper$Callback;Landroid/content/Context;)V

    iput-object v6, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mSwipeHelper:Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout$NotificationSwipeHelper;
    ...
    iput-object v0, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mStackScrollAlgorithm:Lcom/android/systemui/statusbar/stack/StackScrollAlgorithm;
    ...
    iput-object v0, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mFalsingManager:Lcom/android/systemui/classifier/FalsingManager;
    ...
    iput-boolean v0, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mShouldDrawNotificationBackground:Z
    ...
    iput-boolean v0, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mFadeNotificationsOnDismiss:Z
    ...
    iput v0, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mSeparatorWidth:I
    ...
    iput v0, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mSeparatorThickness:I
    ...
    iput v0, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mDarkSeparatorPadding:I
    ...
    invoke-virtual {v0, v6}, Lcom/android/systemui/statusbar/stack/NotificationRoundnessManager;->setAnimatedChildren(Ljava/util/HashSet;)V

    iget-object v0, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mRoundnessManager:Lcom/android/systemui/statusbar/stack/NotificationRoundnessManager;

    new-instance v6, Lcom/android/systemui/statusbar/stack/-$$Lambda$NotificationStackScrollLayout$5BC2kaMAloRxl8auhuScFksFNjA;

    invoke-direct {v6, p0}, Lcom/android/systemui/statusbar/stack/-$$Lambda$NotificationStackScrollLayout$5BC2kaMAloRxl8auhuScFksFNjA;-><init>(Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;)V

    invoke-virtual {v0, v6}, Lcom/android/systemui/statusbar/stack/NotificationRoundnessManager;->setOnRoundingChangedCallback(Ljava/lang/Runnable;)V

    iget-object v0, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mRoundnessManager:Lcom/android/systemui/statusbar/stack/NotificationRoundnessManager;

    invoke-static {v0}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;)Ljava/lang/Object;

    new-instance v6, Lcom/android/systemui/statusbar/stack/-$$Lambda$bam6n-VlBWgcqhwrPMDo0VFka_4;

    invoke-direct {v6, v0}, Lcom/android/systemui/statusbar/stack/-$$Lambda$bam6n-VlBWgcqhwrPMDo0VFka_4;-><init>(Lcom/android/systemui/statusbar/stack/NotificationRoundnessManager;)V

    invoke-virtual {p0, v6}, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->addOnExpandedHeightListener(Ljava/util/function/BiConsumer;)V
    ...
    new-instance v6, Lcom/android/systemui/statusbar/stack/-$$Lambda$NotificationStackScrollLayout$ORqWctSAOFbrSZfQ2fKGWKeQ46w;

    invoke-direct {v6, v0}, Lcom/android/systemui/statusbar/stack/-$$Lambda$NotificationStackScrollLayout$ORqWctSAOFbrSZfQ2fKGWKeQ46w;-><init>(Lcom/android/systemui/statusbar/NotificationBlockingHelperManager;)V

    invoke-virtual {p0, v6}, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->addOnExpandedHeightListener(Ljava/util/function/BiConsumer;)V

    invoke-direct {p0}, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->updateWillNotDraw()V

    iget-object v6, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mBackgroundPaint:Landroid/graphics/Paint;
    ...
    iput-object v2, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mDebugLogMonitor:Lcom/android/systemui/statusbar/DebugLogMonitor;
    ...
    invoke-virtual {v2, p0, v6, v3}, Lcom/android/systemui/qs/TouchAnimator$Builder;->addFloat(Ljava/lang/Object;Ljava/lang/String;[F)Lcom/android/systemui/qs/TouchAnimator$Builder;
    ...
    sget-object v3, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->SineInOut33:Landroid/view/animation/Interpolator;
    ...
    iput-object v2, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mStackScrollerAlphaAnimator:Lcom/android/systemui/qs/TouchAnimator;
...
.method static synthetic access$2700(Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;)Landroid/content/Context;
    .locals 1
...
.method static synthetic access$2800(Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;)Lcom/android/systemui/statusbar/ExpandableNotificationRow$LongPressListener;
    .locals 1
...
.method static synthetic access$2902(Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;Z)Z
    .locals 0
...
.method private checkForLongClick(Landroid/view/View;)V
    ...
    new-instance v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout$14;

    invoke-direct {v0, p0, p1}, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout$14;-><init>(Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;Landroid/view/View;)V
    ...
    invoke-virtual {p0, v0, v1, v2}, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->postDelayed(Ljava/lang/Runnable;J)Z
...
.method private drawBackground(Landroid/graphics/Canvas;)V
    ...
    iget v7, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mSeparatorWidth:I
    ...
    iget v8, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mRegularTopPadding:I

    int-to-float v8, v8

    iget v9, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mSeparatorThickness:I
    ...
    iget-object v6, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mFirstVisibleBackgroundChild:Lcom/android/systemui/statusbar/ActivatableNotificationView;
    ...
    iget v12, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mDarkAmount:F
    ...
    invoke-static {v14, v15, v10}, Landroid/util/MathUtils;->lerp(FFF)F
    ...
    invoke-static {v15, v6, v12}, Landroid/util/MathUtils;->lerp(FFF)F
    ...
    invoke-static {v15, v1, v10}, Landroid/util/MathUtils;->lerp(FFF)F
    ...
    invoke-static {v15, v2, v12}, Landroid/util/MathUtils;->lerp(FFF)F

    move-result v2

    float-to-int v2, v2

    invoke-virtual {v13, v14, v6, v1, v2}, Landroid/graphics/Rect;->set(IIII)V
    ...
    iget-object v2, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mBackgroundOverlapPaint:Landroid/graphics/Paint;

    invoke-virtual {v1}, Lcom/android/systemui/statusbar/NotificationColorPicker;->getState()I
    ...
    invoke-virtual {v6, v13}, Lcom/android/systemui/coloring/QSColoringServiceManager;->getQSColoringColor(I)I
    ...
    :cond_5
    iget-boolean v6, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mIsNightModeOn:Z
    ...
    :cond_6
    iget v6, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mQsBackgroundColor:I
    ...
    iget-boolean v6, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mIsActivityLaunchAnimating:Z
    ...
    :cond_7
    iget-object v6, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mBackgroundAnimationRect:Landroid/graphics/Rect;

    iget v6, v6, Landroid/graphics/Rect;->top:I

    iget v13, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mIncreasedPaddingBetweenElements:I

    sub-int/2addr v6, v13

    iget v13, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mPaddingBetweenElements:I
    ...
    iget-object v14, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mBackgroundOverlapPaint:Landroid/graphics/Paint;
...
.method private getFirstChildWithBackground()Lcom/android/systemui/statusbar/ActivatableNotificationView;
    ...
    iget-object v3, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mNotificationTop:Lcom/android/systemui/statusbar/SecNotificationTop;
...
.method private handleEmptySpaceClick(Landroid/view/MotionEvent;)V
    ...
    const-string v1, "onEmptySpaceClicked is ignored by notification Animating.."
...
.method private initView(Landroid/content/Context;)V
    ...
    iput v3, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mCollapsedSize:I
    ...
    invoke-virtual {v3, p1}, Lcom/android/systemui/statusbar/stack/StackScrollAlgorithm;->initView(Landroid/content/Context;)V
    ...
    invoke-virtual {v3, p1}, Lcom/android/systemui/statusbar/stack/AmbientState;->reload(Landroid/content/Context;)V
    ...
    invoke-virtual {v0, v4}, Lcom/android/systemui/statusbar/NotificationLockscreenUserManager;->isTypoNotification(I)Z
    ...
    iput v4, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mPaddingBetweenElements:I
    ...
    invoke-virtual {v4, v5}, Lcom/android/systemui/statusbar/stack/StackScrollAlgorithm;->updatePaddingBetweenElements(I)V
    ...
    invoke-virtual {v4, v5, v3}, Lcom/android/systemui/statusbar/NotificationShelf;->updatePaddingBetweenElements(IZ)V
    ...
    iput v0, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mIncreasedPaddingBetweenElements:I
    ...
    iput v0, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mMinTopOverScrollToEscape:F
    ...
    iput v0, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mBottomMargin:I
    ...
    iput v0, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mSidePaddings:I
    ...
    iput v0, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mMinInteractionHeight:I
    ...
    iput v0, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mCornerRadius:I
    ...
    iput v0, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mHeadsUpPadding:I
...
.method private scrollAmountForKeyboardFocus(IZ)I
    ...
    invoke-virtual {v3}, Lcom/android/systemui/statusbar/NotificationShelf;->getY()F
    ...
    iget-object v2, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mQsContainer:Landroid/view/ViewGroup;
...
.method private setStackTranslation(F)V
    ...
    sget-boolean v0, Lcom/android/systemui/Rune;->NOTI_SUPPORT_QSEXPANSION_WITHOUT_NSSL:Z

    if-eqz v0, :cond_0

    invoke-direct {p0}, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->shouldHideShelf()Z
    ...
    const-string v1, "ADJUST STACK.TRANSLATION"
...
.method private shouldHideShelf()Z
    .locals 5
...
.method private updateBackgroundDimming()V
    ...
    :goto_0
    iget v7, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mKeyguardStackScrollerAlpha:F
    ...
    invoke-virtual {v5}, Lcom/android/systemui/statusbar/NotificationColorPicker;->getState()I
    ...
    :cond_2
    iget-boolean v7, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mIsNightModeOn:Z
    ...
    invoke-virtual {v7, v8}, Lcom/android/systemui/statusbar/NotificationColorPicker;->getColor(I)I
    ...
    :goto_1
    iget v8, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mDimAmount:F

    invoke-static {v7, v6, v8}, Landroid/support/v4/graphics/ColorUtils;->blendARGB(IIF)I
...
.method private updateClippingToTopRoundedCorner()V
    ...
    iget v12, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mOwnScrollY:I
    ...
    :goto_8
    invoke-virtual {v5, v11}, Lcom/android/systemui/statusbar/ExpandableView;->setDistanceToTopRoundness(F)V
...
.method private updateContentHeight()V
    ...
    iget-object v6, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mShelf:Lcom/android/systemui/statusbar/NotificationShelf;

    invoke-virtual {v6}, Lcom/android/systemui/statusbar/NotificationShelf;->isShowOnLock()Z

    move-result v6

    iget-object v7, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mStatusBar:Lcom/android/systemui/statusbar/phone/StatusBar;

    invoke-virtual {v7}, Lcom/android/systemui/statusbar/phone/StatusBar;->getPanel()Lcom/android/systemui/statusbar/phone/NotificationPanelView;

    move-result-object v7

    invoke-virtual {v7}, Lcom/android/systemui/statusbar/phone/NotificationPanelView;->getAvailableSpace()I
    ...
    iget-object v7, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mShelf:Lcom/android/systemui/statusbar/NotificationShelf;

    invoke-virtual {v7, v8}, Lcom/android/systemui/statusbar/NotificationShelf;->setShowOnLock(Z)V
    ...
    invoke-virtual {v7}, Lcom/android/systemui/statusbar/stack/AmbientState;->isFullyDark()Z
    ...
    iput v11, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mOldMaxDisplayedNotifications:I
    ...
    iget-object v13, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mFooterView:Lcom/android/systemui/statusbar/FooterView;
    ...
    invoke-virtual {v12}, Lcom/android/systemui/statusbar/ExpandableView;->hasNoContentHeight()Z
    ...
    :goto_3
    iget-object v15, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mAmbientState:Lcom/android/systemui/statusbar/stack/AmbientState;

    invoke-virtual {v15}, Lcom/android/systemui/statusbar/stack/AmbientState;->isFullyDark()Z
    ...
    instance-of v15, v12, Lcom/android/systemui/statusbar/ExpandableNotificationRow;
    ...
    invoke-virtual {v15}, Lcom/android/systemui/statusbar/ExpandableNotificationRow;->getEntry()Lcom/android/systemui/statusbar/NotificationData$Entry;

    move-result-object v15

    invoke-direct {v0, v15}, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->isPulsing(Lcom/android/systemui/statusbar/NotificationData$Entry;)Z
    ...
    :cond_7
    iget-object v8, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mShelf:Lcom/android/systemui/statusbar/NotificationShelf;
    ...
    :cond_8
    iget-object v12, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mShelf:Lcom/android/systemui/statusbar/NotificationShelf;

    iget v8, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mMaxDisplayedNotifications:I

    if-gtz v8, :cond_9

    iget v8, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mOldMaxDisplayedNotifications:I
    ...
    invoke-virtual {v8, v9}, Lcom/android/systemui/statusbar/NotificationShelf;->setShowOnLock(Z)V

    iget v8, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mMaxDisplayedNotifications:I

    iput v8, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mOldMaxDisplayedNotifications:I
    ...
    iget v9, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mIncreasedPaddingBetweenElements:I

    int-to-float v9, v9

    invoke-static {v2, v9, v8}, Lcom/android/systemui/statusbar/notification/NotificationUtils;->interpolate(FFF)F
    ...
    iget v11, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mPaddingBetweenElements:I

    int-to-float v11, v11

    move/from16 v17, v2

    iget v2, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mIncreasedPaddingBetweenElements:I
    ...
    invoke-static {v9, v2, v11}, Lcom/android/systemui/statusbar/notification/NotificationUtils;->interpolate(FFF)F
    ...
    iget v11, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mIncreasedPaddingBetweenElements:I
    ...
    invoke-virtual {v12}, Lcom/android/systemui/statusbar/ExpandableView;->getIntrinsicHeight()I
    ...
    :goto_8
    iput v10, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mIntrinsicContentHeight:I
    ...
    invoke-virtual {v1, v8}, Lcom/android/systemui/statusbar/stack/AmbientState;->setLayoutMaxHeight(I)V
    ...
    invoke-virtual {v1}, Lcom/android/systemui/statusbar/NotificationShelf;->isShowOnLock()Z

    move-result v1

    if-eq v6, v1, :cond_12

    invoke-direct/range {p0 .. p0}, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->updateFirstAndLastBackgroundViews()V
...
.method private updateFirstAndLastBackgroundViews()V
    ...
    invoke-virtual {v2}, Lcom/android/systemui/statusbar/NotificationShelf;->isShowOnLock()Z
    ...
    :goto_2
    iput-object v2, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mLastVisibleBackgroundChild:Lcom/android/systemui/statusbar/ActivatableNotificationView;
...
.method private updateViewShadows()V
    ...
    iget-object v9, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mStatusBar:Lcom/android/systemui/statusbar/phone/StatusBar;

    invoke-virtual {v9}, Lcom/android/systemui/statusbar/phone/StatusBar;->isKeyguardState()Z

    move-result v9

    if-eqz v9, :cond_3

    instance-of v9, v3, Lcom/android/systemui/statusbar/NotificationShelf;
...
.method public changeViewPosition(Landroid/view/View;I)V
    ...
    instance-of v2, p1, Lcom/android/systemui/statusbar/NotificationShelf;
    ...
    invoke-virtual {p0, v2}, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->addView(Landroid/view/View;)V

    const-string v2, "StackScroller"

    const-string v3, "WTH, ADD SHELF"
...
.method public dispatchKeyEvent(Landroid/view/KeyEvent;)Z
    ...
    invoke-virtual {p0}, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->getFirstRowNotGone()Lcom/android/systemui/statusbar/ExpandableNotificationRow;
    ...
    :cond_1
    invoke-virtual {p0, v4}, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->indexOfChild(Landroid/view/View;)I
    ...
    invoke-virtual {p0, v9}, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->getChildAt(I)Landroid/view/View;
    ...
    invoke-direct {p0, v6, v1}, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->scrollAmountForKeyboardFocus(IZ)I

    move-result v7

    if-eqz v7, :cond_7

    iget v9, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mOwnScrollY:I
    ...
    invoke-virtual {v1}, Lcom/android/systemui/statusbar/NotificationShelf;->hasFocus()Z
    ...
    new-instance v5, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout$13;

    invoke-direct {v5, p0, v4}, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout$13;-><init>(Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;Landroid/view/View;)V
    ...
    invoke-virtual {p0, v3}, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->indexOfChild(Landroid/view/View;)I
    ...
    instance-of v5, v6, Lcom/android/systemui/statusbar/NotificationShelf;

    if-nez v5, :cond_15

    invoke-direct {p0, v4, v2}, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->scrollAmountForKeyboardFocus(IZ)I
    ...
    :goto_7
    iget-boolean v7, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mAnimationsEnabled:Z
    ...
    invoke-virtual {v5}, Lcom/android/systemui/statusbar/NotificationShelf;->requestFocus()Z
    ...
    :cond_17
    iget-boolean v3, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mHasSentForKeyLongPress:Z
    ...
    iget-object v1, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mLongPressListener:Lcom/android/systemui/statusbar/ExpandableNotificationRow$LongPressListener;
    ...
    iput-boolean v2, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mHasSentForKeyLongPress:Z

    invoke-direct {p0, v1}, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->checkForLongClick(Landroid/view/View;)V
    ...
    iput-boolean v1, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mHasSentForKeyLongPress:Z

    iget-boolean v3, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mHasPerformedKeyLongPress:Z

    if-eqz v3, :cond_1a

    iput-boolean v1, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mHasPerformedKeyLongPress:Z

    return v2

    :cond_1a
    iget-object v1, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mKeyLongPressRunnable:Ljava/lang/Runnable;
    ...
    iput-object v1, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mKeyLongPressRunnable:Ljava/lang/Runnable;
    ...
    invoke-virtual {v1}, Lcom/android/systemui/statusbar/NotificationShelf;->getNotiSettingsButtonView()Landroid/view/View;
    ...
    invoke-virtual {v1}, Lcom/android/systemui/statusbar/NotificationShelf;->getClearAllButtonView()Landroid/view/View;
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p2}, Lcom/android/systemui/statusbar/stack/AmbientState;->dump(Ljava/io/PrintWriter;)V
...
.method public getFirstRowNotGone()Lcom/android/systemui/statusbar/ExpandableNotificationRow;
    .locals 5
...
.method public getHeadsUpInset()I
    .locals 1
...
.method public onApplyWindowInsets(Landroid/view/WindowInsets;)Landroid/view/WindowInsets;
    ...
    :cond_1
    :goto_0
    invoke-virtual {p0}, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->getRootWindowInsets()Landroid/view/WindowInsets;
    ...
    iput v4, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mHeadsUpInset:I
    ...
    :cond_4
    iget v4, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mHeadsUpPadding:I
    ...
    :cond_5
    :goto_1
    iget v4, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mStatusBarHeight:I

    iget v5, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mHeadsUpPadding:I
    ...
    iget v5, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mHeadsUpInset:I

    invoke-virtual {v4, v5}, Lcom/android/systemui/statusbar/stack/StackScrollAlgorithm;->setHeadsUpInset(I)V
...
.method public onConfigChanged(Landroid/content/res/Configuration;)V
    ...
    iput v0, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mQsBackgroundColor:I
    ...
    invoke-virtual {v0}, Lcom/android/systemui/statusbar/NotificationShelf;->updateBackgroundColor()V
    ...
    :goto_0
    iput-boolean v0, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mIsNightModeOn:Z
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-boolean v0, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mIsActivityLaunchAnimating:Z
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_0
    iget-object v4, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mDebugLogMonitor:Lcom/android/systemui/statusbar/DebugLogMonitor;

    invoke-virtual {v4, v2}, Lcom/android/systemui/statusbar/DebugLogMonitor;->addTouchDebugLogs(I)V
    ...
    iget-boolean v5, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mSwipingInProgress:Z
    ...
    iget-object v5, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mExpandHelper:Lcom/android/systemui/ExpandHelper;
    ...
    iget-boolean v6, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mSwipingInProgress:Z

    if-nez v6, :cond_3

    iget-boolean v6, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mExpandingNotification:Z
    ...
    iget-boolean v7, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mIsBeingDragged:Z

    if-nez v7, :cond_4

    iget-boolean v7, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mExpandingNotification:Z

    if-nez v7, :cond_4

    iget-boolean v7, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mExpandedInThisMotion:Z

    if-nez v7, :cond_4

    iget-boolean v7, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mOnlyScrollingInThisMotion:Z

    if-nez v7, :cond_4

    iget-boolean v7, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mDisallowDismissInThisMotion:Z

    if-nez v7, :cond_4

    iget-object v7, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mSwipeHelper:Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout$NotificationSwipeHelper;

    invoke-virtual {v7, v1}, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout$NotificationSwipeHelper;->onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v9}, Lcom/android/systemui/statusbar/NotificationGutsManager;->getExposedGuts()Lcom/android/systemui/statusbar/NotificationGuts;

    move-result-object v9

    invoke-direct {v0, v1, v9}, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->isTouchInView(Landroid/view/MotionEvent;Landroid/view/View;)Z
    ...
    iput-boolean v8, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mCheckForLeavebehind:Z

    iget-object v10, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mStatusBar:Lcom/android/systemui/statusbar/phone/StatusBar;

    invoke-virtual {v10}, Lcom/android/systemui/statusbar/phone/StatusBar;->getGutsManager()Lcom/android/systemui/statusbar/NotificationGutsManager;
    ...
    invoke-virtual/range {v11 .. v17}, Lcom/android/systemui/statusbar/NotificationGutsManager;->closeAndSaveGuts(ZZZIIZ)V
    ...
    iput-boolean v3, v0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mCheckForLeavebehind:Z
...
.method public onMenuClicked(Landroid/view/View;IILcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin$MenuItem;)V
    ...
    instance-of v1, v1, Lcom/android/systemui/statusbar/SecNotificationInfo;
    ...
    check-cast v1, Lcom/android/systemui/statusbar/SecNotificationInfo;

    invoke-virtual {v1}, Lcom/android/systemui/statusbar/SecNotificationInfo;->getSettingClickListener()Landroid/view/View$OnClickListener;
    ...
    invoke-virtual {v2, v0, p4}, Lcom/android/systemui/statusbar/NotificationGutsManager;->bindGuts(Lcom/android/systemui/statusbar/ExpandableNotificationRow;Lcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin$MenuItem;)V
    ...
    invoke-virtual {p0, v2, v3}, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->resetExposedMenuView(ZZ)V
    ...
    invoke-interface {v1, p1, p2, p3, p4}, Lcom/android/systemui/statusbar/ExpandableNotificationRow$LongPressListener;->onLongPress(Landroid/view/View;IILcom/android/systemui/plugins/statusbar/NotificationMenuRowPlugin$MenuItem;)Z
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_0
    iget-object v3, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mDebugLogMonitor:Lcom/android/systemui/statusbar/DebugLogMonitor;
    ...
    iget-boolean v5, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mOnlyScrollingInThisMotion:Z
    ...
    invoke-virtual {v5, v4}, Lcom/android/systemui/ExpandHelper;->onlyObserveMovements(Z)V
    ...
    iget-boolean v7, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mDisallowDismissInThisMotion:Z

    if-nez v7, :cond_7

    iget-object v7, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mSwipeHelper:Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout$NotificationSwipeHelper;

    invoke-virtual {v7, p1}, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout$NotificationSwipeHelper;->onTouchEvent(Landroid/view/MotionEvent;)Z

    move-result v6

    :cond_7
    iget-object v7, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mStatusBar:Lcom/android/systemui/statusbar/phone/StatusBar;

    invoke-virtual {v7}, Lcom/android/systemui/statusbar/phone/StatusBar;->getGutsManager()Lcom/android/systemui/statusbar/NotificationGutsManager;

    move-result-object v7

    invoke-virtual {v7}, Lcom/android/systemui/statusbar/NotificationGutsManager;->getExposedGuts()Lcom/android/systemui/statusbar/NotificationGuts;

    move-result-object v7

    if-eqz v7, :cond_a

    invoke-direct {p0, p1, v7}, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->isTouchInView(Landroid/view/MotionEvent;Landroid/view/View;)Z
    ...
    check-cast v8, Lcom/android/systemui/statusbar/SecNotificationSnooze;

    invoke-virtual {v8}, Lcom/android/systemui/statusbar/SecNotificationSnooze;->isExpanded()Z
...
.method public setDoNotShowShelf(Z)V
    ...
    iget-boolean v0, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mDoNotShowShelf:Z

    if-eq v0, p1, :cond_1

    iput-boolean p1, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mDoNotShowShelf:Z
    ...
    invoke-virtual {v1, v0}, Lcom/android/systemui/statusbar/NotificationShelf;->setAlpha(F)V

    iget-object v1, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mShelf:Lcom/android/systemui/statusbar/NotificationShelf;

    iget-boolean v2, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mDoNotShowShelf:Z

    invoke-virtual {v1, v2}, Lcom/android/systemui/statusbar/NotificationShelf;->setDoNotShowShelf(Z)V
    ...
    :goto_0
    invoke-virtual {v1, v2}, Lcom/android/systemui/statusbar/NotificationShelf;->setVisibility(I)V
...
.method public setDummyHun(Landroid/view/View;)V
    .locals 1

    iget-object v0, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mDummyHunView:Landroid/view/View;
    ...
    invoke-virtual {p0, v0}, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->removeView(Landroid/view/View;)V
    ...
    :cond_1
    :goto_0
    iput-object p1, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mDummyHunView:Landroid/view/View;
...
.method public setExpandedHeight(F)V
    ...
    iget-boolean v8, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mShouldShowShelfOnly:Z
    ...
    :cond_3
    iget-boolean v8, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mQsExpanded:Z

    if-eqz v8, :cond_5

    sget-boolean v8, Lcom/android/systemui/Rune;->NOTI_SUPPORT_QSEXPANSION_WITHOUT_NSSL:Z

    if-eqz v8, :cond_5

    iget v8, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mContentHeight:I

    iget v9, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mTopPadding:I

    sub-int/2addr v8, v9

    iget v9, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mIntrinsicPadding:I

    add-int/2addr v8, v9

    iget v9, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mMaxTopPadding:I

    iget-object v10, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mShelf:Lcom/android/systemui/statusbar/NotificationShelf;
    ...
    iget v12, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mQsExpansionFraction:F
    ...
    :goto_6
    sget-boolean v9, Lcom/android/systemui/Rune;->NOTI_SUPPORT_QSEXPANSION_WITHOUT_NSSL:Z

    if-eqz v9, :cond_b

    iget v9, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mQsExpansionFraction:F
    ...
    :goto_7
    invoke-static {v10, v0, v9}, Lcom/android/systemui/statusbar/notification/NotificationUtils;->interpolate(FFF)F
    ...
    iget-object v10, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mSwipeAnimatorSupplier:Ljava/util/function/Supplier;
    ...
    :cond_a
    iget-object v10, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mStackScrollerAlphaAnimator:Lcom/android/systemui/qs/TouchAnimator;

    iget v11, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mQsExpansionFraction:F

    invoke-virtual {v10, v11}, Lcom/android/systemui/qs/TouchAnimator;->setPosition(F)V
    ...
    iput v8, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mCurrentStackHeight:I
    ...
    :cond_c
    invoke-direct {p0, v7}, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->setStackTranslation(F)V
    ...
    iget-object v3, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mExpandedHeightListeners:Ljava/util/ArrayList;
    ...
    invoke-interface {v3, v9, v10}, Ljava/util/function/BiConsumer;->accept(Ljava/lang/Object;Ljava/lang/Object;)V
...
.method public setKeyguardStackScrollerAlpha(F)V
    .locals 0

    iput p1, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mKeyguardStackScrollerAlpha:F
...
.method public setShouldShowShelfOnly(Z)V
    ...
    iput-boolean v0, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mShouldShowShelfOnly:Z
...
.method public setStatusBarState(I)V
    ...
    iget v2, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mStatusBarState:I
    ...
    invoke-virtual {v0, v2}, Lcom/android/systemui/statusbar/NotificationLockscreenUserManager;->isTypoNotification(I)Z
    ...
    invoke-virtual {v2, v3}, Lcom/android/systemui/statusbar/stack/StackScrollAlgorithm;->updatePaddingBetweenElements(I)V
    ...
    invoke-virtual {v2, v3, v1}, Lcom/android/systemui/statusbar/NotificationShelf;->updatePaddingBetweenElements(IZ)V

    :cond_2
    return-void
.end method

.method public setSwipeAnimatorSupplier(Ljava/util/function/Supplier;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->mSwipeAnimatorSupplier:Ljava/util/function/Supplier;
...
.method public updateLandScapeFirstAndLastBackgroundViews()V
    .locals 0
...
.method public updateNotificationBackgroundAlpha()V
    .locals 12
    ...
    invoke-static {v4, v2, v1}, Lcom/android/internal/util/NotificationColorUtil;->getOpacityOnKeyguard(FIZ)F
    ...
    invoke-virtual {p0, v4}, Lcom/android/systemui/statusbar/stack/NotificationStackScrollLayout;->setKeyguardStackScrollerAlpha(F)V
    ...
    instance-of v7, v6, Lcom/android/systemui/statusbar/ActivatableNotificationView;

    if-eqz v7, :cond_4

    move-object v7, v6

    check-cast v7, Lcom/android/systemui/statusbar/ActivatableNotificationView;

    const/4 v8, 0x0

    instance-of v9, v6, Lcom/android/systemui/statusbar/ExpandableNotificationRow;
    ...
    :cond_1
    const-class v9, Lcom/android/systemui/statusbar/NotificationColorPicker;

    invoke-static {v9}, Lcom/android/systemui/Dependency;->get(Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object v9

    check-cast v9, Lcom/android/systemui/statusbar/NotificationColorPicker;

    invoke-virtual {v7}, Lcom/android/systemui/statusbar/ActivatableNotificationView;->getDimmedBackground()Lcom/android/systemui/statusbar/NotificationBackgroundView;
    ...
    :cond_3
    const-class v11, Lcom/android/systemui/statusbar/NotificationColorPicker;

    invoke-static {v11}, Lcom/android/systemui/Dependency;->get(Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object v11

    check-cast v11, Lcom/android/systemui/statusbar/NotificationColorPicker;

    invoke-virtual {v11, v8}, Lcom/android/systemui/statusbar/NotificationColorPicker;->isNeedToUpdate(Lcom/android/systemui/statusbar/ExpandableNotificationRow;)Z
    ...
    :goto_2
    invoke-virtual {v9, v10, v11}, Lcom/android/systemui/statusbar/NotificationColorPicker;->updateBGColor(Lcom/android/systemui/statusbar/NotificationBackgroundView;Z)V
...
.method public updateTypoInitializeFlag()V
    .locals 5
    ...
    invoke-virtual {v0}, Lcom/android/systemui/statusbar/NotificationColorPicker;->shouldReTintTypo()Z
    ...
    invoke-virtual {v4}, Lcom/android/systemui/statusbar/ExpandableNotificationRow;->resetTypoInitFlag()V
