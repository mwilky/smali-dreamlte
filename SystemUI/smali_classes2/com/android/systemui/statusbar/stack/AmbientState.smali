...
.method public dump(Ljava/io/PrintWriter;)V
    ...
    const-string v0, "  mAmbient State:"

    invoke-virtual {p1, v0}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    const-string v0, "      mScrollY=%s mDimmed=%s mOverScrollTopAmount=%s mOverScrollBottomAmount=%s\n      mSpeedBumpIndex=%s mDark=%s mHideSensitive=%s mStackTranslation=%s\n      mLayoutHeight=%s mTopPadding=%s mShadeExpanded=%s mMaxHeadsUpTranslation=%s\n      mDismissAllInProgress=%s mLayoutMinHeight=%s mZDistanceBetweenElements=%s mBaseZHeight=%s\n      mMaxLayoutHeight=%s mCurrentScrollVelocity=%s mStatusBarState=%s mExpandingVelocity=%s\n      mPanelTracking=%s mExpansionChanging=%s mPanelFullWidth=%s mUnlockHintRunning=%s"

    const/16 v1, 0x18

    new-array v1, v1, [Ljava/lang/Object;

    iget v2, p0, Lcom/android/systemui/statusbar/stack/AmbientState;->mScrollY:I
    ...
    iget-boolean v2, p0, Lcom/android/systemui/statusbar/stack/AmbientState;->mDimmed:Z
    ...
    iget v3, p0, Lcom/android/systemui/statusbar/stack/AmbientState;->mOverScrollTopAmount:F
    ...
    iget v3, p0, Lcom/android/systemui/statusbar/stack/AmbientState;->mOverScrollBottomAmount:F
    ...
    iget v3, p0, Lcom/android/systemui/statusbar/stack/AmbientState;->mSpeedBumpIndex:I
    ...
    iget-boolean v3, p0, Lcom/android/systemui/statusbar/stack/AmbientState;->mDark:Z
    ...
    iget-boolean v3, p0, Lcom/android/systemui/statusbar/stack/AmbientState;->mHideSensitive:Z
    ...
    iget v3, p0, Lcom/android/systemui/statusbar/stack/AmbientState;->mStackTranslation:F
    ...
    iget v3, p0, Lcom/android/systemui/statusbar/stack/AmbientState;->mLayoutHeight:I
    ...
    iget v3, p0, Lcom/android/systemui/statusbar/stack/AmbientState;->mTopPadding:I
    ...
    iget-boolean v3, p0, Lcom/android/systemui/statusbar/stack/AmbientState;->mShadeExpanded:Z
    ...
    iget v3, p0, Lcom/android/systemui/statusbar/stack/AmbientState;->mMaxHeadsUpTranslation:F
    ...
    iget-boolean v3, p0, Lcom/android/systemui/statusbar/stack/AmbientState;->mDismissAllInProgress:Z
    ...
    iget v3, p0, Lcom/android/systemui/statusbar/stack/AmbientState;->mLayoutMinHeight:I
    ...
    iget v3, p0, Lcom/android/systemui/statusbar/stack/AmbientState;->mZDistanceBetweenElements:I
    ...
    iget v3, p0, Lcom/android/systemui/statusbar/stack/AmbientState;->mBaseZHeight:I
    ...
    iget v3, p0, Lcom/android/systemui/statusbar/stack/AmbientState;->mMaxLayoutHeight:I
    ...
    iget v3, p0, Lcom/android/systemui/statusbar/stack/AmbientState;->mCurrentScrollVelocity:F
    ...
    iget v3, p0, Lcom/android/systemui/statusbar/stack/AmbientState;->mStatusBarState:I
    ...
    iget v3, p0, Lcom/android/systemui/statusbar/stack/AmbientState;->mExpandingVelocity:F
    ...
    iget-boolean v3, p0, Lcom/android/systemui/statusbar/stack/AmbientState;->mPanelTracking:Z
    ...
    iget-boolean v3, p0, Lcom/android/systemui/statusbar/stack/AmbientState;->mExpansionChanging:Z
    ...
    iget-boolean v3, p0, Lcom/android/systemui/statusbar/stack/AmbientState;->mPanelFullWidth:Z
    ...
    iget-boolean v3, p0, Lcom/android/systemui/statusbar/stack/AmbientState;->mUnlockHintRunning:Z
