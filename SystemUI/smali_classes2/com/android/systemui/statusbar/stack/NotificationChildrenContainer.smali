...
.method public addNotification(Lcom/android/systemui/statusbar/ExpandableNotificationRow;I)V
    ...
    invoke-virtual {v1, p1}, Lcom/android/systemui/statusbar/ExpandableNotificationRow$NotificationViewState;->cancelAnimations(Landroid/view/View;)V
...
.method public applyState(Lcom/android/systemui/statusbar/stack/StackScrollState;)V
    ...
    invoke-virtual {v7, v6}, Lcom/android/systemui/statusbar/stack/ExpandableViewState;->applyToView(Landroid/view/View;)V

    const/4 v8, 0x0

    invoke-virtual {v6, v8, v8, v4, v4}, Lcom/android/systemui/statusbar/ExpandableNotificationRow;->setFakeShadowIntensity(FFII)V
    ...
    iput-boolean v4, p0, Lcom/android/systemui/statusbar/stack/NotificationChildrenContainer;->mNeverAppliedGroupState:Z
...
.method public getState(Lcom/android/systemui/statusbar/stack/StackScrollState;Lcom/android/systemui/statusbar/stack/ExpandableViewState;Lcom/android/systemui/statusbar/stack/AmbientState;)V
    ...
    iput v5, v4, Lcom/android/systemui/statusbar/stack/ViewState;->zTranslation:F
...
.method protected onMeasure(II)V
    ...
    iget v4, v0, Lcom/android/systemui/statusbar/stack/NotificationChildrenContainer;->mDividerHeight:I
...
.method public recreateNotificationHeader(Landroid/view/View$OnClickListener;)V
    ...
    iget-object v6, p0, Lcom/android/systemui/statusbar/stack/NotificationChildrenContainer;->mContext:Landroid/content/Context;

    iget-object v7, p0, Lcom/android/systemui/statusbar/stack/NotificationChildrenContainer;->mContainingNotification:Lcom/android/systemui/statusbar/ExpandableNotificationRow;

    invoke-virtual {v7}, Lcom/android/systemui/statusbar/ExpandableNotificationRow;->isOnKeyguard()Z
    ...
    invoke-virtual {v8}, Lcom/android/systemui/statusbar/ExpandableNotificationRow;->isCustomNotification()Z

    move-result v8

    invoke-virtual {v5, v6, v2, v7, v8}, Lcom/android/systemui/statusbar/NotificationData$Entry;->getAppPrimaryColor(Landroid/content/Context;ZZZ)I
    ...
    iget-object v7, p0, Lcom/android/systemui/statusbar/stack/NotificationChildrenContainer;->mContext:Landroid/content/Context;

    invoke-static {v7}, Lcom/android/internal/util/NotificationColorUtil;->getInstance(Landroid/content/Context;)Lcom/android/internal/util/NotificationColorUtil;

    move-result-object v7

    invoke-static {v6, v7}, Lcom/android/systemui/statusbar/notification/NotificationUtils;->isGrayscale(Landroid/widget/ImageView;Lcom/android/internal/util/NotificationColorUtil;)Z

    move-result v6

    iget-object v7, p0, Lcom/android/systemui/statusbar/stack/NotificationChildrenContainer;->mContainingNotification:Lcom/android/systemui/statusbar/ExpandableNotificationRow;

    invoke-virtual {v4, v7}, Lcom/android/systemui/statusbar/NotificationColorPicker;->isNeedToRevert(Lcom/android/systemui/statusbar/ExpandableNotificationRow;)Z
    ...
    invoke-virtual {v4, v8, v5, v6, v7}, Lcom/android/systemui/statusbar/NotificationColorPicker;->updateHeader(Landroid/view/View;IZZ)V
...
.method public startAnimationToState(Lcom/android/systemui/statusbar/stack/StackScrollState;Lcom/android/systemui/statusbar/stack/AnimationProperties;)V
    ...
    invoke-virtual {v8, v7, p2}, Lcom/android/systemui/statusbar/stack/ExpandableViewState;->animateTo(Landroid/view/View;Lcom/android/systemui/statusbar/stack/AnimationProperties;)V

    invoke-virtual {v7, v6, v6, v4, v4}, Lcom/android/systemui/statusbar/ExpandableNotificationRow;->setFakeShadowIntensity(FFII)V
    ...
    iget-boolean v5, p0, Lcom/android/systemui/statusbar/stack/NotificationChildrenContainer;->mNeverAppliedGroupState:Z

    if-eqz v5, :cond_5

    iget-object v5, p0, Lcom/android/systemui/statusbar/stack/NotificationChildrenContainer;->mGroupOverFlowState:Lcom/android/systemui/statusbar/stack/ViewState;

    iget v5, v5, Lcom/android/systemui/statusbar/stack/ViewState;->alpha:F

    iget-object v7, p0, Lcom/android/systemui/statusbar/stack/NotificationChildrenContainer;->mGroupOverFlowState:Lcom/android/systemui/statusbar/stack/ViewState;

    iput v6, v7, Lcom/android/systemui/statusbar/stack/ViewState;->alpha:F

    iget-object v6, p0, Lcom/android/systemui/statusbar/stack/NotificationChildrenContainer;->mGroupOverFlowState:Lcom/android/systemui/statusbar/stack/ViewState;
    ...
    iput v5, v6, Lcom/android/systemui/statusbar/stack/ViewState;->alpha:F
    ...
    invoke-virtual {v4, v5, p2}, Lcom/android/systemui/statusbar/stack/ViewState;->animateTo(Landroid/view/View;Lcom/android/systemui/statusbar/stack/AnimationProperties;)V
...
.method public updateGroupOverflow()V
    ...
    const-string v1, "Noti-NCC"

    const-string v4, "group notification header is null!! "
    ...
    invoke-virtual {v3, v4, v1}, Landroid/view/NotificationHeaderView;->setOverFlowNumber(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v3, v1, v4}, Landroid/view/NotificationHeaderView;->setOverFlowNumber(Ljava/lang/String;Ljava/lang/String;)V
...
.method public updateHeaderForExpansion(Z)V
    ...
    invoke-virtual {v0}, Lcom/android/systemui/statusbar/ExpandableNotificationRow;->isDimmed()Z
