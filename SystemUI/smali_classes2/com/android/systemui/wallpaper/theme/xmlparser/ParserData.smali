...
.method public constructor <init>(Landroid/content/Context;Landroid/content/Context;Ljava/lang/String;Lcom/android/systemui/wallpaper/KeyguardAnimatedWallpaper;IIZILcom/android/systemui/wallpaper/WallpaperUtils$UpdateBitmapCallback;)V
    ...
    iput v1, p0, Lcom/android/systemui/wallpaper/theme/xmlparser/ParserData;->mPackageHeight:F
    ...
    iput-object v3, p0, Lcom/android/systemui/wallpaper/theme/xmlparser/ParserData;->mDisplayMetrics:Landroid/util/DisplayMetrics;

    iput v0, p0, Lcom/android/systemui/wallpaper/theme/xmlparser/ParserData;->mDeviceWidth:F

    iput v1, p0, Lcom/android/systemui/wallpaper/theme/xmlparser/ParserData;->mDeviceHeight:F
...
.method private init()V
    ...
    iget-object v2, p0, Lcom/android/systemui/wallpaper/theme/xmlparser/ParserData;->mDisplayMetrics:Landroid/util/DisplayMetrics;
    ...
    iget-boolean v1, p0, Lcom/android/systemui/wallpaper/theme/xmlparser/ParserData;->mIsPreview:Z

    if-eqz v1, :cond_3

    iget v1, p0, Lcom/android/systemui/wallpaper/theme/xmlparser/ParserData;->mViewWidth:I

    int-to-float v1, v1

    iget v2, p0, Lcom/android/systemui/wallpaper/theme/xmlparser/ParserData;->mDeviceDensity:F

    div-float/2addr v1, v2

    iput v1, p0, Lcom/android/systemui/wallpaper/theme/xmlparser/ParserData;->mDeviceWidth:F

    iget v1, p0, Lcom/android/systemui/wallpaper/theme/xmlparser/ParserData;->mViewHeight:I
    ...
    :goto_0
    new-instance v1, Lcom/android/systemui/wallpaper/theme/view/FrameImageView;

    iget-object v2, p0, Lcom/android/systemui/wallpaper/theme/xmlparser/ParserData;->mContext:Landroid/content/Context;

    invoke-direct {v1, v2}, Lcom/android/systemui/wallpaper/theme/view/FrameImageView;-><init>(Landroid/content/Context;)V

    invoke-virtual {p0, v1}, Lcom/android/systemui/wallpaper/theme/xmlparser/ParserData;->setFrameImageView(Lcom/android/systemui/wallpaper/theme/view/FrameImageView;)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/systemui/wallpaper/theme/xmlparser/ParserData;->setAnimationBuilder(Lcom/android/systemui/wallpaper/theme/builder/AnimationBuilder;)V

    new-instance v1, Lcom/android/systemui/wallpaper/theme/builder/ComplexAnimationBuilder;

    invoke-direct {v1}, Lcom/android/systemui/wallpaper/theme/builder/ComplexAnimationBuilder;-><init>()V

    invoke-virtual {p0, v1}, Lcom/android/systemui/wallpaper/theme/xmlparser/ParserData;->setComplexAnimationBuilder(Lcom/android/systemui/wallpaper/theme/builder/ComplexAnimationBuilder;)V
