.class public Lcom/android/systemui/util/FOTAUtils;
...
.method public static transferTaskLockPrefMtoN(Landroid/content/Context;Ljava/lang/String;Z)V
    ...
    :goto_1
    invoke-static {p0, v4, v5, v6}, Lcom/android/systemui/util/FOTAUtils;->saveLockedTask_N(Landroid/content/Context;Ljava/lang/String;ILjava/util/Set;)V
    ...
    invoke-virtual {v10, v8, v11}, Lcom/android/systemui/shared/system/PackageManagerWrapper;->getActivityInfo(Landroid/content/ComponentName;I)Landroid/content/pm/ActivityInfo;

    move-result-object v10

    if-eqz v10, :cond_3

    iget-object v6, v10, Landroid/content/pm/ActivityInfo;->taskAffinity:Ljava/lang/String;
    ...
    invoke-static {p0, v7, v5, v9}, Lcom/android/systemui/util/FOTAUtils;->saveLockedTask_N(Landroid/content/Context;Ljava/lang/String;ILjava/util/Set;)V
...
.method public static transferTaskLockPrefNtoO(Landroid/content/Context;)V
    ...
    invoke-virtual {v8, v5, v9, v10}, Lcom/android/systemui/recents/TaskLockPreference;->saveLockedTask(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v3, "DefaultLockPreference"
    ...
    invoke-virtual {v6, v5}, Lcom/android/systemui/recents/TaskLockPreference;->saveDefaultLockedPackage(Ljava/lang/String;)V
